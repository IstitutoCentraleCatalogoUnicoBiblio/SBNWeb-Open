...
public class InserisciFornitoreForm extends ActionForm {


	private static final long serialVersionUID = -209608318798140723L;
	...
	private boolean disabilitaComune=false;
	...
	public boolean isDisabilitaComune() {
		return disabilitaComune;
	}

	public void setDisabilitaComune(boolean disabilitaComune) {
		this.disabilitaComune = disabilitaComune;
	}

...
public class SinteticaMarcheForm extends AbstractSinteticaMarcheForm {


	private static final long serialVersionUID = 248930532074881861L;

	//	 Aree della sintetica utilizzate per interrogare in indice con l'area passata da interrogazione
	private AreaDatiPassaggioInterrogazioneMarcaVO datiInterrMarca = new AreaDatiPassaggioInterrogazioneMarcaVO();

	private TabellaEsaminaVO tabellaEsaminaVO = new TabellaEsaminaVO();
	...
	AreaDatiVariazioneMarcaVO areaDatiPassPerConfVariazione = new AreaDatiVariazioneMarcaVO();
	...
	private AreaDatiLegameTitoloVO areaDatiLegameTitoloVO	= new AreaDatiLegameTitoloVO();
	...
	public void setChiaviImmagini(String[] chiaviImmagini) {
		this.chiaviImmagini = chiaviImmagini;
	}
	...
	public AreaDatiVariazioneMarcaVO getAreaDatiPassPerConfVariazione() {
		return areaDatiPassPerConfVariazione;
	}

	public void setAreaDatiPassPerConfVariazione(
			AreaDatiVariazioneMarcaVO areaDatiPassPerConfVariazione) {

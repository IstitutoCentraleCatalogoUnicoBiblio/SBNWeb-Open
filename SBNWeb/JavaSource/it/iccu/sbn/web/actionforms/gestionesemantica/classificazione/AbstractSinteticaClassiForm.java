...
public abstract class AbstractSinteticaClassiForm extends SemanticaBaseForm {


	private static final long serialVersionUID = -4820947365011877644L;
	...
	private SinteticaClasseVO lista = new SinteticaClasseVO();
	...
	public SinteticaClasseVO getLista() {
		return lista;
	}

	public void setLista(SinteticaClasseVO lista) {
		this.lista = lista;
	}

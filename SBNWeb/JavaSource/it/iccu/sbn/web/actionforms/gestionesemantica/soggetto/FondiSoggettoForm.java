...
public class FondiSoggettoForm extends AbstractSinteticaSoggettiForm {


	private static final long serialVersionUID = -8789866708039114577L;
	...
	private boolean condivisoIndice = false;

	public DettaglioSoggettoVO[] getSoggetti() {

		DettaglioSoggettoVO cid1 = new DettaglioSoggettoVO();
		cid1.setCid(cidTrascinaDa);
		cid1.setTesto(testoTrascinaDa);

		DettaglioSoggettoVO cid2 = new DettaglioSoggettoVO();
		cid2.setCid(cidTrascinaA);
		cid2.setTesto(testoTrascinaA);
	...
	public boolean isCondivisoIndice() {
		return condivisoIndice;
	}

	public void setCondivisoIndice(boolean condivisoIndice) {
		this.condivisoIndice = condivisoIndice;
	}

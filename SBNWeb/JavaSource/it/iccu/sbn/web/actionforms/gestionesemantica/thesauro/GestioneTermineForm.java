...
public class GestioneTermineForm extends SemanticaBaseForm {


	private static final long serialVersionUID = -500697168991195375L;
	...
	private DettaglioTermineThesauroVO dettaglioOld;
	...
	public boolean isEnableTrascina() {
		...
		case GESTIONE:
			return (dettaglio != null)
					&& (dettaglio.getNumTitoliBiblio() > 0
							|| dettaglio.getNumTitoliPolo() > 0);
		default:
			// true solo se in GESTIONE
			return false;
		}
	}

	public boolean isEnableTitoliCollegati() {
		switch (this.modalita) {
		case CREA:
	...
	public boolean isEnableFormaNome() {
		switch (this.modalita) {
	...
	public DettaglioTermineThesauroVO getDettaglioOld() {
		return dettaglioOld;
	}

	public void setDettaglioOld(DettaglioTermineThesauroVO dettaglioOld) {

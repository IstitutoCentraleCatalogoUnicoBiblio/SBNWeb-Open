 ...
 ******************************************************************************/
package it.iccu.sbn.web.actionforms.gestionestampe.schede;
...
//public class StampaSchedeForm extends StampaSingoloFontDinamicoForm {
	public class StampaSchedeForm extends RicercaInventariCollocazioniForm {
    /**
		 * 
		 */
		private static final long serialVersionUID = -3225974563773521874L;


	public StampaSchedeForm() throws Exception {
		super();
	...
	public boolean isChkCollSchClassificazioni() {
		return chkCollSchClassificazioni;
	}

	public void setChkCollSchClassificazioni(boolean chkCollSchClassificazioni) {
		this.chkCollSchClassificazioni = chkCollSchClassificazioni;
	}

	public boolean isChkCollSchEditori() {
		return chkCollSchEditori;
	}

	public void setChkCollSchEditori(boolean chkCollSchEditori) {
		this.chkCollSchEditori = chkCollSchEditori;
	}

	public boolean isChkCollSchPossessori() {
		return chkCollSchPossessori;
	}

	public void setChkCollSchPossessori(boolean chkCollSchPossessori) {
		this.chkCollSchPossessori = chkCollSchPossessori;
	}

	public boolean isChkCollSchPrincipale() {
		return chkCollSchPrincipale;
	}

	public void setChkCollSchPrincipale(boolean chkCollSchPrincipale) {
		this.chkCollSchPrincipale = chkCollSchPrincipale;
	}

	public boolean isChkCollSchRichiami() {
		return chkCollSchRichiami;
	}

	public void setChkCollSchRichiami(boolean chkCollSchRichiami) {
		this.chkCollSchRichiami = chkCollSchRichiami;
	}

	public boolean isChkCollSchSoggetti() {
		return chkCollSchSoggetti;
	}

	public void setChkCollSchSoggetti(boolean chkCollSchSoggetti) {
		this.chkCollSchSoggetti = chkCollSchSoggetti;
	}

	public boolean isChkCollSchTitoli() {
		return chkCollSchTitoli;
	}

	public void setChkCollSchTitoli(boolean chkCollSchTitoli) {
		this.chkCollSchTitoli = chkCollSchTitoli;
	}

	public boolean isChkCollSchTopografico() {
		return chkCollSchTopografico;
	}

	public void setChkCollSchTopografico(boolean chkCollSchTopografico) {
		this.chkCollSchTopografico = chkCollSchTopografico;
	}

	public boolean isChkStampaPiuInventari() {
		return chkStampaPiuInventari;
	}

	public void setChkStampaPiuInventari(boolean chkStampaPiuInventari) {
		this.chkStampaPiuInventari = chkStampaPiuInventari;
	}

	public boolean isChkStampaTitNonPoss() {
		return chkStampaTitNonPoss;
	}

	public void setChkStampaTitNonPoss(boolean chkStampaTitNonPoss) {
		this.chkStampaTitNonPoss = chkStampaTitNonPoss;
	}
	...
	/**
	 * @return Returns the listaNatura.
	 */
	...
	/**
	 * @param listaNatura The listaNatura to set.
	 */
	...
	public int getNumCollSchClassificazioni() {
		return numCollSchClassificazioni;
	}

	public void setNumCollSchClassificazioni(int numCollSchClassificazioni) {
		this.numCollSchClassificazioni = numCollSchClassificazioni;
	}

	public int getNumCollSchEditori() {
		return numCollSchEditori;
	}

	public void setNumCollSchEditori(int numCollSchEditori) {
		this.numCollSchEditori = numCollSchEditori;
	}

	public int getNumCollSchPossessori() {
		return numCollSchPossessori;
	}

	public void setNumCollSchPossessori(int numCollSchPossessori) {
		this.numCollSchPossessori = numCollSchPossessori;
	}

	public int getNumCollSchPrincipale() {
		return numCollSchPrincipale;
	}

	public void setNumCollSchPrincipale(int numCollSchPrincipale) {
		this.numCollSchPrincipale = numCollSchPrincipale;
	}

	public int getNumCollSchRichiami() {
		return numCollSchRichiami;
	}

	public void setNumCollSchRichiami(int numCollSchRichiami) {
		this.numCollSchRichiami = numCollSchRichiami;
	}

	public int getNumCollSchSoggetti() {
		return numCollSchSoggetti;
	}

	public void setNumCollSchSoggetti(int numCollSchSoggetti) {
		this.numCollSchSoggetti = numCollSchSoggetti;
	}

	public int getNumCollSchTitoli() {
		return numCollSchTitoli;
	}

	public void setNumCollSchTitoli(int numCollSchTitoli) {
		this.numCollSchTitoli = numCollSchTitoli;
	}

	public int getNumCollSchTopografico() {
		return numCollSchTopografico;
	}

	public void setNumCollSchTopografico(int numCollSchTopografico) {
		this.numCollSchTopografico = numCollSchTopografico;
	}

...
import it.iccu.sbn.web.actionforms.gestionesemantica.soggetto.ModLegameTraDescrForm;
...
public class ModLegameTraDescrAction extends LookupDispatchAction {

	private static Log log = LogFactory.getLog(ModLegameTraDescrAction.class);
	...
	protected ActionForward unspecified(ActionMapping mapping, ActionForm form,
		...
		ModLegameTraDescrForm currentForm = (ModLegameTraDescrForm) form;
		...
		String noteLegame = null;

		if (!currentForm.isSessione()) {
			log.info("ModLegameTraDescrAction::unspecified");
			...
			secondoLivelloAut = (String) request
					.getAttribute(NavigazioneSemantica.DID_ARRIVO_LEGAME_LIVELLO_AUTORITA);
			...
			tipoLegame = (String) request.getAttribute(NavigazioneSemantica.TIPO_LEGAME);
			noteLegame = (String) request.getAttribute(NavigazioneSemantica.NOTE_AL_LEGAME);
			currentForm.setDidPadre((String) request.getAttribute(NavigazioneSemantica.DID_RADICE_LEGAMI));
			currentForm.setCondiviso((Boolean)request.getAttribute(NavigazioneSemantica.OGGETTO_CONDIVISO_INDICE));
			...
			if (!ValidazioneDati.strIsNull(tipoSoggetto) )
			...
			currentForm.setNote(noteLegame);
	...
	public ActionForward ok(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			CreaVariaDescrittoreVO risposta = factory.getGestioneSemantica()
					.modificaLegameDescrittori(legame,
		...
		if (!ValidazioneDati.strIsNull(currentForm.getCid()) ) {

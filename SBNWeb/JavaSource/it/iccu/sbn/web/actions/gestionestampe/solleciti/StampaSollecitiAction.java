 ...
 ******************************************************************************/
package it.iccu.sbn.web.actions.gestionestampe.solleciti;

import it.iccu.sbn.web.actionforms.gestionestampe.solleciti.StampaSollecitiForm;
...
public class StampaSollecitiAction extends LookupDispatchAction {

	private StampaSollecitiForm ricSolleciti;
	...
	public ActionForward unspecified(ActionMapping mapping, ActionForm form,
		...
		ricSolleciti = (StampaSollecitiForm) form;
...
//		NavigationPathBO.updateNavigationPath(httpSession, form, mapping.getPath(), false);
	...
	throws Exception {
		...
		ricSolleciti = (StampaSollecitiForm) form;
		try {
			request.setAttribute("parametroPassato", ricSolleciti.getElemBlocco());
//			NavigationPathBO.updateNavigationPath(httpSession, form, mapping.getPath(), false);

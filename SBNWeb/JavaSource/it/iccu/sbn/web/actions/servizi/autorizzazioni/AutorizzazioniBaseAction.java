...
public abstract class AutorizzazioniBaseAction extends SinteticaLookupDispatchAction implements SbnAttivitaChecker {
	...
	public boolean checkAttivita(HttpServletRequest request, ActionForm form, String idCheck) {
		...
		try {
			if (ValidazioneDati.equals(idCheck, NavigazioneServizi.GESTIONE))
				ejb.checkAttivita(CodiciAttivita.getIstance().SERVIZI_AGGIORNA_DIRITTI_AUTORIZZAZIONE);

		  ...
		  <table   width="100%"  border="0" cellpadding="0" cellspacing="0">
             ...
             <tr><td class="etichettaIntestazione" colspan="8">&nbsp;</td></tr>
 		     ...
 		     <tr>
                        ...
                        <sbn:disableAll checkAttivita="ESAMINA"  inverted="true">
                        <td  valign="top" scope="col" colspan="6" align="left" style="width:280px;">
	                    	...
	                    	<html:submit  styleClass="buttonImage" property="methodEsaminaBuonoOrdine" disabled="${noinput}">
								<bean:message  key="ordine.label.fornitore" bundle="acquisizioniLabels" />
							</html:submit>
						</td>
						</sbn:disableAll>
		...
		<c:when test="${navForm.gestBil}">
		     ...
		     <tr>
		     		<sbn:disableAll checkAttivita="ESAMINA" inverted="true">
                        ...
                        <td scope="col" align="left">
						<html:text styleId="testoNormale" property="buono.bilancio.codice1" size="10" readonly="true" ></html:text>
                        </td>
                        <td scope="col" class="etichetta" align="left">
                        <bean:message  key="ordine.label.capitolo" bundle="acquisizioniLabels" />
                        </td>
                        <td scope="col" colspan="5" align="left">
						<html:text styleId="testoNormale" property="buono.bilancio.codice2" size="16" readonly="true" maxlength="16" ></html:text>
                        </td>
                    </sbn:disableAll>
		     </tr>
        </c:when>
					...
					<logic:greaterThan name="navForm" property="numOrdini" value="0">
					   ...
					   <c:set var="color" >
							...
							<!-- controllo se è stato selezionata l'operazione di inserimento riga -->
								<td scope="col" align="center">
									<html:select  style="width:40px;" styleClass="testoNormale"  name="elencaBuoni" indexed="true" property="tipoOrdine" disabled="${noinput}">
									<html:optionsCollection  property="listaTipoOrdine" value="codice" label="descrizione" />
									</html:select>
								</td>
								<td  scope="col" align="center">
								<html:text styleId="testoNormale" property="annoOrdine" size="4" name="elencaBuoni" indexed="true" disabled="${noinput}"></html:text>
								</td>
								<td  scope="col" align="center">
								<html:text styleId="testoNormale" property="codOrdine" size="2" name="elencaBuoni" indexed="true" disabled="${noinput}" ></html:text>
								</td>
							...
							<td align="center"><bean-struts:write  name="elencaBuoni" format="0.00" property="prezzoEuroOrdineStr"/></td>
...
<!--				<jsp:include page="/WEB-INF/jsp/subpages/acquisizioni/utility/confermaOperazione.jsp" />-->
				<table align="center">
					<tr>
						<td><html:submit styleClass="pulsanti" property="methodEsaminaBuonoOrdine">
								<bean:message key="acquisizioni.bottone.si" bundle="acquisizioniLabels" /></html:submit>
							<html:submit styleClass="pulsanti" property="methodEsaminaBuonoOrdine">
		...
		<logic:equal name="navForm" property="enableScorrimento" value="true">
             ...
             <sbn:checkAttivita idControllo="GESTIONE">
				<sbn:checkAttivita idControllo="ESAMINA" inverted="true">
					<html:submit styleClass="pulsanti" property="methodEsaminaBuonoOrdine">

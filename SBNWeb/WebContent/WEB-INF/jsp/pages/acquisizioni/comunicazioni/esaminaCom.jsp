...
<html:xhtml />
<layout:page>
	<sbn:navform action="/acquisizioni/comunicazioni/esaminaCom.do">
		<div id="divForm">
		<div id="divMessaggio"><sbn:errors bundle="acquisizioniMessages" />
		</div>
			...
			<tr>
				<sbn:disableAll checkAttivita="SIF_DA_PERIODICO" inverted="true">
					...
					<td scope="col" colspan="6" align="left"><html:text
						...
						styleClass="buttonImage" property="methodEsaminaCom"
						disabled="${noinput}">
			...
			<logic:equal name="navForm"
				...
				<tr>
					...
					<td scope="col" align="left"><html:text styleId="testoNormale"
						property="testoVuoto" size="4" readonly="${noinputOrd}"></html:text>
					<html:submit styleClass="buttonImage" property="methodEsaminaCom"
						disabled="${noinputOrd}">
			...
			<logic:equal name="navForm"
				...
				<tr>
					...
					<td bgcolor="#EBEBE4" colspan="5"><bs:write
						name="navForm"
						property="datiComunicazione.docORDINE.codice4" /></td>
				</tr>
		...
		<div id="divFooter"><c:choose>
			...
			<c:otherwise>
				<table align="center" border="0" style="height: 40px">
					<tr>
						<td><logic:equal name="navForm"
							property="enableScorrimento" value="true">
							<html:submit styleClass="pulsanti" property="methodEsaminaCom">
						...
						</logic:equal> <logic:equal name="navForm" property="disabilitaTutto"
							value="false">
							...
							<sbn:checkAttivita idControllo="GESTIONE">
								<logic:equal name="navForm"
									property="datiComunicazione.statoComunicazione" value="3">
									<html:submit styleClass="pulsanti" property="methodEsaminaCom">
										<bean:message key="ricerca.button.invia"
											bundle="acquisizioniLabels" />
									</html:submit>
								</logic:equal>
						...
						</logic:equal> <logic:notEqual name="navForm"
							property="datiComunicazione.direzioneComunicazione" value="D">
							<html:submit styleClass="pulsanti" property="methodEsaminaCom">
								<bean:message key="ricerca.button.stampa"
									bundle="acquisizioniLabels" />
							</html:submit>
						</logic:notEqual> <html:submit styleClass="pulsanti" property="methodEsaminaCom">

...
<logic:notEqual  name="esaminaFatturaNCForm" property="datiFatturaNC.fornitoreFattura.codice" value="">
		<bean-struts:define id="noinputForn"  value="true"/>
</logic:notEqual>

<c:choose>
<c:when test="${esaminaFatturaNCForm.disabilitaTutto}">
...
<html:xhtml />
<layout:page>
	<sbn:navform action="/acquisizioni/fatture/esaminaFatturaNC.do" >
  <div id="divForm">
		<div id="divMessaggio"><sbn:errors /></div>

<bean-struts:define id="tipoNC"  value="false"/>
<logic:equal  name="esaminaFatturaNCForm" property="datiFatturaNC.tipoFattura" value="N">
	<bean-struts:define id="tipoNC"  value="true"/>
		...
		<table  width="100%" border="0">
		     <tr>
                        ...
                        <td scope="col" align="left">
							<html:text styleId="testoNormale" name="esaminaFatturaNCForm" property="datiFatturaNC.codBibl" size="4" readonly="true" ></html:text>
                        </td>
                        <td  width="10%" scope="col" class="etichetta" align="left">
                  			<bean:message  key="ricerca.label.annoFatt" bundle="acquisizioniLabels" />
                        </td>
                        <td scope="col" align="left">
							<html:text styleId="testoNormale" name="esaminaFatturaNCForm" property="datiFatturaNC.annoFattura" size="4" readonly="${noinput}"></html:text>
                        </td>
                        <td width="5%" scope="col" class="etichetta" align="left">
                  			<bean:message  key="ricerca.label.progr" bundle="acquisizioniLabels" />
                        </td>
                        <td scope="col"  align="left">
							<html:text styleId="testoNormale" name="esaminaFatturaNCForm" property="datiFatturaNC.progrFattura" size="4" readonly="true" ></html:text>
                        </td>
		     </tr>
		     <tr>
                        <td  class="etichetta" width="10%" scope="col" align="left">
                        ...
                        <td scope="col" align="left">
							<html:text styleId="testoNormale" name="esaminaFatturaNCForm" property="datiFatturaNC.dataRegFattura" size="10" readonly="${noinput}" ></html:text>
                        </td>
                        <td  width="10%" scope="col" class="etichetta" align="left">
                  			<bean:message  key="ricerca.label.tipoOrdine" bundle="acquisizioniLabels" />
                        </td>
                        <td scope="col" align="left">
				        <html:select  styleClass="testoNormale"  property="datiFatturaNC.tipoFattura" style="width:40px;" onchange="this.form.submit();" disabled="${noinput}">
		     ...
		     <tr>
                        ...
                        <td scope="col" align="left">
							<html:text styleId="testoNormale" name="esaminaFatturaNCForm" property="datiFatturaNC.dataFattura" size="10" readonly="${noinput}"></html:text>
                        </td>
                        <td  width="10%" scope="col" class="etichetta" align="left">
                  			<bean:message  key="ricerca.label.nr" bundle="acquisizioniLabels" />
                        </td>
                        <td scope="col"  align="left">
							<html:text styleId="testoNormale" name="esaminaFatturaNCForm" property="datiFatturaNC.numFattura" size="4" readonly="${noinput}"></html:text>
                        </td>
		     </tr>
		     ...
		     <tr>
                        ...
                        <td scope="col" align="left">
							<html:text styleId="testoNormale" name="esaminaFatturaNCForm" property="datiFatturaNC.importoFatturaStr" size="10" readonly="${noinput}"></html:text>
                        </td>
                        <td  width="10%" scope="col" class="etichetta" align="left">
                  			<bean:message  key="ricerca.label.sconto" bundle="acquisizioniLabels" />
                        </td>
                        <td scope="col" ><div align="left">
							<html:text styleId="testoNormale" name="esaminaFatturaNCForm" property="datiFatturaNC.scontoFatturaStr" size="10" readonly="${noinput}"></html:text>
                        </td>
		     </tr>
		     <tr>
                        <td  class="etichetta" width="10%" scope="col" align="left">
                        ...
                        <td scope="col"  align="left">
    						<bean-struts:write format="0.00" name="esaminaFatturaNCForm" property="datiFatturaNC.cambioFattura" />
                        </td>
                        <td  width="10%" scope="col" class="etichetta" align="left">
                  			<bean:message  key="ordine.label.stato" bundle="acquisizioniLabels" />
                        </td>
                        <td scope="col" align="left">
						<html:select  styleClass="testoNormale"  property="datiFatturaNC.statoFattura"  disabled="true">
			 ...
			 <tr>
                        ...
                        <td scope="col" colspan="7" align="left">
					 		<html:text styleId="testoNormale" property="datiFatturaNC.fornitoreFattura.codice" size="5"  maxlength="10" readonly="${noinputForn}"></html:text>
	 						<html:text styleId="testoNormale" property="datiFatturaNC.fornitoreFattura.descrizione" size="45" readonly="${noinputForn}"></html:text>
	                    	<html:submit  styleClass="buttonImage" property="methodEsaminaFatturaNC" disabled="${noinputForn}">
								<bean:message  key="ordine.label.fornitore" bundle="acquisizioniLabels" />
							</html:submit>
						</td>
             </tr>
		...
		<logic:greaterThan name="esaminaFatturaNCForm" property="numRigheFatt" value="0">
			<logic:iterate id="elencaRigheFatt" property="datiFatturaNC.righeDettaglioFattura" name="esaminaFatturaNCForm" indexId="indice">
			   <c:set var="color" >
					<c:choose>
					...
					<!-- controllo se è stato selezionata l'operazione di inserimento riga (non altre spese) -->
				  	<tr class="testoNormale" bgcolor="${color}">
						<td  scope="col" align="center">
							<html:text styleId="testoNormale"  name="elencaRigheFatt" property="rigaFattura" size="1" readonly="true" ></html:text>
						</td>
						<td  scope="col" align="center">
							<html:text styleId="testoNormale"    name="elencaRigheFatt" property="importoRigaFatturaStr" size="5" readonly="${noinput}"></html:text>
						</td>
						<td  scope="col" align="center">
							<html:text styleId="testoNormale"    name="elencaRigheFatt" property="sconto1RigaFatturaStr" size="2" readonly="${noinput}"></html:text>
						</td>
						<td  scope="col" align="center">
							<html:text styleId="testoNormale"   name="elencaRigheFatt" property="sconto2RigaFatturaStr" size="2" readonly="${noinput}"></html:text>
						</td>
						<td scope="col" align="center">
							<html:select  styleClass="testoNormale"    name="elencaRigheFatt"  property="codIvaRigaFattura" style="width:40px;" disabled="${noinput}">
							<html:optionsCollection  property="listaIva" value="codice" label="descrizione" />
							</html:select>
						</td>
						<logic:equal name="elencaRigheFatt" property="codPolo"  value="*" >
							<td scope="col" align="center">
								<html:select  styleClass="testoNormale"   name="elencaRigheFatt"  property="ordine.codice1" style="width:40px;" disabled="true">
								<html:optionsCollection  property="listaTipoOrdine" value="codice" label="descrizioneCodice" />
								</html:select>
							</td>
							<td  scope="col" align="center">
								<html:text styleId="testoNormale" name="elencaRigheFatt"   property="ordine.codice2" size="4" readonly="true" ></html:text>
							</td>
							<td  scope="col" align="center">
								<html:text styleId="testoNormale" name="elencaRigheFatt"   property="ordine.codice3" size="4" readonly="true" ></html:text>
						...
						<logic:notEqual  name="elencaRigheFatt" property="codPolo"  value="*" >
							<td scope="col" align="center">
								<html:select  styleClass="testoNormale"   name="elencaRigheFatt"  property="ordine.codice1" style="width:40px;" disabled="${noinput}">
								<html:optionsCollection  property="listaTipoOrdine" value="codice" label="descrizioneCodice" />
								</html:select>
							</td>
							<td  scope="col" align="center">
								<html:text styleId="testoNormale" name="elencaRigheFatt"   property="ordine.codice2" size="4" readonly="${noinput}" ></html:text>
							</td>
							<td  scope="col" align="center">
								<html:text styleId="testoNormale" name="elencaRigheFatt"   property="ordine.codice3" size="4" readonly="${noinput}" ></html:text>
								<c:choose>
								<c:when test="${esaminaFatturaNCForm.disabilitaTutto}">
						...
						<td  scope="col" align="center">
							<html:text styleId="testoNormale" name="elencaRigheFatt"   property="bilancio.codice1" size="4" readonly="${noinput}" ></html:text>
						</td>
						<td  scope="col" align="center">
							<html:text styleId="testoNormale" name="elencaRigheFatt"   property="bilancio.codice2" size="4" maxlength="16" readonly="${noinput}" ></html:text>
						</td>
						<td  scope="col" align="center">
							<html:select  styleClass="testoNormale" name="elencaRigheFatt"    property="bilancio.codice3" style="width:40px;" disabled="${noinput}">
...
<!--							<input type="submit"  class="buttonImageInv"  name="tagInv" value="" title="legami inventario"></input>-->
             <sbn:checkAttivita idControllo="GESTIONE">
						...
						<td  class="testoNormale" align="center">
							<html:radio property="radioRFattNC" value="${operazioneValue}"></html:radio>
						</td>
					</tr>
		<c:choose>
			<c:when test="${tipoNC}">
				  	<tr class="testoNormale" bgcolor="${color}">
						...
						<td  scope="col" align="right" colspan="6">
						...
						<td  scope="col" align="center">
							<html:text styleId="testoNormale" name="elencaRigheFatt"   property="fattura.codice1" size="4" readonly="${noinput}" ></html:text>
						</td>
						<td  scope="col" align="center">
							<html:text styleId="testoNormale" name="elencaRigheFatt"   property="fattura.codice2" size="4" readonly="${noinput}" ></html:text>
						</td>
						<td  scope="col" align="center">
							<html:text styleId="testoNormale" name="elencaRigheFatt"   property="fattura.codice3" size="4" readonly="${noinput}" ></html:text>
							<c:choose>
							<c:when test="${esaminaFatturaNCForm.disabilitaTutto}">
	  							  <input type="submit"  class="buttonImageListaSezione"  name="bottoneFattura" value="${indice}" title="ricerca fattura" disabled="disabled"></input>
							</c:when>
							<c:otherwise>
	  							  <input type="submit"  class="buttonImageListaSezione"  name="bottoneFattura" value="${indice}" title="ricerca fattura"></input>
							</c:otherwise>
							</c:choose>
					...
					<c:choose>
						<c:when test="${esaminaFatturaNCForm.clicNotaPrg == varLink }">
							  	<tr class="testoNormale" bgcolor="${color}" >
									<td colspan="14" scope="col" align="center" >
									  <bean-struts:define id="varLink"  value=""  />
			                  			<bean:message  key="ricerca.label.note" bundle="acquisizioniLabels" />
										<html:textarea styleId="testoNormale"  name="elencaRigheFatt"    property="noteRigaFattura" rows="1" cols="100"   ></html:textarea>
										<sbn:tastiera limit="80" name="esaminaFatturaNCForm"  property="elencaRigheFatt[${indice}].noteRigaFattura"></sbn:tastiera>
									</td>
								</tr>
						</c:when>
					</c:choose>
  ...
  <div id="divFooter">
		<c:choose>
			<c:when test="${esaminaFatturaNCForm.conferma}">
           ...
           <table align="left"  border="0" width="100%" >
            ...
            <tr>
             ...
             <sbn:checkAttivita idControllo="GESTIONE">
					...
					<html:submit styleClass="pulsanti" property="methodEsaminaFatturaNC">
             ...
             <sbn:checkAttivita idControllo="GESTIONE">
				...
				<logic:equal name="esaminaFatturaNCForm" property="datiFatturaNC.statoFattura" value="2">
							<html:submit styleClass="pulsanti" property="methodEsaminaFatturaNC">
            ...
            <tr>
             ...
             <sbn:checkAttivita idControllo="GESTIONE">
					...
					<logic:equal name="esaminaFatturaNCForm" property="enableScorrimento" value="true">
								<html:submit styleClass="pulsanti" property="methodEsaminaFatturaNC">

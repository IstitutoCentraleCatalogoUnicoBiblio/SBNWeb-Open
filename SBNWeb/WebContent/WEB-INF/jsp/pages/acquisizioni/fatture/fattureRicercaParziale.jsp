...
<html:xhtml />
<layout:page>
	<sbn:navform action="/acquisizioni/fatture/fattureRicercaParziale.do">
  <div id="divForm">
		  ...
		  <table  border="0"  width="100%" >
		     <tr>
                        ...
                        <td scope="col" align="left">
	                        ...
	                        <html:submit title="elenco" styleClass="buttonImageListaSezione" property="methodFattureRicercaParziale" >
		     ...
		     <tr>
                        <td scope="col" class="etichetta" align="left">
                  			<bean:message  key="ricerca.label.tipoFatt" bundle="acquisizioniLabels" />
                        </td>
                        <td scope="col"  align="left">
		     ...
		     <tr>
					 <td class="etichetta"  valign="top" >
                        ...
                        <td colspan="4"  valign="top"  align="left" >
				 		  <html:text styleId="testoNormale" property="fornitore1.codice" size="5"  maxlength="10" readonly="${noinput}"></html:text>
 						<html:text styleId="testoNormale" property="fornitore1.descrizione" size="45" readonly="${noinput}"></html:text>
                    	<html:submit  styleClass="buttonImage" property="methodFattureRicercaParziale" disabled="${noinput}">
							<bean:message  key="ordine.label.fornitore" bundle="acquisizioniLabels" />
						</html:submit>
                     </td>
 ...
 <div id="divFooter">
			...
			<html:submit styleClass="pulsanti" property="methodFattureRicercaParziale">
				<bean:message key="ricerca.button.cerca" bundle="acquisizioniLabels" />
			</html:submit>
			</sbn:checkAttivita>

		<c:choose>
			<c:when test="${!fattureRicercaParzialeForm.LSRicerca}">
			...
			<c:choose>
				<c:when test="${fattureRicercaParzialeForm.visibilitaIndietroLS}">
					<html:submit styleClass="pulsanti" property="methodFattureRicercaParziale">

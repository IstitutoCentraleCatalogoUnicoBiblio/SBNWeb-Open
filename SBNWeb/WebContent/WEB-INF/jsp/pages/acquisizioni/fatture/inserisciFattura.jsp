...
<logic:notEqual  name="inserisciFatturaForm" property="datiFattura.fornitoreFattura.codice" value="">
		<bean-struts:define id="noinputForn"  value="true"/>
</logic:notEqual>

<c:choose>
<c:when test="${inserisciFatturaForm.disabilitaTutto}">
...
<html:xhtml />
<layout:page>
	<sbn:navform action="/acquisizioni/fatture/inserisciFattura.do">
  <div id="divForm">
...
<logic:equal  name="inserisciFatturaForm" property="datiFattura.tipoFattura" value="N">
	<bean-struts:define id="tipoNC"  value="true"/>
		...
		<table  width="100%" border="0">
		     <tr>
                        ...
                        <td scope="col" align="left">
							<html:text styleId="testoNormale" name="inserisciFatturaForm" property="datiFattura.codBibl" size="4" readonly="true" ></html:text>
	                        <html:submit title="elenco" styleClass="buttonImageListaSezione" property="methodInserisciFattura" disabled="${noinput}">
                        ...
                        <td scope="col" align="left">
							<html:text styleId="testoNormale" name="inserisciFatturaForm" property="datiFattura.annoFattura" size="4" readonly="${noinput}"></html:text>
                        </td>
                        <td width="5%" scope="col" class="etichetta" align="left">
                  			<bean:message  key="ricerca.label.progr" bundle="acquisizioniLabels" />
                        </td>
                        <td scope="col"  align="left">
							<html:text styleId="testoNormale" name="inserisciFatturaForm" property="datiFattura.progrFattura" size="4" readonly="true" ></html:text>
                        </td>
		     </tr>
		     <tr>
                        <td  class="etichetta" width="10%" scope="col" align="left">
                        ...
                        <td scope="col" align="left">
							<html:text styleId="testoNormale" name="inserisciFatturaForm" property="datiFattura.dataRegFattura" size="10" readonly="${noinput}" ></html:text>
                        </td>
                        <td  width="10%" scope="col" class="etichetta" align="left">
		     ...
		     <tr>
                        ...
                        <td scope="col" align="left">
							<html:text styleId="testoNormale" name="inserisciFatturaForm" property="datiFattura.dataFattura" size="10" readonly="${noinput}"></html:text>
                        </td>
                        <td  width="10%" scope="col" class="etichetta" align="left">
                  			<bean:message  key="ricerca.label.nr" bundle="acquisizioniLabels" />
                        </td>
                        <td scope="col"  align="left">
							<html:text styleId="testoNormale" name="inserisciFatturaForm" property="datiFattura.numFattura" size="4" readonly="${noinput}"></html:text>
                        </td>
		     </tr>
		     ...
		     <tr>
                        ...
                        <td scope="col" align="left">
							<html:text styleId="testoNormale" name="inserisciFatturaForm" property="datiFattura.importoFatturaStr" size="10" readonly="${noinput}"></html:text>
                        </td>
                        <td  width="10%" scope="col" class="etichetta" align="left">
                  			<bean:message  key="ricerca.label.sconto" bundle="acquisizioniLabels" />
                        </td>
                        <td scope="col" ><div align="left">
							<html:text styleId="testoNormale" name="inserisciFatturaForm" property="datiFattura.scontoFatturaStr" size="10" readonly="${noinput}"></html:text>
                        </td>
		     </tr>
		     <tr>
                        <td  class="etichetta" width="10%" scope="col" align="left">
                        ...
                        <td scope="col"  align="left">
    						<bean-struts:write format="0.00" name="inserisciFatturaForm" property="datiFattura.cambioFattura" />
                        </td>
                        <td  width="10%" scope="col" class="etichetta" align="left">
			 ...
			 <tr>
                        ...
                        <td scope="col" colspan="7" align="left">
	                    	...
	                    	<html:submit  styleClass="buttonImage" property="methodInserisciFattura" disabled="${noinputForn}">
								<bean:message  key="ordine.label.fornitore" bundle="acquisizioniLabels" />
							</html:submit>
						</td>
             </tr>
		     ...
		     <tr>
                  <td colspan="8">
				  	...
				  	<tr class="etichetta" bgcolor="#dde8f0">
						...
						<c:choose>
						<c:when test="${inserisciFatturaForm.gestBil}">
							<td scope="col" colspan="3" align="center" style="width: 30%;">
		...
		<logic:greaterThan name="inserisciFatturaForm" property="numRigheFatt" value="0">
			<logic:iterate id="elencaRigheFatt" property="elencaRigheFatt" name="inserisciFatturaForm" indexId="indice">
			   <c:set var="color" >
					<c:choose>
...
<!--							<html:text styleId="testoNormale" indexed="true" name="elencaRigheFatt" property="rigaFattura" size="1" readonly="true" ></html:text>-->
						...
						<logic:equal name="elencaRigheFatt" property="codPolo"  value="*" >
							<!-- controllo se è stato selezionata l'operazione di inserimento riga (solo per altre spese) -->
							<td scope="col" align="center">
						...
						<c:when test="${inserisciFatturaForm.gestBil}">
							...
							<td  scope="col" align="center">
								<html:text styleId="testoNormale" name="elencaRigheFatt" indexed="true" property="bilancio.codice2" size="16" maxlength="16" readonly="${noinput}" ></html:text>
							</td>
							<logic:equal name="elencaRigheFatt" property="codPolo"  value="*" >
								<td  scope="col" align="center">
									<html:select  styleClass="testoNormale" name="elencaRigheFatt" indexed="true"  property="bilancio.codice3" style="width:40px;" disabled="true">
...
<!-- 						  <html:link action="/acquisizioni/fatture/*.do" ><img border="0"   alt="legami inventario"  src='<c:url value="/images/inv.GIF" />'/></html:link>-->
						...
						<td  class="testoNormale" align="center">
							<html:radio property="radioRFatt" value="${indice}"></html:radio>
						</td>
					</tr>
		<c:choose>
			<c:when test="${tipoNC}">
				  	<tr class="testoNormale" bgcolor="${color}">
						...
						<td  scope="col" align="center">
							...
							<c:choose>
							<c:when test="${inserisciFatturaForm.disabilitaTutto}">
 							  <input type="submit"  class="buttonImage"  name="bottoneFattura" value="${indice}" title="ricerca fatture" disabled="disabled"></input>
							</c:when>
							<c:otherwise>
 							  <input type="submit"  class="buttonImage"  name="bottoneFattura" value="${indice}" title="ricerca fatture"></input>
							</c:otherwise>
							</c:choose>
						</td>
						<c:choose>
						...
						<c:choose>
						<c:when test="${inserisciFatturaForm.clicNotaPrg == varLink }">
							  	<tr class="testoNormale" bgcolor="${color}" >
									<td colspan="14" scope="col" align="center" >
									  <bean-struts:define id="varLink"  value=""  />
			                  			<bean:message  key="ricerca.label.note" bundle="acquisizioniLabels" />
										<html:textarea style="background-color: #FFFFCC;" styleId="testoNormale"  name="elencaRigheFatt" indexed="true"  property="noteRigaFattura" rows="1" cols="100"   ></html:textarea>
										<sbn:tastiera limit="80" name="inserisciFatturaForm"  property="elencaRigheFatt[${indice}].noteRigaFattura"></sbn:tastiera>
  ...
  <div id="divFooter">
		<c:choose>
			<c:when test="${inserisciFatturaForm.conferma}">
		           ...
		           <table align="left"  border="0" width="100%" >
					...
					<c:choose>
						<c:when test="${!inserisciFatturaForm.disabilitaTutto}">
							...
							<html:submit styleClass="pulsanti" property="methodInserisciFattura">
					...
					<!-- Bug collaudo 4455 sul dettaglio di una fattura è presente il tasto stampa che permette di stampare online
						...
						è stata effettuata la modifica affinche il salva appaia anche il bottone stampa
					-->
					<c:choose>
						<c:when test="${inserisciFatturaForm.fatturaSalvata}">
							<html:submit styleClass="pulsanti" property="methodInserisciFattura">
		            ...
		            <tr>
		             <td align="center" >
						...
						<c:choose>
							...
							<logic:equal  name="inserisciFatturaForm" property="visibilitaIndietroLS" value="true">
								<html:submit  styleClass="pulsanti" property="methodInserisciFattura">

...
<logic:notEqual  name="ordineRicercaParzialeBoForm" property="disabilitaFornitore" value="false">
		<bean-struts:define id="noinputForn"  value="true"/>
</logic:notEqual>


<c:choose>
<c:when test="${ordineRicercaParzialeBoForm.disabilitaTutto}">
...
<html:xhtml />
<layout:page>
	<sbn:navform action="/acquisizioni/ordini/ordineRicercaParzialeBo.do">
	<div id="divForm">
    ...
    <table   width="100%"  align="center"  >
		  ...
		  <table   width="100%" border="0">
		     <tr>
                        ...
                        <html:submit title="elenco" styleClass="buttonImageListaSezione" property="methodOrdineRicercaParzialeBo" disabled="${noinput}">
                        ...
                        -->
				<c:choose>
					<c:when test="${ordineRicercaParzialeBoForm.gestSez}">
                        ...
                        <div align="left" valign="top">
              			<html:text styleId="testoNormale" property="sezione" size="7" maxlength="7" readonly="${noinput}" ></html:text>
       				    <!--
	        ...
	        <tr  >
	          ...
	          <td class="etichetta" colspan="4" >
					...
					<td valign="top" align="left">
					  <html:text styleId="testoNormale"   property="titolo.codice" size="10" readonly="${noinput}"></html:text>
					</td>
					<td bgcolor="#EBEBE4" valign="top" align="left" >
						<bean-struts:write  name="ordineRicercaParzialeBoForm" property="titolo.descrizione" />
					</td>
					<td valign="top" align="left">
                        <html:submit title="ricerca" styleClass="buttonImage" property="methodOrdineRicercaParzialeBo" disabled="${noinput}">
...
<!--			  <html:link action="/gestionebibliografica/titolo/interrogazioneTitolo.do"  ><img border="0"   alt="ricerca titolo"  src='<c:url value="/images/lente.GIF" />'/></html:link>-->
		     ...
		     <tr >
                        ...
                        <td valign="top" colspan="4" scope="col" align="left" >
				 		  <html:text styleId="testoNormale" property="codFornitore" size="5"  maxlength="10" readonly="${noinputForn}"></html:text>
				 		  <html:text styleId="testoNormale" property="fornitore" size="40"  maxlength="40" readonly="${noinputForn}"></html:text>
       				    <!--
                        ...
                        -->
                        <html:submit  styleClass="buttonImage" property="methodOrdineRicercaParzialeBo" disabled="${noinputForn}">
							<bean:message  key="ordine.label.fornitore" bundle="acquisizioniLabels" />
						</html:submit>
                        </td>
		     ...
		     <tr>
                        ...
                        <td>
				 		  	<html:text styleId="testoNormale" property="dataOrdineDa" size="10" readonly="${noinput}"></html:text>
                        </td>
                        <td colspan="2" align="left" class="etichetta">
                        	<bean:message  key="ricerca.label.dataOrdineA" bundle="acquisizioniLabels" />
				 		  <html:text styleId="testoNormale" property="dataOrdineA" size="10" readonly="${noinput}"></html:text>
		     ...
		     <tr>
                        ...
                        <td>
				 		  	<html:text styleId="testoNormale" property="dataStampaOrdineDa" size="10" readonly="${noinput}"></html:text>
                        </td>
                        <td colspan="2" align="left" class="etichetta">
                        	<bean:message  key="ricerca.label.dataStampaOrdineA" bundle="acquisizioniLabels" />
				 		  <html:text styleId="testoNormale" property="dataStampaOrdineA" size="10" readonly="${noinput}"></html:text>
                        	<bean:message  key="ordine.data.formato" bundle="acquisizioniLabels" />
			...
			<tr>
                        ...
                        <td>
				 		  <html:text styleId="testoNormale" property="dataOrdineAbbDa" size="10" readonly="${noinput}"></html:text>
                        </td>
						<td colspan="2" class="etichetta">
						<bean:message  key="ricerca.label.dataOrdineAbbA" bundle="acquisizioniLabels" />
				 		<html:text styleId="testoNormale" property="dataOrdineAbbA" size="10" readonly="${noinput}"></html:text>
                        	<bean:message  key="ordine.data.formato" bundle="acquisizioniLabels" />
				...
				<c:choose>
					<c:when test="${ordineRicercaParzialeBoForm.gestBil}">
				     <tr>
		                        <td scope="col"  align="left" class="etichetta">
		                        	<bean:message  key="ordine.label.esercizio" bundle="acquisizioniLabels" />
		                        </td>
		                        <td scope="col" align="left">
		                        <html:text styleId="testoNormale" property="esercizio" size="4" readonly="${noinput}"></html:text>
		                        </td>
		                        <td  scope="col" align="left" class="etichetta">
		                        <bean:message  key="ordine.label.capitolo" bundle="acquisizioniLabels" />
		                        <html:text styleId="testoNormale" property="capitolo" size="16" maxlength="16" readonly="${noinput}"></html:text>
		                        </td>
		                        ...
		                        -->
		                        <html:submit  styleClass="buttonImage" property="methodOrdineRicercaParzialeBo" disabled="${noinput}">
...
<!--
					 ...
					 <html:radio property="stampato" value="true" disabled="${noinput}"/>
...
<div id="divFooterCommon">
 ...
 <div id="divFooter">
           <table align="center" border="0" style="height:40px" >
			...
			<html:submit styleClass="pulsanti" property="methodOrdineRicercaParzialeBo">
				<bean:message key="ricerca.button.cerca" bundle="acquisizioniLabels" />
			</html:submit>
			</sbn:checkAttivita>
		<c:choose>
			<c:when test="${!ordineRicercaParzialeBoForm.LSRicerca}">
		...
		<c:choose>
			<c:when test="${ordineRicercaParzialeBoForm.visibilitaIndietroLS}">
				<html:submit styleClass="pulsanti" property="methodOrdineRicercaParzialeBo">

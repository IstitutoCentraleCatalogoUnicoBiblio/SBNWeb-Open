...
<bean-struts:define id="chiusa"  value="false"/>

<c:choose>
<c:when test="${esaminaSezioneForm.sezione.chiusa}">
...
<c:choose>
<c:when test="${esaminaSezioneForm.disabilitaTutto}">
	<bean-struts:define id="noinput"  value="true"/>
	<bean-struts:define id="chiusa"  value="true"/>
</c:when>
</c:choose>

<html:xhtml />
<layout:page>
	<sbn:navform action="/acquisizioni/sezioni/esaminaSezione.do">
  <div id="divForm">
  	<div id="divMessaggio">
		...
		<table   width="100%" border="0">
		     ...
		     <tr>
                        ...
                        <td colspan="2"  scope="col" align="left">
                        	<html:text styleId="testoNormale"  property="sezione.codiceSezione" size="7" readonly="true"></html:text>
                        </td>
			</tr>
		     <tr>
						<td  class="etichetta"  scope="col" align="left">
		     ...
		     <tr>
                        ...
                        <td   scope="col" align="left">
     					  	<bean-struts:write format="0.00" name="esaminaSezioneForm" property="sezione.sommaDispSezione" />
                        </td>
						<td  class="etichetta"  scope="col" align="left">
	                        <bean:message  key="ricerca.label.dataAgg" bundle="acquisizioniLabels" />
                        	<html:text styleId="testoNormale"  property="sezione.dataAgg" size="10" readonly="true"></html:text>
                        </td>
		     ...
		     <tr>
                        ...
                        <td scope="col" align="left">
                        	<html:text styleId="testoNormale"  property="sezione.budgetSezione" size="20" readonly="${noinput}" ></html:text>
                        </td>
                        -->
                        <td scope="col" align="left">
                       ...
                       <td scope="col" align="left" class="etichetta" >
                        	...
                        	<html:text styleId="testoNormale"  property="sezione.dataVal" size="10" readonly="${chiusa}" ></html:text>
		     ...
		     <tr>
						...
						<c:choose>
						<c:when test="${esaminaSezioneForm.disabilitaTutto eq false}">
							<sbn:tastiera limit="80" property="sezione.noteSezione" name="esaminaSezioneForm"></sbn:tastiera>
						</c:when>
						</c:choose>
                        </td>
  ...
  <div id="divFooter">
				...
				<!-- tabella bottoni -->
		<c:choose>
			<c:when test="${esaminaSezioneForm.conferma}">
		           ...
		           <table align="center"  border="0" style="height:40px" >
					<tr>
		             <td  valign="top" align="center">
						<logic:equal name="esaminaSezioneForm" property="enableScorrimento" value="true">
									<html:submit styleClass="pulsanti" property="methodEsaminaSezione">
						...
						<logic:equal name="esaminaSezioneForm" property="disabilitaTutto" value="false">
						...
						<html:submit styleClass="pulsanti" property="methodEsaminaSezione">
							<bean:message key="button.esaminaSpesa" bundle="acquisizioniLabels" />
						</html:submit>
			 			...
			 			<html:submit styleClass="pulsanti" property="methodEsaminaSezione">
							<bean:message key="button.esaminaStoria" bundle="acquisizioniLabels" />
						</html:submit>

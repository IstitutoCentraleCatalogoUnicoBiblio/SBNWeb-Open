...
<%@page import="it.iccu.sbn.web.actionforms.amministrazionesistema.polo.ProfilazioneAuthoritiesForm;"%>
<html:xhtml />
<layout:page>
<div>
		<div id="divForm">
<sbn:navform action="/amministrazionesistema/abilitazionePolo/profilazionePoloAuthorities.do">
			<div id="divMessaggio">
					<sbn:errors bundle="amministrazioneSistemaMessages" />
			</div>
<!--html:form action="/amministrazionesistema/abilitazionePolo/profilazionePoloAuthorities.do"-->
		...
		<table align="center" border="0" width="100%">
			...
			<br/>
			 ...
			 <table class="sintetica">
				...
				<logic:iterate id="item" property="elencoAuth" name="profilazionePoloAuthoritiesForm" indexId="riga">

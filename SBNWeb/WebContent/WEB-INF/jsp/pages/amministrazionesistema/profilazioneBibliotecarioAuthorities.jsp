...
<%@page import="it.iccu.sbn.web.actionforms.amministrazionesistema.bibliotecario.ProfilazioneAuthoritiesForm;"%>
<html:xhtml />
<layout:page>
<div>
		<div id="divForm">
<sbn:navform action="/amministrazionesistema/abilitazioneBibliotecario/profilazioneBibliotecarioAuthorities.do">
			<div id="divMessaggio">
		...
		<table align="center" border="0" width="100%">
			<tr>
				<td align="left" style="font-weight: bold; font-size: 15px" width="100%">
					<bean:message key="profilo.polo.parametri.auth" bundle="amministrazioneSistemaLabels"/>:
				</td>
			</tr>
			<tr>
				<td>
					<b><bean:message key="profilo.bibliotecario.parametri.nome" bundle="amministrazioneSistemaLabels"/>: </b>
					<c:out value="${profilazioneBibliotecarioAuthoritiesForm.nomeUtente}"></c:out>
					<b><bean:message key="profilo.bibliotecario.parametri.biblioteca" bundle="amministrazioneSistemaLabels"/>: </b>
					<c:out value="${profilazioneBibliotecarioAuthoritiesForm.nomeBiblioteca}"></c:out>
					<b><bean:message key="profilo.bibliotecario.parametri.user" bundle="amministrazioneSistemaLabels"/>: </b>
					<c:out value="${profilazioneBibliotecarioAuthoritiesForm.nomeUser}"></c:out>
				</td>
			</tr>
		</table>
			...
			<br/>
			 ...
			 <table class="sintetica">
				...
				<logic:iterate id="item" property="elencoAuth" name="profilazioneBibliotecarioAuthoritiesForm" indexId="riga">
		...
		<div id="divFooter">
			<table align="center" border="0" style="height:40px">
				<tr>
					<td align="center">
						<c:choose>
							<c:when test="${profilazioneBibliotecarioAuthoritiesForm.abilitatoWrite eq 'TRUE'}">
								<html:submit styleClass="pulsanti" property="methodProfilazioneParametriAuth">

...
<%@page import="it.iccu.sbn.web.actionforms.amministrazionesistema.bibliotecario.ProfilazioneMaterialiForm;"%>
<html:xhtml />
<layout:page>
<div>
<sbn:navform action="/amministrazionesistema/abilitazioneBibliotecario/profilazioneBibliotecarioMateriali.do">
			<div id="divMessaggio">
		...
		<table align="center" border="0" width="100%">
			...
			<tr>
				<td>
					...
					<c:out value="${profilazioneBibliotecarioMaterialiForm.nomeUt}"></c:out>
					<b><bean:message key="profilo.bibliotecario.parametri.biblioteca" bundle="amministrazioneSistemaLabels"/>: </b>
					<c:out value="${profilazioneBibliotecarioMaterialiForm.nomeBiblio}"></c:out>
					<b><bean:message key="profilo.bibliotecario.parametri.user" bundle="amministrazioneSistemaLabels"/>: </b>
					<c:out value="${profilazioneBibliotecarioMaterialiForm.nomeUsername}"></c:out>
				</td>
			</tr>
		</table>
			...
			<br/>
			 ...
			 <table class="sintetica">
				...
				<logic:iterate id="item" property="elencoParMat" name="profilazioneBibliotecarioMaterialiForm" indexId="riga">
											...
											<c:when test="${pmtr.tipo eq 'RADIO'}">
												<td  style="text-align: center">
													<logic:iterate id="opzione" property="radioOptions" name="pmtr">
														<html:radio property="elencoParMat[${item.indice}].elencoParametri[${pmtr.index}].selezione"
		...
		<div id="divFooter">
			<table align="center" border="0" style="height:40px">
				<tr>
					<td align="center">
						<c:choose>
							<c:when test="${profilazioneBibliotecarioMaterialiForm.abilitatoWrite eq 'TRUE'}">

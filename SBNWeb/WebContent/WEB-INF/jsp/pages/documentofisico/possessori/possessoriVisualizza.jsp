...
<html:xhtml/>
<layout:page>
	<sbn:navform action="/documentofisico/possessori/possessoriVisualizza.do">
		...
		<table border="0">
			<tr>
				...
				<td class="testoNormale">
					<html:select property="possDettVO.livello" style="width:40px" disabled="true">
				...
				<td class="testoNormale">
					<html:select property="possDettVO.tipoTitolo" style="width:40px" disabled="true">
		...
		<table>
			...
			<tr>
				...
				<td width="500" class="testoNormale">
					<html:textarea property="possDettVO.nome" rows="3" cols="70" readonly="true"></html:textarea>
				</td>
			</tr>
			<tr>
				<td width="80" class="etichetta">
				...
				<td width="500" class="testoNormale">
					<html:textarea property="possDettVO.nota" rows="3" cols="70"readonly="true" ></html:textarea>
				</td>
			</tr>
		</table>
		...
		<table>
			<tr>
				<td width="100" class="etichetta">
					<bean:message key="documentofisico.dettaglio.datains" bundle="documentoFisicoLabels" />
				</td>
				<td width="100" class="testoNormale">
					<html:text property="possDettVO.dataIns" size="10" maxlength="10" readonly="true"></html:text>
				</td>

				<td width="120" class="etichetta">
					<bean:message key="documentofisico.dettaglio.datavar" bundle="documentoFisicoLabels" />
				</td>
				<td width="100" class="testoNormale">
					<html:text property="possDettVO.dataVar" size="10" maxlength="10" readonly="true"></html:text>
				</td>
			</tr>
		...
		<table align="center">
			<tr>
				<td align="center">
					...
					<html:submit property="methodPossVisualizza">

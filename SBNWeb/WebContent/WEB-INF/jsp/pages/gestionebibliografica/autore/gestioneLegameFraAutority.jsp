...
<layout:page>
	...
	<sbn:navform
		action="/gestionebibliografica/autore/gestioneLegameFraAutority.do">
		...
		<c:choose>
			<c:when test="${gestioneLegameFraAutorityForm.creaRinvio eq 'SI'}">
				<jsp:include
					page="/WEB-INF/jsp/subpages/gestionebibliografica/autore/gestioneDatiLegameAutoreRinvio.jsp" />
			</c:when>
			<c:otherwise>
				<jsp:include
					page="/WEB-INF/jsp/subpages/gestionebibliografica/autore/gestioneDatiLegameFraAutor.jsp" />
			</c:otherwise>
		</c:choose></div>
		...
		<table align="center">
			<tr>
				<td align="center"><html:submit property="methodGestLegFraAutor">

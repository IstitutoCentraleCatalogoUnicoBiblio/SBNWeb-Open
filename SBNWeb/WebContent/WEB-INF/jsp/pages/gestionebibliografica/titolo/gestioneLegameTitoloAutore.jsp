...
<layout:page>
	...
	<sbn:navform
		action="/gestionebibliografica/titolo/gestioneLegameTitoloAutore.do">
		...
		<jsp:include
			page="/WEB-INF/jsp/subpages/gestionebibliografica/titolo/gestioneDatiLegameTitoloAut.jsp" />

		</div>


	<c:if test="${gestioneLegameTitoloAutoreForm.areaDatiLegameTitoloVO.tipoOperazione eq 'TrascinaLegameAutore'}">
		<table border="0">
			<tr>
				<td class="etichetta"><bean:message key="label.elencoBidArrivoLegamiAutore"
					bundle="gestioneBibliograficaLabels" /></td>
			</tr>
			<tr>
				<td class="testoNormale"><html:text
					property="elencoBidArrivoLegamiAutore" size="100" readonly="true"
					></html:text></td>
			</tr>
		</table>
	</c:if>
		...
		<table align="center">
			<tr>
				<td align="center"><html:submit property="methodGestLegTitAut">

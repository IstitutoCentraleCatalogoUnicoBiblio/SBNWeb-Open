...
<layout:page>
	...
	<sbn:navform
		action="/gestionebibliografica/titolo/gestioneLegameTitoloEditore.do">
		...
		<jsp:include
			page="/WEB-INF/jsp/subpages/gestionebibliografica/titolo/gestioneDatiLegameTitoloEdi.jsp" />
		...
		<table align="center">
			<tr>
				<td align="center"><html:submit property="methodGestLegTitEdi">

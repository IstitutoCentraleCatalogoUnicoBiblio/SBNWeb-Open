...
<layout:page>
	...
	<sbn:navform
		action="/gestionebibliografica/titolo/gestioneLegameTitoloLuogo.do">
		...
		<jsp:include
			page="/WEB-INF/jsp/subpages/gestionebibliografica/titolo/gestioneDatiLegameTitoloLuo.jsp" />
		...
		<table align="center">
			<tr>
				<td align="center"><html:submit property="methodGestLegTitLuo">

...
<layout:page>
	<sbn:navform
		action="/gestionesemantica/catalogazionesemantica/CreaLegameClassificazioneTitolo.do">
		<div id="divForm">
			<div id="divMessaggio">
				<sbn:errors />
			</div>
			...
			<table width="100%" border="0">
				...
				<tr>
					<td align="center" class="etichetta">
						<bean:message key="crea.notaAlLegameClass"
							bundle="gestioneSemanticaLabels" />
					</td>
				</tr>
				<tr>
					<td>
						<html:textarea styleId="testoNormale" property="notaAlLegame"
							cols="90" rows="6"></html:textarea>
						<sbn:tastiera limit="90" property="notaAlLegame"
							name="CreaLegameClassificazioneTitoloForm" />
					</td>
				</tr>
			</table>
			<table width="100%" border="0">
				<tr>
					...
					<td>
						<html:select styleClass="testoNormale" property="statoControllo"
							disabled="true">
				...
				<tr>
					...
					<td>
						<html:text property="simbolo" readonly="true"></html:text>
					</td>
				</tr>
			</table>
			<table width="100%" border="0">
				...
				<tr>
					<td>
						<html:text styleId="testoNormale" property="descrizione"
				...
				<tr>
					<td>
						<html:text styleId="testoNormale" property="ulterioreTermine"
							size="138" readonly="true"></html:text>
					</td>
				</tr>
			</table>
			...
			<div id="divFooter">
				<table align="center">
					<tr>
						<td align="center">
							<html:submit property="methodCreaLegameTitCla">

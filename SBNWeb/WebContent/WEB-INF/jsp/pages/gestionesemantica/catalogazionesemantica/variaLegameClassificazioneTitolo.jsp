...
<layout:page>
	<sbn:navform
		action="/gestionesemantica/catalogazionesemantica/VariaLegameClassificazioneTitolo.do">
		<div id="divForm">
		...
		<table width="100%" border="0">
			...
			<tr>
				<td><html:textarea styleId="testoNormale"
					...
					limit="90" name="VariaLegameClassificazioneTitoloForm"
		...
		<table align="center">
			<tr>
				<td align="center"><html:submit
					property="methodVariaLegameTitCla">
					<bean:message key="button.ok" bundle="gestioneSemanticaLabels" />
				</html:submit></td>
				<%--<td align="center"><html:submit property="methodVariaLegameTitCla">

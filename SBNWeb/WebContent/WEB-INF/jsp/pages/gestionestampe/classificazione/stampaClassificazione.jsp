...
<layout:page>
	...
	<sbn:navform action="/gestionestampe/classificazione/stampaClassificazione.do">
	<div id="content">
		 ...
		 <table   width="100%" border="0">
		     <tr>
                       <td  width="15%" valign="top" scope="col"  ><div align="left" class="etichetta">
                        <bean:message  key="classificazione.label.codCla" bundle="gestioneStampeLabels" /></div></td>
		   ...
		   <table   width="100%" border="0">
		     ...
		     <tr>
                        ...
                        <bean:message  key="classificazione.label.insDal" bundle="gestioneStampeLabels" />
                        </div></td>
                        <td valign="top" scope="col"><div align="left">
                        ...
                        <td valign="top" width="20%" scope="col" ><div align="left" class="etichetta">
                        <bean:message  key="classificazione.label.insAl" bundle="gestioneStampeLabels" />
                        </div></td>
                        <td valign="top" scope="col"><div align="left">
		     ...
		     <tr>
                        ...
                        <td valign="top" width="20%" scope="col" ><div align="left" class="etichetta">
                        <bean:message  key="classificazione.label.aggDal" bundle="gestioneStampeLabels" />
                        </div></td>
                        <td valign="top" scope="col"><div align="left">
                        ...
                        <td valign="top" width="20%" scope="col" ><div align="left" class="etichetta">
                        <bean:message  key="classificazione.label.aggAl" bundle="gestioneStampeLabels" />
                        </div></td>
                        <td valign="top" scope="col"><div align="left">
	      ...
	      <tr>
		  	  ...
		  	  <table   width="100%" border="0">
	     		 <tr>
		     	 <td valign="top" width="20%" scope="col" ><div align="left" class="etichetta">
                   <bean:message key="classificazione.label.opz" bundle="gestioneStampeLabels" />
		 		</div></td>
                    </tr>
                    <tr>
                             <td  valign="top" scope="col"  ><div align="left" class="etichetta">
                        <bean:message  key="classificazione.label.opzColl" bundle="gestioneStampeLabels" /></div></td>
                        <td  valign="top" scope="col" ><div align="left">
                    ...
                    <tr>
                              <td  valign="top" scope="col"  ><div align="left" class="etichetta">
                        <bean:message  key="classificazione.label.opzNotzn" bundle="gestioneStampeLabels" /></div></td>
                        <td  valign="top" scope="col" ><div align="left">
                    ...
                    <tr>
                                       <td  valign="top" scope="col"  ><div align="left" class="etichetta">
                        <bean:message  key="classificazione.label.opzNtznPrpr" bundle="gestioneStampeLabels" /></div></td>
                        <td  valign="top" scope="col" ><div align="left">
           ...
           <table align="center" border="0" style="height:40px" >
            <tr >
             <td>
			<html:submit styleClass="pulsanti" property="methodStampaClassificazione">

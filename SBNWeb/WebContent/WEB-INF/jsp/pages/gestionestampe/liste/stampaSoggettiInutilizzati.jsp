...
<layout:page>
	...
	<sbn:navform action="/gestionestampe/liste/stampaSoggettiInutilizzati.do">
	<div id="content">
	...
	<tr>
		 ...
		 <table   width="100%" border="0">
		     <tr>
                       <td width="15%" class="etichetta" align="right"><div align="left" class="etichetta">
                        	<bean:message key="soggettiIn.label.codSogg" bundle="gestioneStampeLabels" />
                       </div></td>
		...
		<td width="53%" class="etichetta">
		 ...
		 <table   width="100%" border="0">
		     <tr>
                       <td width="15%" class="etichetta" align="right"><div align="left" class="etichetta">
                       	<bean:message key="soggettiIn.label.SoggFI" bundle="gestioneStampeLabels" />
        ...
        <html:radio property="tipoRicerca" value="SoggFI" />
		     	     ...
		     	     <tr>
                       <td width="15%" class="etichetta" align="right"><div align="left" class="etichetta">
                       <bean:message key="soggettiIn.label.SoggPA" bundle="gestioneStampeLabels" />
       ...
       <html:radio property="tipoRicerca" value="SoggPA" />
		          	     ...
		          	     <tr>
                       <td width="15%" class="etichetta" align="right"><div align="left" class="etichetta">
                      <bean:message key="soggettiIn.label.SoggLCL" bundle="gestioneStampeLabels" />
       ...
       <html:radio property="tipoRicerca" value="SoggLCL" />
		     		          	     ...
		     		          	     <tr>
                       <td width="15%" class="etichetta" align="right"><div align="left" class="etichetta">
                     	<bean:message key="soggettiIn.label.SoggNLBR" bundle="gestioneStampeLabels" />

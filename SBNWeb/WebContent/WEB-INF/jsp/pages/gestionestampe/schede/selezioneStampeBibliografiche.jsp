...
<layout:page>
<sbn:navform
	action="/gestionestampe/schede/selezioneStampeBibliografiche.do">
	<div id="divMessaggio">
		<sbn:errors />
	</div>
		...
		<table border="0">
			...
			<tr>
				<table border="0" cellspacing="15">
					<logic:iterate id="item" property="listaStampe"	name="selezioneStampeBibliograficheForm" indexId="idx">
						...
						<tr>
							...
							<td>
								<html:submit styleClass="pulsanti"
									property="${sbn:getUniqueButtonName(selezioneStampeBibliograficheForm.SUBMIT_TESTO_PULSANTE, idx)}">&gt;
								</html:submit>
							</td>
						</tr>
					</sbn:checkAttivita>

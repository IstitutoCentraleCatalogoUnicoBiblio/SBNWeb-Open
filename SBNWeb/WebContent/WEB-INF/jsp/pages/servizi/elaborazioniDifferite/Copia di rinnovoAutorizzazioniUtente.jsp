...
<bean-struts:define id="opzione2"  value="false"/>
<bean-struts:define id="opzione3"  value="false"/>
<bean-struts:define id="opzione4"  value="true"/>


<c:choose>
<c:when test="${rinnovoAutorizzazioniUtenteForm.tipoRinnModalitaDiff eq 'D'}">
	<bean-struts:define id="opzione3"  value="true"/>
	<bean-struts:define id="opzione4"  value="false"/>
</c:when>
</c:choose>

<c:choose>
<c:when test="${rinnovoAutorizzazioniUtenteForm.tipoRinnModalitaDiff eq 'T'}">
	<bean-struts:define id="opzione2"  value="true"/>
	<bean-struts:define id="opzione4"  value="false"/>
</c:when>
</c:choose>
						...
						<table width="100%" border="0" >
							...
							<tr>
								<td>
									...
									&nbsp;<html:text styleId="testoNoBold"   property="dataRinnovoOpz2" size="10" maxlength="10" readonly="${opzione3}"></html:text>
								</td>
							</tr>
							<tr>
								<td>
									...
									&nbsp;<html:text styleId="testoNoBold"   property="dataRinnovoOpz3" size="10" maxlength="10" readonly="${opzione2}"></html:text>
								</td>
							</tr>
						</table>
					</td>
							...
							<td>
								...
								<c:choose>
									<c:when test="${rinnovoAutorizzazioniUtenteForm.risultatiPresenti}">
										<logic:iterate id="elencaAut" property="listaAutorizzazioni"	name="rinnovoAutorizzazioniUtenteForm">
										   <c:set var="color" >
												<c:choose>
											...
											<tr class="testoNormale" bgcolor="${color}">
												...
												<td align="left">
													<html:text styleId="testoNoBold"  name="elencaAut" property="codice3" size="10" maxlength="10" readonly="${opzione2}"></html:text>
												</td>
												<td>

		  	...
		  	<table  align="center" width="100%"   style="border-color: #5A96DF;	border-style: dotted; border-width: 1px;" >
                    <tr class="etichetta" bgcolor="#dde8f0">
                      <td scope="col" align="center">
							<bean:message key="ricerca.label.chiave" bundle="acquisizioniLabels" />
                      </td>
                      <td scope="col" align="center">
							<bean:message key="ricerca.label.autore" bundle="acquisizioniLabels" />
                      </td>
                      ...
                      <td scope="col" align="center">
							<bean:message key="ordine.label.resp" bundle="acquisizioniLabels" />
                      </td>
                    </tr>

				<logic:greaterThan name="esaminaOfferteForm" property="numRigheAut" value="0">
					<logic:iterate id="elencaRigheAut" property="listaAutori" name="esaminaOfferteForm" indexId="indice">
					   <c:set var="color" >
							<c:choose>
	                      ...
	                      <td  scope="col" align="center">
							<html:text styleId="testoNormale" name="elencaRigheAut" property="chiaveAutore" size="4" readonly="true" ></html:text>
	                      </td>
	                      <td  scope="col" align="center">
							<html:text styleId="testoNormale" name="elencaRigheAut"   maxlength="80" property="autore" size="30" readonly="true" ></html:text>
	                      </td>
	                      <td  scope="col" align="center">
							<html:text styleId="testoNormale" name="elencaRigheAut" property="tipoAutore" size="4" readonly="true" ></html:text>
	                      </td>
	                      <td  scope="col" align="center">
							<html:text styleId="testoNormale" name="elencaRigheAut" property="responsabilitaAutore" size="10" readonly="true" ></html:text>
	                      </td>
						</tr>

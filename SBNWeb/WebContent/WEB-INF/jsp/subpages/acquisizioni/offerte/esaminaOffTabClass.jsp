		  	...
		  	<table  align="center" width="100%"   style="border-color: #5A96DF;	border-style: dotted; border-width: 1px;" >
                    <tr class="etichetta" bgcolor="#dde8f0">
                      <td scope="col" align="center">
							<bean:message key="ricerca.label.codSistCla" bundle="acquisizioniLabels" />
                      </td>
                      <td scope="col" align="center">
							<bean:message key="ricerca.label.codIdeCla" bundle="acquisizioniLabels" />
                      </td>
                    </tr>

				<logic:greaterThan name="esaminaOfferteForm" property="numRigheCla" value="0">
					<logic:iterate id="elencaRigheCla" property="listaClassificazione" name="esaminaOfferteForm" indexId="indice">
					   <c:set var="color" >
							<c:choose>
	                      ...
	                      <td  scope="col" align="center">
							<html:text styleId="testoNormale" name="elencaRigheCla" property="codiceSistemaClassificazione" size="10" readonly="true" ></html:text>
	                      </td>
	                      <td  scope="col" align="center">
							<html:text styleId="testoNormale" name="elencaRigheCla"   maxlength="30" property="identificativoClasse" size="30" readonly="true" ></html:text>
	                      </td>
						</tr>
					</logic:iterate>
				</logic:greaterThan>

...
<table  width="100%"  border="0" cellpadding="0" cellspacing="0">
		  	...
		  	<table  align="center" width="100%"   style="border-color: #5A96DF;	border-style: dotted; border-width: 1px;" >
				...
				<logic:greaterThan name="esaminaOfferteForm" property="numRigheNot" value="0">
					<logic:iterate id="elencaRigheNot" property="listaNoteEDI" name="esaminaOfferteForm" indexId="indice">
					   <c:set var="color" >
							<c:choose>
	                      ...
	                      <td  scope="col" align="center" bgcolor="${color}">
							<html:text styleId="testoNormale" name="elencaRigheNot" property="noteEdi" size="30" readonly="true" ></html:text>
	                      </td>
						</tr>
					  	<tr class="testoNormale" >
	                      <td scope="col" align="center" bgcolor="#dde8f0">
								<bean:message key="ricerca.label.coordEdi" bundle="acquisizioniLabels" />
	                      </td>
	                      <td  scope="col" align="center" bgcolor="${color}">
							<html:text styleId="testoNormale" name="elencaRigheNot"   maxlength="30" property="coordinateEdi" size="30" readonly="true" ></html:text>
	                      </td>
						</tr>
					  	<tr class="testoNormale" >
	                      <td scope="col" align="center" bgcolor="#dde8f0">
								<bean:message key="ricerca.label.altriRif" bundle="acquisizioniLabels" />
	                      </td>
	                      <td  scope="col" align="center" bgcolor="${color}">
							<html:text styleId="testoNormale" name="elencaRigheNot"   maxlength="30" property="altriRiferimenti" size="30" readonly="true" ></html:text>
	                      </td>
						</tr>
					</logic:iterate>
				</logic:greaterThan>

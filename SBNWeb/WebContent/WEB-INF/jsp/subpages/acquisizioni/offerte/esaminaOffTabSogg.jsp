		  	...
		  	<table  align="center" width="100%"   style="border-color: #5A96DF;	border-style: dotted; border-width: 1px;" >
                    <tr class="etichetta" bgcolor="#dde8f0">
                      <td scope="col" align="center">
							<bean:message key="ricerca.label.chiaveSoggetto" bundle="acquisizioniLabels" />
                      </td>
                      <td scope="col" align="center">
							<bean:message key="ricerca.label.soggetto" bundle="acquisizioniLabels" />
                      </td>
				...
				<logic:greaterThan name="esaminaOfferteForm" property="numRigheSog" value="0">
					<logic:iterate id="elencaRigheSog" property="listaSoggetto" name="esaminaOfferteForm" indexId="indice">
					   <c:set var="color" >
							<c:choose>
	                      ...
	                      <td  scope="col" align="center">
							<html:text styleId="testoNormale" name="elencaRigheSog" property="chiaveSoggetto" size="10" readonly="true" ></html:text>
	                      </td>
	                      <td  scope="col" align="center">
							<html:text styleId="testoNormale" name="elencaRigheSog"   maxlength="30" property="soggetto" size="30" readonly="true" ></html:text>
	                      </td>
						</tr>
					</logic:iterate>
				</logic:greaterThan>

...
<c:when test="${formName eq 'esaminaOrdineForm'}">
	...
	<c:when test="${esaminaOrdineForm.disabilitaTutto}">
        ...
        <tr  >
          ...
          <td  >
        	<html:select  styleClass="testoNormale" property="tipoInvio" disabled="${ordineAperto}" >
          ...
          <bean:message  key="ordine.label.urg" bundle="acquisizioniLabels" />
        	<html:select  styleClass="testoNormale" property="urg" disabled="${ordineAperto}" >
        	...
        	<html:select  styleClass="testoNormale" property="datiOrdine.cd_tipo_lav" disabled="${ordineAperto}" >
			<html:optionsCollection  property="listaTipoLavorazione" value="cd_tabellaTrim" label="ds_tabella" />
			</html:select>
			</td>
        </tr>

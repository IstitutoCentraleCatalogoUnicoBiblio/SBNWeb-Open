...
<table border="0">
	<tr>
		...
		<td width="60" class="testoNormale"><html:text property="dettMarcaVO.midPadre"
...
<table border="0">
	<tr>
		...
		<td width="100"><html:textarea property="dettMarcaVO.descrizionePadre"
...
<table border="0">
	<tr>
		...
		<td width="100"><html:textarea
			property="dettMarcaVO.notaAlLegame" cols="60" rows="1" readonly="true"></html:textarea>
		</td>
	</tr>
</table>

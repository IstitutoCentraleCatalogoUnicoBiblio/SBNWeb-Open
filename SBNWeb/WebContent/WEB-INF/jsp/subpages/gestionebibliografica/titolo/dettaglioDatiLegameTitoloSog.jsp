...
<table border="0">
	<tr>
		...
		<td width="100" class="testoNormale"><html:text property="bid"
	...
	<tr>
		...
		<td width="100"><html:textarea property="descr"
	...
	<tr>
		...
		<td width="100"><html:textarea
			property="notaLegame" cols="60" rows="1" readonly="true"></html:textarea>
		</td>
	</tr>
</table>

...
<table border="0">
	<c:if test="${dettaglioTitoloForm.dettTitComVO.detTitoloPFissaVO.natura eq 'B'}">
		<tr>
			<td width="100" class="etichetta"><bean:message
				key="ricerca.lingua" bundle="gestioneBibliograficaLabels" /></td>

			<td><html:select property="dettTitComVO.detTitoloPFissaVO.lingua1" style="width:55px">
				<html:optionsCollection property="listaLingua" value="codice" label="descrizioneCodice" />
			</html:select></td>
			<td><html:select property="dettTitComVO.detTitoloPFissaVO.lingua2" style="width:55px">
				<html:optionsCollection property="listaLingua" value="codice" label="descrizioneCodice" />
			</html:select></td>
			<td><html:select property="dettTitComVO.detTitoloPFissaVO.lingua3" style="width:55px">
				<html:optionsCollection property="listaLingua" value="codice" label="descrizioneCodice" />
			</html:select></td>
		</tr>
	</c:if>

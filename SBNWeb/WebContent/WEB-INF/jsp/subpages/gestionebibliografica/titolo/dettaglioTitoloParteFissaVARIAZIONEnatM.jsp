...
<table border="0">
	<tr>
		...
		<td width="40" class="testoNormale"><html:text
			property="dettTitComVO.detTitoloPFissaVO.dataPubbl1" size="15" onchange="this.form.submit()"></html:text></td>
		<td width="60" class="etichetta"><bean:message
...
<table border="0">
	<tr>
		...
		<td><html:textarea
			...
			rows="5"></html:textarea> <sbn:tastiera limit="1200"
	...
	<c:choose>
		...
		<!--<tr>
			...
			<c:choose>
				...
				<c:when	test="${dettaglioTitoloForm.dettTitComVO.detTitoloPFissaVO.tipoRec eq 'd'}">
					<tr>
						<td class="etichetta"><bean:message
							key="catalogazione.areaT.musica"
							bundle="gestioneBibliograficaLabels" /></td>
				...
				<c:when	test="${dettaglioTitoloForm.dettTitComVO.detTitoloPFissaVO.tipoRec eq 'e'}">
					<tr>
						<td class="etichetta"><bean:message
				...
				<c:when	test="${dettaglioTitoloForm.dettTitComVO.detTitoloPFissaVO.tipoRec eq 'f'}">
					<tr>
						<td class="etichetta"><bean:message
							key="catalogazione.areaT.datiMatematici"
							bundle="gestioneBibliograficaLabels" /></td>
    ...
    <!-- Inizio Modifica gennaio 2015 - Vedi Doc test SbnWEB audiovisivi di Carla Scognamiglio
 	   9) Dalla mappa del Varia audiovisivo va eliminata area dati matematici -->
 	   <!-- Gennaio 2018 almaviva2 : i dati matematici vanno esculi anche da materiale ELETTRONICO quindi si sostituisce
 	   il c:choose con il c:if -->
		<!--<c:choose>
			<c:when	test="${dettaglioTitoloForm.dettTitComVO.detTitoloPFissaVO.tipoMat ne 'H'}">
				<tr>
					<td class="etichetta"><bean:message
						key="catalogazione.areaT.datiMatematici"
						bundle="gestioneBibliograficaLabels" /></td>
		...
		<c:if test="${dettaglioTitoloForm.dettTitComVO.detTitoloPFissaVO.tipoMat eq 'M'
						or dettaglioTitoloForm.dettTitComVO.detTitoloPFissaVO.tipoMat eq 'A'
						or dettaglioTitoloForm.dettTitComVO.detTitoloPFissaVO.tipoMat eq 'U'
						or dettaglioTitoloForm.dettTitComVO.detTitoloPFissaVO.tipoMat eq 'G'
						or dettaglioTitoloForm.dettTitComVO.detTitoloPFissaVO.tipoMat eq 'C'}">
				<tr>
					<td class="etichetta"><bean:message
						key="catalogazione.areaT.datiMatematici"
						bundle="gestioneBibliograficaLabels" /></td>
	...
	<tr>
		<td class="etichetta"><bean:message
			...
			bundle="gestioneBibliograficaLabels" /></td>
		<td><html:textarea
			property="dettTitComVO.detTitoloPFissaVO.areaTitPubbl" cols="70"
			rows="3"></html:textarea> <sbn:tastiera limit="1200"
			property="dettTitComVO.detTitoloPFissaVO.areaTitPubbl"
			name="dettaglioTitoloForm"></sbn:tastiera></td>
	</tr>

	<sbn:anchor name ="dettaglioTitoloForm" property="dettTitComVO.detTitoloPFissaVO.livAut"/>
				...
				<c:if test="${dettaglioTitoloForm.dettTitComVO.detTitoloPFissaVO.natura eq 'M'
					...
					<table border="0">
						...
						<logic:iterate id="itemReperCartaceo"	property="dettTitComVO.detTitoloPFissaVO.listaReperCartaceo"
							...
							<tr>
								<td></td>
								<td bgcolor="#FFCC99"><html:text name="itemReperCartaceo" property="campoUno" indexed="true" /></td>
								<td bgcolor="#FFCC99"><html:text name="itemReperCartaceo" property="campoDue" indexed="true" /></td>
								<td bgcolor="#FFCC99"><html:text name="itemReperCartaceo" property="nota" indexed="true" /></td>
		...
		<table border="0" bordercolor="#dde8f0">
			...
			<logic:iterate id="itemNumStd"
				...
				<tr>
					...
					<td bgcolor="#FFCC99"><html:text name="itemNumStd"
						property="nota" indexed="true" size="30" maxlength="30"/>
						<sbn:tastiera name="dettaglioTitoloForm"
							property='<%="dettTitComVO.detTitoloPFissaVO.listaNumStandard[" + idxNumStd + "].nota"%>' />
			...
			<logic:iterate id="itemImp"
				...
				<tr class="testoNormale">
					...
					<td bgcolor="#FFCC99"><html:text name="itemImp"
						property="campoDue" indexed="true" size="35" /></td>
					<td bgcolor="#FFCC99"><html:text name="itemImp"
						property="nota" indexed="true" size="35" /></td>
					<td bgcolor="#FFCC99"><html:radio
						property="selezRadioImpronta" value="${idxImp}" /></td>
					</tr>
				</logic:iterate>
			</table>
	</c:when>

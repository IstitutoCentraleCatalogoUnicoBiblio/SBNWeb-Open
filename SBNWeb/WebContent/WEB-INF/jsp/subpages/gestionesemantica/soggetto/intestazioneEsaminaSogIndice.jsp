...
<!-- Intestazione Esamina In Indice  -->
<table width="100%" border="0">
	<tr><td>
		<c:if test="${EsaminaSoggettoForm.enableTit}">
			<jsp:include page="/WEB-INF/jsp/subpages/gestionesemantica/catalogazionesemantica/datiTitolo.jsp" />
		</c:if>
	</td></tr>
</table>
...
<table width="100%" border="0">
	<tr>
		<td class="etichetta"><bean:message key="label.livRicercaIndice" bundle="gestioneBibliograficaLabels" /></td>
	</tr>
</table>
<table width="100%" border="0">
	<tr>
		...
		<td><html:text property="cid" readonly="true">
		</html:text></td>

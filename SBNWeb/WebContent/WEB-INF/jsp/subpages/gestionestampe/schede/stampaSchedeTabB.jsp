				 ...
				 <!-- COLONNA TAG ON -->
					...
					<table width="100%" border="0"  cellpadding="0" cellspacing="0" >
            		  <tr>
              		  ...
              		  <td colspan="3" class="tagBottomOn2" style="width: auto;"><bean:message  key="schede.label.selezionePerCollocazione" bundle="gestioneStampeLabels" /></td>
              		  <td style="width: 8px;">
               		   <table  border="0" cellpadding="0" cellspacing="0" style="width: 8px;">
                 		   <tr>
                ...
                <td>
					<table width="100%" border="0"  cellpadding="0" cellspacing="0" >
     				 ...
     				 <!-- valorizzare correttamente il link del tag -->
			            ...
			            <html:link  action="/gestionestampe/schede/stampaSchede.do" paramId="paramLink" paramName="varLink" >
							<bean:message  key="schede.label.identificativiTitoli" bundle="gestioneStampeLabels" />
			            </html:link>
              		  </td>
              		  <td style="width: 8px;">
               		   <table  border="0" cellpadding="0" cellspacing="0" style="width: 8px;">

...
<table class="sintetica">
	<tr>
		...
		<th width="7%" class="etichetta" scope="col" bgcolor="#dde8f0" style="text-align:center; font-size: 90%;">
			<bean:message key="servizi.configurazione.moduloRichiesta.dataLimite" bundle="serviziLabels" />
		</th>
		...
		<th width="20%" class="etichetta" scope="col" bgcolor="#dde8f0" style="text-align:center; font-size: 90%;">
			<bean:message key="servizi.erogazione.movimento.bibRichiedente" bundle="serviziLabels" />
		</th>
	...
	<logic:iterate id="item" property="richieste" name="navForm" indexId="progr">
		...
		<tr>
			...
			<td bgcolor="${color}" class="testoNoBold" style="font-size: 90%;text-align:center;">
				<bs:write name="item" property="dataDesiderata" format="dd/MM/yyyy"/>
			</td>
			<td bgcolor="${color}" class="testoNoBold" style="font-size: 90%;text-align:center;">
				<bs:write name="item" property="requesterId"/>
			</td>
			<td bgcolor="${color}" class="testoNoBold" style="font-size: 90%;text-align:center;">
				<bs:write name="item" property="denominazioneBibRichiedente"/>
			</td>

...
<table align="center">
	<tr>
		<td align="center">
					...
					<logic:greaterThan  name="DettaglioMaterieInteresseForm" property="numMat" value="1">
					<html:submit styleClass="pulsanti" property="methodDettMaterie">

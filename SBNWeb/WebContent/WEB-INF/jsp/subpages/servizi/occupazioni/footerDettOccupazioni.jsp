...
<table align="center">
	<tr>
		<td align="center">
					<logic:greaterThan  name="DettaglioOccupazioniForm" property="numOcc" value="1">
					<html:submit styleClass="pulsanti" property="methodDettOccup">

...
<table align="center">
	<tr>
		<td align="center">
					<logic:greaterThan  name="DettaglioSpecTitoloStudioForm" property="numSpecTit" value="1">
					<html:submit styleClass="pulsanti" property="methodDettSpecialita">

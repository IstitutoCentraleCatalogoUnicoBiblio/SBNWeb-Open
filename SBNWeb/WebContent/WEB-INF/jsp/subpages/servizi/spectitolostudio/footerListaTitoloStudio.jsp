	...
	<tr>
		<td align="center">
			<c:if test="${not empty ListaSpecTitoloStudioForm.listaSpecialita}"><!--
				<html:submit property="methodListaSpecialita">
			...
			<c:if test="${not empty ListaSpecTitoloStudioForm.listaSpecialita}">
				<html:submit property="methodListaSpecialita" styleClass="buttonSelezTutti" titleKey="servizi.title.selezionaTutti" bundle="serviziLabels">
					<bean:message key="servizi.bottone.selTutti" bundle="serviziLabels" />
				</html:submit>
				<html:submit property="methodListaSpecialita" styleClass="buttonSelezNessuno" titleKey="servizi.title.selezionaNessuno" bundle="serviziLabels">

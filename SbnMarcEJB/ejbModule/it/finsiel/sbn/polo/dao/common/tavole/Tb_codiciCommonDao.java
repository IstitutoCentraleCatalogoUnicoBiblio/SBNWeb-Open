...
public class Tb_codiciCommonDao extends TableDao{

    protected boolean kycleslike = false;

    public Tb_codiciCommonDao() {
        super();
    }

    public Tb_codiciCommonDao(Criteria codiciCriteria) {
        super();
        this.basicCriteria = codiciCriteria;
    }

    public void createCriteria(HashMap opzioni) throws InfrastructureException
    {
        try {
            Class cl = Tb_codiciCommonDao.class;//this.getClass();
    ...
    public static void main(String[] args) throws Exception{
        Tb_codiciCommonDao aut = new Tb_codiciCommonDao();

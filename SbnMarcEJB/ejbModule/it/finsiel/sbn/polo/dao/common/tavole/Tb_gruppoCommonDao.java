...
public class Tb_gruppoCommonDao extends TableDao{

    protected boolean kycleslike = false;


    public Tb_gruppoCommonDao() {
        super();
    }
    public Tb_gruppoCommonDao(Criteria gruppoCriteria) {
        super();
        this.basicCriteria = gruppoCriteria;
    }
    ...
    {
        try {
            Class cl = Tb_gruppoCommonDao.class;//this.getClass();

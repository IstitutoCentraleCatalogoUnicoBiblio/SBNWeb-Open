...
public class Tb_improntaCommonDao extends TableDao{

	protected boolean kycleslike = false;

    public Tb_improntaCommonDao() {
        super();
    }
    public Tb_improntaCommonDao(Criteria improntaCriteria) {
        super();
        this.basicCriteria = improntaCriteria;
    }

    public void createCriteria(HashMap opzioni) throws InfrastructureException
    {
        try {
            Class cl = Tb_improntaCommonDao.class;//this.getClass();
    ...
    public static void main(String[] args) throws Exception{
        Tb_improntaCommonDao aut = new Tb_improntaCommonDao();

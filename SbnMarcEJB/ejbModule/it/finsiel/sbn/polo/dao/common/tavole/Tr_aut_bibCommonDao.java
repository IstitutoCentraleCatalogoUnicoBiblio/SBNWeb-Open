...
public class Tr_aut_bibCommonDao extends TableDao{

    protected boolean kycleslike = false;

    public Tr_aut_bibCommonDao() {
        super();
    }
    ...
    {
        try {
            Class cl = Tr_aut_bibCommonDao.class;//this.getClass();
    ...
    public static void main(String[] args) throws Exception{
        Tr_aut_bibCommonDao aut = new Tr_aut_bibCommonDao();

...
public class Tr_aut_marCommonDao extends TableDao{



    protected boolean kycleslike = false;

    public Tr_aut_marCommonDao() {
        super();
    }
    ...
    {
        try {
            Class cl = Tr_aut_marCommonDao.class;//this.getClass();
    ...
    public static void main(String[] args) throws Exception{
        Tr_aut_marCommonDao aut = new Tr_aut_marCommonDao();

...
public class Tr_des_desCommonDao extends TableDao{

    protected boolean kycleslike = false;

    public Tr_des_desCommonDao() {
        super();
    }
    public void createCriteria(HashMap opzioni) throws InfrastructureException
    {
        try {
            Class cl = Tr_des_desCommonDao.class;//this.getClass();
    ...
    public static void main(String[] args) throws Exception{
        Tr_des_desCommonDao aut = new Tr_des_desCommonDao();

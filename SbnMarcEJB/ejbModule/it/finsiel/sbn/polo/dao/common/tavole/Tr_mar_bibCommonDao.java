...
/*
DEFAULT <opzionale dipende="XXXfl_allinea_sbnmarc"> AND fl_allinea_sbnmarc = XXXfl_allinea_sbnmarc </opzionale>
DEFAULT <opzionale dipende="XXXcd_biblioteca"> AND cd_biblioteca = XXXcd_biblioteca</opzionale>

 */

public class Tr_mar_bibCommonDao extends TableDao{
	protected boolean kycleslike = false;

    public Tr_mar_bibCommonDao() {
        super();
    }
    public void createCriteria(HashMap opzioni) throws InfrastructureException
    {
        try {
            Class cl = Tr_mar_bibCommonDao.class;//this.getClass();
    ...
    public static void main(String[] args) throws Exception{
        Tr_mar_bibCommonDao aut = new Tr_mar_bibCommonDao();

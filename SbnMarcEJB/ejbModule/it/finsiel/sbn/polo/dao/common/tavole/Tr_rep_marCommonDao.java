...
/*
DEFAULT<opzionale dipende="XXXfl_canc"> AND fl_canc = XXXfl_canc </opzionale>
...
public class Tr_rep_marCommonDao extends TableDao{

	protected boolean kycleslike = false;

    public Tr_rep_marCommonDao() {
        super();
    }
    public void createCriteria(HashMap opzioni) throws InfrastructureException
    {
        try {
            Class cl = Tr_rep_marCommonDao.class;//this.getClass();
    ...
    public static void main(String[] args) throws Exception{
        Tr_rep_marCommonDao aut = new Tr_rep_marCommonDao();

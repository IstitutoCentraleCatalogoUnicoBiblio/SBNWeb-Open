...
public class Tr_rep_titCommonDao extends TableDao{

	protected boolean kycleslike = false;

    public Tr_rep_titCommonDao() {
        super();
    }
    public void createCriteria(HashMap opzioni) throws InfrastructureException
    {
        try {
            Class cl = Tr_rep_titCommonDao.class;//this.getClass();
    ...
    public static void main(String[] args) throws Exception{
        Tr_rep_titCommonDao aut = new Tr_rep_titCommonDao();

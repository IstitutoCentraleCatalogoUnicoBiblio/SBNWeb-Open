...
/*
 DA RIVEDERE CI SONO GLI IMPORT ED EXPORT
...
public class Tr_tit_bibCommonDao extends TableDao{

	protected boolean kycleslike = false;

    public Tr_tit_bibCommonDao() {
        super();
    }
    public void createCriteria(HashMap opzioni) throws InfrastructureException
    {
        try {
            Class cl = Tr_tit_bibCommonDao.class;//this.getClass();
    ...
    public static void main(String[] args) throws Exception{
        Tr_tit_bibCommonDao aut = new Tr_tit_bibCommonDao();

...
public class Tr_tit_marCommonDao extends TableDao{

	protected boolean kycleslike = false;

    public Tr_tit_marCommonDao() {
        super();
    }
    public void createCriteria(HashMap opzioni) throws InfrastructureException
    {
        try {
            Class cl = Tr_tit_marCommonDao.class;//this.getClass();
    ...
    public static void main(String[] args) throws Exception{
        Tr_tit_marCommonDao aut = new Tr_tit_marCommonDao();

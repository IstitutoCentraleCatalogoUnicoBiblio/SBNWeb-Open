...
public class Ts_link_multimCommonDao extends TableDao{

	protected boolean kycleslike = false;

    public Ts_link_multimCommonDao() {
        super();
    }
    public void createCriteria(HashMap opzioni) throws InfrastructureException
    {
        try {
            Class cl = Ts_link_multimCommonDao.class;//this.getClass();
    ...
    public static void main(String[] args) throws Exception{
        Ts_link_multimCommonDao aut = new Ts_link_multimCommonDao();

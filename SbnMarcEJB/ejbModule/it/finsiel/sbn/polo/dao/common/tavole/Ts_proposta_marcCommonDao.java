...
public class Ts_proposta_marcCommonDao extends TableDao {

	public Ts_proposta_marcCommonDao() {
		super();
...
public void setData(HashMap opzioni) throws ParseException {
	...
	public Ts_proposta_marcCommonDao(Criteria basicCriteria) {
		super(basicCriteria);
		// TODO Auto-generated constructor stub
	}
    ...
    {
        try {
            Class cl = Ts_proposta_marcCommonDao.class;//this.getClass();

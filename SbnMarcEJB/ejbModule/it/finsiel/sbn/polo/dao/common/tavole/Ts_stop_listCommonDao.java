...
public class Ts_stop_listCommonDao extends TableDao{

	protected boolean kycleslike = false;

    public Ts_stop_listCommonDao() {
        super();
    }
    public void createCriteria(HashMap opzioni) throws InfrastructureException
    {
        try {
            Class cl = Ts_stop_listCommonDao.class;//this.getClass();
    ...
    public static void main(String[] args) throws Exception{
        Ts_stop_listCommonDao aut = new Ts_stop_listCommonDao();

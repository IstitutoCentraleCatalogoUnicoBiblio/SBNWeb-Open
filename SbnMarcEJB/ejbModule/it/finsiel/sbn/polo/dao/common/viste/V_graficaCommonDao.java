...
public class V_graficaCommonDao extends Tb_titoloCommonDao{
    ...
    {
        try {
            Class cl = V_graficaCommonDao.class;//this.getClass();
    ...
    public static void main(String[] args) throws Exception{
        V_graficaCommonDao aut = new V_graficaCommonDao();

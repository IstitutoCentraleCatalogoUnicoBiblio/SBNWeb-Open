...
public class V_musicaCommonDao extends Tb_titoloCommonDao{
    ...
    {
        try {
            Class cl = V_musicaCommonDao.class;//this.getClass();
    ...
    public static void main(String[] args) throws Exception{
        V_musicaCommonDao aut = new V_musicaCommonDao();

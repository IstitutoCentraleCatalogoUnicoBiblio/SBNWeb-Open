...
public class Ve_cartografia_mar_autCommonDao extends Tb_titoloCommonDao {
	...
	public Ve_cartografia_mar_autCommonDao() {
        super();
	}
	...
	{
		try {
			Class cl = Ve_cartografia_mar_autCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Ve_cartografia_mar_autCommonDao aut = new Ve_cartografia_mar_autCommonDao();

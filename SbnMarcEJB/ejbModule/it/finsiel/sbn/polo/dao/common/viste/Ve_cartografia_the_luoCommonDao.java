...
public class Ve_cartografia_the_luoCommonDao extends Tb_titoloCommonDao {
	...
	public Ve_cartografia_the_luoCommonDao() {
        super();
	}
	...
	{
		try {
			Class cl = Ve_cartografia_the_luoCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Ve_cartografia_the_luoCommonDao aut = new Ve_cartografia_the_luoCommonDao();

...
public class Ve_grafica_cla_autCommonDao extends Tb_titoloCommonDao {
	...
	public Ve_grafica_cla_autCommonDao() {
		super();
	}
	...
	{
		try {
			Class cl = Ve_grafica_cla_autCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Ve_grafica_cla_autCommonDao aut = new Ve_grafica_cla_autCommonDao();

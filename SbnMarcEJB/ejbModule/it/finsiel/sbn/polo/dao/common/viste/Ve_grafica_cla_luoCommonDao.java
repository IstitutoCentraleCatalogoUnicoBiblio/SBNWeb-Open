...
public class Ve_grafica_cla_luoCommonDao extends Tb_titoloCommonDao {
	...
	public Ve_grafica_cla_luoCommonDao() {
        super();
	}
	...
	{
		try {
			Class cl = Ve_grafica_cla_luoCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Ve_grafica_cla_luoCommonDao aut = new Ve_grafica_cla_luoCommonDao();

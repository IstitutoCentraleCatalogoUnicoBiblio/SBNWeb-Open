...
public class Ve_grafica_luo_autCommonDao extends Tb_titoloCommonDao {
	...
	public Ve_grafica_luo_autCommonDao() {
		super();
	}
	...
	{
		try {
			Class cl = Ve_grafica_luo_autCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Ve_grafica_luo_autCommonDao aut = new Ve_grafica_luo_autCommonDao();

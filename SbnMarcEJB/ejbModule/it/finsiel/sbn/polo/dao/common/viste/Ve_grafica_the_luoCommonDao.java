...
public class Ve_grafica_the_luoCommonDao extends Tb_titoloCommonDao {
	...
	public Ve_grafica_the_luoCommonDao() {
        super();
	}
	...
	{
		try {
			Class cl = Ve_grafica_the_luoCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Ve_grafica_the_luoCommonDao aut = new Ve_grafica_the_luoCommonDao();

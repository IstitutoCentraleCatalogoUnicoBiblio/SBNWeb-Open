...
public class Ve_grafica_tit_c_autCommonDao extends Tb_titoloCommonDao {
	...
	public Ve_grafica_tit_c_autCommonDao() {
		super();
	}
	...
	{
		try {
			Class cl = Ve_grafica_tit_c_autCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Ve_grafica_tit_c_autCommonDao aut = new Ve_grafica_tit_c_autCommonDao();

...
public class Ve_grafica_tit_c_luoCommonDao extends Tb_titoloCommonDao {
	...
	public Ve_grafica_tit_c_luoCommonDao() {
        super();
	}
	...
	{
		try {
			Class cl = Ve_grafica_tit_c_luoCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Ve_grafica_tit_c_luoCommonDao aut = new Ve_grafica_tit_c_luoCommonDao();

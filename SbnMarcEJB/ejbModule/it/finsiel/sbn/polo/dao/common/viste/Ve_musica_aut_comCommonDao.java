...
public class Ve_musica_aut_comCommonDao extends Tb_titoloCommonDao {
...
/*
    ...
    */
    ...
    public Ve_musica_aut_comCommonDao() {
        super();
    }
...
*/
    ...
    public void setNumeroOpera(HashMap opzioni) throws Exception {
        ...
        param.setValueString(opzioni,Ve_musica_aut_comCommonDao.XXXnumeroOpera);
        if ((value = this.setParameterLikeAnywhere(param)) != null) {
            this.basicCriteria.add(value);
            opzioni.remove(Ve_musica_aut_comCommonDao.XXXnumeroOpera);
        }
    }
    ...
    public void setNumeroOrdine(HashMap opzioni) throws Exception {
        ...
        param.setValueString(opzioni,Ve_musica_aut_comCommonDao.XXXnumeroOrdine);
        if ((value = this.setParameterLikeAnywhere(param)) != null) {
            this.basicCriteria.add(value);
            opzioni.remove(Ve_musica_aut_comCommonDao.XXXnumeroOrdine);
        }
    }
    ...
    {
        try {
            Class cl = Ve_musica_aut_comCommonDao.class;//this.getClass();
    ...
    public static void main(String[] args) throws Exception{
        Ve_musica_aut_comCommonDao aut = new Ve_musica_aut_comCommonDao();

...
public class Ve_musica_aut_luoCommonDao extends Tb_titoloCommonDao {
	...
	public Ve_musica_aut_luoCommonDao() {
        super();
	}
	...
	{
		try {
			Class cl = Ve_musica_aut_luoCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Ve_musica_aut_luoCommonDao aut = new Ve_musica_aut_luoCommonDao();

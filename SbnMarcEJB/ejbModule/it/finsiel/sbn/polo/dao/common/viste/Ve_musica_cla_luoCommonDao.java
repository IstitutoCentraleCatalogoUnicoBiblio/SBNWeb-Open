...
public class Ve_musica_cla_luoCommonDao extends Tb_titoloCommonDao {
	...
	public Ve_musica_cla_luoCommonDao() {
        super();
	}
	...
	{
		try {
			Class cl = Ve_musica_cla_luoCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Ve_musica_cla_luoCommonDao aut = new Ve_musica_cla_luoCommonDao();

...
public class Ve_musica_luo_autCommonDao extends Tb_titoloCommonDao {
	...
	public Ve_musica_luo_autCommonDao() {
		super();
	}
	...
	{
		try {
			Class cl = Ve_musica_luo_autCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Ve_musica_luo_autCommonDao aut = new Ve_musica_luo_autCommonDao();

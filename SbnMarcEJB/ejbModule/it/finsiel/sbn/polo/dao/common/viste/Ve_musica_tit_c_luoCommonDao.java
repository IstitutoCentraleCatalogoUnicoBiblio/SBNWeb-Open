...
public class Ve_musica_tit_c_luoCommonDao extends Tb_titoloCommonDao {
	...
	public Ve_musica_tit_c_luoCommonDao() {
        super();
	}
	...
	{
		try {
			Class cl = Ve_musica_tit_c_luoCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Ve_musica_tit_c_luoCommonDao aut = new Ve_musica_tit_c_luoCommonDao();

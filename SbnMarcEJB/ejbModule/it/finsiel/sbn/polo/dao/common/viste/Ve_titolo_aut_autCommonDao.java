...
public class Ve_titolo_aut_autCommonDao extends Tb_titoloCommonDao {
...
*/
	...
	public Ve_titolo_aut_autCommonDao() {
		super();
	}
    ...
    private void setStringaLikeAutore1(HashMap opzioni) throws Exception {
        ...
        param.setValueString(opzioni,Ve_titolo_aut_autCommonDao.XXXStringaLikeAutore1);
    ...
    private void setStringaLikeAutore2(HashMap opzioni) throws Exception {
        ...
        param.setValueString(opzioni,Ve_titolo_aut_autCommonDao.XXXStringaLikeAutore2);
    ...
    private void setStringaEsattaAutore1(HashMap opzioni) throws Exception {
        ...
        Parameter param = new Parameter();
        param.setKey("KY_CLES1_A_F");
        param.setValueString(opzioni,Ve_titolo_aut_autCommonDao.XXXStringaEsattaAutore1);
    ...
    private void setStringaEsattaAutore2(HashMap opzioni) throws Exception {
        ...
        Parameter param = new Parameter();
        param.setKey("KY_CLES2_A_F");
        param.setValueString(opzioni,Ve_titolo_aut_autCommonDao.XXXStringaEsattaAutore2);
        if ((value = this.setParameterEq(param)) != null) {
            this.basicCriteria.add(value);
    ...
    private void setKyAuteur(HashMap opzioni) throws Exception {
        ...
        param.setValueString(opzioni,Ve_titolo_aut_autCommonDao.XXXky_auteur);
        if ((value = this.setParameterEq(param)) != null) {
            this.basicCriteria.add(value);
    ...
    private void setKyCautun(HashMap opzioni) throws Exception {
        ...
        param.setValueString(opzioni,Ve_titolo_aut_autCommonDao.XXXky_cautun);
        if ((value = this.setParameterEq(param)) != null) {
            this.basicCriteria.add(value);
    ...
    private void setTpResponsabilita(HashMap opzioni) throws Exception {
        ...
        param.setValueString(opzioni,Ve_titolo_aut_autCommonDao.XXXtp_responsabilita);
        if ((value = this.setParameterEq(param)) != null) {
            this.basicCriteria.add(value);
    ...
    private void setCdRelazione(HashMap opzioni) throws Exception {
        ...
        param.setValueString(opzioni,Ve_titolo_aut_autCommonDao.XXXcd_relazione);
        if ((value = this.setParameterEq(param)) != null) {
            this.basicCriteria.add(value);
	...
	{
		try {
			Class cl = Ve_titolo_aut_autCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Ve_titolo_aut_autCommonDao aut = new Ve_titolo_aut_autCommonDao();

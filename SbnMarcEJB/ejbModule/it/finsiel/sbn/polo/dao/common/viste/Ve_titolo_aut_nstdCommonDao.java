...
public class Ve_titolo_aut_nstdCommonDao extends Tb_titoloCommonDao {
    /*
        DEFAULT <opzionale dipende="XXXnumeroLastraDa"> AND numero_lastra &gt;= XXXnumeroLastraDa </opzionale>
        DEFAULT <opzionale dipende="XXXnumeroLastraA"> AND numero_lastra &lt;= XXXnumeroLastraA </opzionale>
 ...
 */
	...
	public Ve_titolo_aut_nstdCommonDao() {
		super();
	}
	...
	{
		try {
			Class cl = Ve_titolo_aut_nstdCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Ve_titolo_aut_nstdCommonDao aut = new Ve_titolo_aut_nstdCommonDao();

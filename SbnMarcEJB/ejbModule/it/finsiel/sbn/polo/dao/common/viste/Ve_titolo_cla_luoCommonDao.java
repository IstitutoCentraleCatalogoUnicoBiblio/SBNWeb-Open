...
public class Ve_titolo_cla_luoCommonDao extends Tb_titoloCommonDao {

    protected boolean kycleslike = false;
    Tb_luogoCommonDao luogo;
    //Tb_titoloCommonDao titolo;

	public Ve_titolo_cla_luoCommonDao() {
		super();
	}
	...
	{
		try {
			Class cl = Ve_titolo_cla_luoCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Ve_titolo_cla_luoCommonDao aut = new Ve_titolo_cla_luoCommonDao();

...
public class Ve_titolo_cla_marCommonDao extends Tb_titoloCommonDao {

    protected boolean kycleslike = false;
    Tb_marcaCommonDao marca;
    //Tb_titoloCommonDao titolo;

	public Ve_titolo_cla_marCommonDao() {
		super();
	}
	...
	{
		try {
			Class cl = Ve_titolo_cla_marCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Ve_titolo_cla_marCommonDao aut = new Ve_titolo_cla_marCommonDao();

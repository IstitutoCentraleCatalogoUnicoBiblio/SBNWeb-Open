...
public class Ve_titolo_luo_autCommonDao extends Tb_titoloCommonDao {

    protected boolean kycleslike = false;
    Tb_autoreCommonDao autore;
    //Tb_titoloCommonDao titolo;

	public Ve_titolo_luo_autCommonDao() {
		super();
	}
	...
	{
		try {
			Class cl = Ve_titolo_luo_autCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Ve_titolo_luo_autCommonDao aut = new Ve_titolo_luo_autCommonDao();

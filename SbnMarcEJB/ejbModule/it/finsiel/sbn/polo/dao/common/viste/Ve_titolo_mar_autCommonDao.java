...
public class Ve_titolo_mar_autCommonDao extends Tb_titoloCommonDao {

    protected boolean kycleslike = false;
    Tb_autoreCommonDao autore;
    //Tb_titoloCommonDao titolo;

	public Ve_titolo_mar_autCommonDao() {
		super();
	}
	...
	{
		try {
			Class cl = Ve_titolo_mar_autCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Ve_titolo_mar_autCommonDao aut = new Ve_titolo_mar_autCommonDao();

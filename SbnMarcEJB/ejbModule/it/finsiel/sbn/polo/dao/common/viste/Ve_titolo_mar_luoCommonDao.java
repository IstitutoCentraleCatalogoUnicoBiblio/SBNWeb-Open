...
public class Ve_titolo_mar_luoCommonDao extends Tb_titoloCommonDao {
	...
	public Ve_titolo_mar_luoCommonDao() {
		super();
	}
	...
	{
		try {
			Class cl = Ve_titolo_mar_luoCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Ve_titolo_mar_luoCommonDao aut = new Ve_titolo_mar_luoCommonDao();

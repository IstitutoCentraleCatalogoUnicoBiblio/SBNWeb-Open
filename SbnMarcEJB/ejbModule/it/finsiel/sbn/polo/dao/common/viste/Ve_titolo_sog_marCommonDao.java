...
public class Ve_titolo_sog_marCommonDao extends Tb_titoloCommonDao {
	...
	public Ve_titolo_sog_marCommonDao() {
		super();
	}
	...
	{
		try {
			Class cl = Ve_titolo_sog_marCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Ve_titolo_sog_marCommonDao aut = new Ve_titolo_sog_marCommonDao();

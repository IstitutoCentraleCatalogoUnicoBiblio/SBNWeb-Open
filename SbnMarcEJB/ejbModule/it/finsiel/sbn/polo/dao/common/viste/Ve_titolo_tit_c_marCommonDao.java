...
public class Ve_titolo_tit_c_marCommonDao extends Tb_titoloCommonDao {

    protected boolean kycleslike = false;
    Tb_marcaCommonDao marca;
    //Tb_titoloCommonDao titolo;

	public Ve_titolo_tit_c_marCommonDao() {
		super();
	}
	...
	{
		try {
			Class cl = Ve_titolo_tit_c_marCommonDao.class;//this.getClass();
            ...
            this.marca = new Tb_marcaCommonDao(this.basicCriteria);
            //this.titolo = new Tb_titoloCommonDao(this.basicCriteria);
            super.createCriteria(opzioni);
            this.marca.createCriteria(opzioni);
	...
	public static void main(String[] args) throws Exception{
		Ve_titolo_tit_c_marCommonDao aut = new Ve_titolo_tit_c_marCommonDao();

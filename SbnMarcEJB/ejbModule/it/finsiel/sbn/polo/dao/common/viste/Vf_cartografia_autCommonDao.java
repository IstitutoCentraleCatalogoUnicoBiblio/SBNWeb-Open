...
public class Vf_cartografia_autCommonDao extends Tb_titoloCommonDao {
	...
	public Vf_cartografia_autCommonDao() {
        super();
	}
	...
	{
		try {
			Class cl = Vf_cartografia_autCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vf_cartografia_autCommonDao aut = new Vf_cartografia_autCommonDao();

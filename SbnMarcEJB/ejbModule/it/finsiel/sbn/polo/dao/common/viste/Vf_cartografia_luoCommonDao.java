...
public class Vf_cartografia_luoCommonDao extends Tb_titoloCommonDao {
	...
	public Vf_cartografia_luoCommonDao() {
        super();
	}
	...
	{
		try {
			Class cl = Vf_cartografia_luoCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vf_cartografia_luoCommonDao aut = new Vf_cartografia_luoCommonDao();

...
public class Vf_grafica_luoCommonDao extends Tb_titoloCommonDao {
	...
	public Vf_grafica_luoCommonDao() {
        super();
	}
	...
	{
		try {
			Class cl = Vf_grafica_luoCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vf_grafica_luoCommonDao aut = new Vf_grafica_luoCommonDao();

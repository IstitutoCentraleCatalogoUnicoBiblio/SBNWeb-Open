...
public class Vf_musica_autCommonDao extends Tb_titoloCommonDao {
	...
	{
		try {
			Class cl = Vf_musica_autCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vf_musica_autCommonDao aut = new Vf_musica_autCommonDao();

...
public class Vf_musica_comCommonDao extends Tb_titoloCommonDao {
...
*/
    ...
    public void setNumeroOpera(HashMap opzioni) throws Exception {
        ...
        param.setValueString(opzioni,Vf_musica_comCommonDao.XXXnumeroOpera);
        if ((value = this.setParameterLikeAnywhere(param)) != null) {
            this.basicCriteria.add(value);
            opzioni.remove(Vf_musica_comCommonDao.XXXnumeroOpera);
        }
    }
    ...
    public void setNumeroOrdine(HashMap opzioni) throws Exception {
        ...
        param.setValueString(opzioni,Vf_musica_comCommonDao.XXXnumeroOrdine);
        if ((value = this.setParameterLikeAnywhere(param)) != null) {
            this.basicCriteria.add(value);
            opzioni.remove(Vf_musica_comCommonDao.XXXnumeroOrdine);
        }
    }
    ...
    {
        try {
            Class cl = Vf_musica_comCommonDao.class;//this.getClass();
    ...
    public static void main(String[] args) throws Exception{
        Vf_musica_comCommonDao aut = new Vf_musica_comCommonDao();

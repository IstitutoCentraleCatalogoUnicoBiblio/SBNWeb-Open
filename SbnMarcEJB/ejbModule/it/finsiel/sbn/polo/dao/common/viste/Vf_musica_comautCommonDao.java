...
public class Vf_musica_comautCommonDao extends Tb_titoloCommonDao {
...
/*
    ...
    */
    ...
    public Vf_musica_comautCommonDao() {
        super();
    }
...
*/
    ...
    public void setNumeroOpera(HashMap opzioni) throws Exception {
        ...
        param.setValueString(opzioni,Vf_musica_comautCommonDao.XXXnumeroOpera);

        if ((value = this.setParameterLikeAnywhere(param)) != null) {
            this.basicCriteria.add(value);
            opzioni.remove(Vf_musica_comautCommonDao.XXXnumeroOpera);
        }
    }
    ...
    public void setNumeroOrdine(HashMap opzioni) throws Exception {
        ...
        param.setValueString(opzioni,Vf_musica_comautCommonDao.XXXnumeroOrdine);
        if ((value = this.setParameterLikeAnywhere(param)) != null) {
            this.basicCriteria.add(value);
            opzioni.remove(Vf_musica_comautCommonDao.XXXnumeroOrdine);
        }
    }
    ...
    {
        try {
            Class cl = Vf_musica_comautCommonDao.class;//this.getClass();
    ...
    public static void main(String[] args) throws Exception{
        Vf_musica_comautCommonDao aut = new Vf_musica_comautCommonDao();

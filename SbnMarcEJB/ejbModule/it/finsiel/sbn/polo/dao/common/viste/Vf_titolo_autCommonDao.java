...
public class Vf_titolo_autCommonDao extends Tb_titoloCommonDao {
	...
	{
		try {
			Class cl = Vf_titolo_autCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vf_titolo_autCommonDao aut = new Vf_titolo_autCommonDao();

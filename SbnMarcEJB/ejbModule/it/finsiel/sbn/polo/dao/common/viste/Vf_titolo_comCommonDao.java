...
public class Vf_titolo_comCommonDao extends Tb_titoloCommonDao {
	...
	{
		try {
			Class cl = Vf_titolo_comCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vf_titolo_comCommonDao aut = new Vf_titolo_comCommonDao();

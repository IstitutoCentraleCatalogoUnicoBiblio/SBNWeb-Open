...
public class Vf_titolo_luoCommonDao extends Tb_titoloCommonDao {
	...
	{
		try {
			Class cl = Vf_titolo_luoCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vf_titolo_luoCommonDao aut = new Vf_titolo_luoCommonDao();

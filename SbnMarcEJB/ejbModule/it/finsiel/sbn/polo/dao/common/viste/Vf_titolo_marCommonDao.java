...
public class Vf_titolo_marCommonDao extends Tb_titoloCommonDao {
	...
	{
		try {
			Class cl = Vf_titolo_marCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vf_titolo_marCommonDao aut = new Vf_titolo_marCommonDao();

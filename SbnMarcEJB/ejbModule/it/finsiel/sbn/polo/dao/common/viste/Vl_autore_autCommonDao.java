...
public class Vl_autore_autCommonDao extends Tb_autoreCommonDao {



    protected boolean kycleslike = false;

	public Vl_autore_autCommonDao() {
        super();
	}
	...
	{
		try {
			Class cl = Vl_autore_autCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vl_autore_autCommonDao aut = new Vl_autore_autCommonDao();

...
public class Vl_autore_bibCommonDao extends Tb_autoreCommonDao {



    protected boolean kycleslike = false;

	public Vl_autore_bibCommonDao() {
        super();
	}
	...
	{
		try {
			Class cl = Vl_autore_bibCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vl_autore_bibCommonDao aut = new Vl_autore_bibCommonDao();

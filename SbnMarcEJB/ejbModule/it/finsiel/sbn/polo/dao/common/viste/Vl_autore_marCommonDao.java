...
public class Vl_autore_marCommonDao extends Tb_autoreCommonDao {
	...
	{
		try {
			Class cl = Vl_autore_marCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vl_autore_marCommonDao aut = new Vl_autore_marCommonDao();

...
public class Vl_autore_titCommonDao extends Tb_autoreCommonDao {
	...
	{
		try {
			Class cl = Vl_autore_titCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vl_autore_titCommonDao aut = new Vl_autore_titCommonDao();

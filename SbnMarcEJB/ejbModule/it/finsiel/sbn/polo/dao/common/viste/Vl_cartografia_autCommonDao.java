...
public class Vl_cartografia_autCommonDao extends Tb_titoloCommonDao {
	...
	public Vl_cartografia_autCommonDao() {
        super();
	}
	...
	{
		try {
			Class cl = Vl_cartografia_autCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vl_cartografia_autCommonDao aut = new Vl_cartografia_autCommonDao();

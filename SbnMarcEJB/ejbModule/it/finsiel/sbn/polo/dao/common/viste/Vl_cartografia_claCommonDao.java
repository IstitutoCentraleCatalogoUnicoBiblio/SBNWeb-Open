...
public class Vl_cartografia_claCommonDao extends Tb_titoloCommonDao{
	...
	public Vl_cartografia_claCommonDao() {
        super();
	}
	...
	{
		try {
			Class cl = Vl_cartografia_claCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vl_cartografia_claCommonDao aut = new Vl_cartografia_claCommonDao();

...
public class Vl_cartografia_luoCommonDao extends Tb_titoloCommonDao{
	...
	public Vl_cartografia_luoCommonDao() {
        super();
	}
	...
	{
		try {
			Class cl = Vl_cartografia_luoCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vl_cartografia_luoCommonDao aut = new Vl_cartografia_luoCommonDao();

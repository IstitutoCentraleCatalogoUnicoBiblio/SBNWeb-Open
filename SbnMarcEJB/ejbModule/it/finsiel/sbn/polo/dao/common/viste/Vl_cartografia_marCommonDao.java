...
public class Vl_cartografia_marCommonDao extends Tb_titoloCommonDao {
	...
	public Vl_cartografia_marCommonDao() {
        super();
	}
	...
	{
		try {
			Class cl = Vl_cartografia_marCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vl_cartografia_marCommonDao aut = new Vl_cartografia_marCommonDao();

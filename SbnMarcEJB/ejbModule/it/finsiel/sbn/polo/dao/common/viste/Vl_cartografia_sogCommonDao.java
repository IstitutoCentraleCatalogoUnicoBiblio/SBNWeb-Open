...
public class Vl_cartografia_sogCommonDao extends Tb_titoloCommonDao {
	...
	public Vl_cartografia_sogCommonDao() {
        super();
	}
	...
	{
		try {
			Class cl = Vl_cartografia_sogCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vl_cartografia_sogCommonDao aut = new Vl_cartografia_sogCommonDao();

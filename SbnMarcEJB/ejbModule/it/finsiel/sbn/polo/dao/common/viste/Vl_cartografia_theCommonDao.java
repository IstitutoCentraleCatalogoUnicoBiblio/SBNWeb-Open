...
public class Vl_cartografia_theCommonDao extends Tb_titoloCommonDao {
	...
	public Vl_cartografia_theCommonDao() {
        super();
	}
	...
	{
		try {
			Class cl = Vl_cartografia_theCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vl_cartografia_theCommonDao aut = new Vl_cartografia_theCommonDao();

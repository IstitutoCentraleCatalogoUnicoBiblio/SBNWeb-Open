...
public class Vl_classe_titCommonDao extends Tb_classeCommonDao{



    protected boolean kycleslike = false;

	public Vl_classe_titCommonDao() {
        super();
	}
	...
	{
		try {
			Class cl = Vl_classe_titCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vl_classe_titCommonDao aut = new Vl_classe_titCommonDao();

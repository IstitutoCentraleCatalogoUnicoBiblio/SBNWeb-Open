...
public class Vl_composizione_autCommonDao extends Tb_titoloCommonDao {
	...
	public Vl_composizione_autCommonDao() {
        super();
	}
	...
	{
		try {
			Class cl = Vl_composizione_autCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vl_composizione_autCommonDao aut = new Vl_composizione_autCommonDao();

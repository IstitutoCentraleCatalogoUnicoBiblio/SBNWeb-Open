...
public class Vl_descrittore_desCommonDao extends Tb_descrittoreCommonDao{



    protected boolean kycleslike = false;

	public Vl_descrittore_desCommonDao() {
        super();
	}
	...
	{
		try {
			Class cl = Vl_descrittore_desCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vl_descrittore_desCommonDao aut = new Vl_descrittore_desCommonDao();

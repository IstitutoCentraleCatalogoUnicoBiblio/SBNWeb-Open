...
public class Vl_descrittore_sogCommonDao extends Tb_descrittoreCommonDao{



    protected boolean kycleslike = false;

	public Vl_descrittore_sogCommonDao() {
        super();
	}
	...
	{
		try {
			Class cl = Vl_descrittore_sogCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vl_descrittore_sogCommonDao aut = new Vl_descrittore_sogCommonDao();

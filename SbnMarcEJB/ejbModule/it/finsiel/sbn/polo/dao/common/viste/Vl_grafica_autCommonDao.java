...
public class Vl_grafica_autCommonDao extends Tb_titoloCommonDao {
	...
	public Vl_grafica_autCommonDao() {
        super();
	}
	...
	{
		try {
			Class cl = Vl_grafica_autCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vl_grafica_autCommonDao aut = new Vl_grafica_autCommonDao();

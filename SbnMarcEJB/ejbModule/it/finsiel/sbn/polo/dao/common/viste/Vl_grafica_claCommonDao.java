...
public class Vl_grafica_claCommonDao extends Tb_titoloCommonDao {
	...
	public Vl_grafica_claCommonDao() {
        super();
	}
	...
	{
		try {
			Class cl = Vl_grafica_claCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vl_grafica_claCommonDao aut = new Vl_grafica_claCommonDao();

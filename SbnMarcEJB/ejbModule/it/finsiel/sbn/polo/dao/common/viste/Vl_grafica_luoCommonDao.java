...
public class Vl_grafica_luoCommonDao extends Tb_titoloCommonDao {
	...
	public Vl_grafica_luoCommonDao() {
        super();
	}
	...
	{
		try {
			Class cl = Vl_grafica_luoCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vl_grafica_luoCommonDao aut = new Vl_grafica_luoCommonDao();

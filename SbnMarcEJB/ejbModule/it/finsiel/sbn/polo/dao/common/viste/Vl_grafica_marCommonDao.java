...
public class Vl_grafica_marCommonDao extends Tb_titoloCommonDao {
	...
	public Vl_grafica_marCommonDao() {
        super();
	}
	...
	{
		try {
			Class cl = Vl_grafica_marCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vl_grafica_marCommonDao aut = new Vl_grafica_marCommonDao();

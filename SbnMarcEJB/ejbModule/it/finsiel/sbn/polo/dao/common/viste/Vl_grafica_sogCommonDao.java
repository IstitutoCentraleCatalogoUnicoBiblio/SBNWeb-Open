...
public class Vl_grafica_sogCommonDao extends Tb_titoloCommonDao {
	...
	public Vl_grafica_sogCommonDao() {
        super();
	}
	...
	{
		try {
			Class cl = Vl_grafica_sogCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vl_grafica_sogCommonDao aut = new Vl_grafica_sogCommonDao();

...
public class Vl_grafica_theCommonDao extends Tb_titoloCommonDao {
	...
	public Vl_grafica_theCommonDao() {
        super();
	}
	...
	{
		try {
			Class cl = Vl_grafica_theCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vl_grafica_theCommonDao aut = new Vl_grafica_theCommonDao();

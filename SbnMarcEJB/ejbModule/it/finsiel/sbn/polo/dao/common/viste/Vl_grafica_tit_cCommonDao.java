...
public class Vl_grafica_tit_cCommonDao extends Tb_titoloCommonDao {
	...
	public Vl_grafica_tit_cCommonDao() {
        super();
	}
	...
	{
		try {
			Class cl = Vl_grafica_tit_cCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vl_grafica_tit_cCommonDao aut = new Vl_grafica_tit_cCommonDao();

...
public class Vl_luogo_luoCommonDao extends Tb_luogoCommonDao{



    protected boolean kycleslike = false;

	public Vl_luogo_luoCommonDao() {
        super();
	}
	...
	{
		try {
			Class cl = Vl_luogo_luoCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vl_luogo_luoCommonDao aut = new Vl_luogo_luoCommonDao();

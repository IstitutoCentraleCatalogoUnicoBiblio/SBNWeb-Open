...
public class Vl_luogo_titCommonDao extends Tb_luogoCommonDao{



    protected boolean kycleslike = false;

	public Vl_luogo_titCommonDao() {
        super();
	}
	...
	{
		try {
			Class cl = Vl_luogo_titCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vl_luogo_titCommonDao aut = new Vl_luogo_titCommonDao();

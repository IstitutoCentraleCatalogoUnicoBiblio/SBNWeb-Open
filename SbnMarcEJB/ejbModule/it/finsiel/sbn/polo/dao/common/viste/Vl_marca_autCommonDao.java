...
public class Vl_marca_autCommonDao extends Tb_marcaCommonDao{



    protected boolean kycleslike = false;

	public Vl_marca_autCommonDao() {
        super();
	}
	...
	{
		try {
			Class cl = Vl_marca_autCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vl_marca_autCommonDao aut = new Vl_marca_autCommonDao();

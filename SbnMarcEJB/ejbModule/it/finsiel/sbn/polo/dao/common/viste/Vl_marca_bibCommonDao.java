...
public class Vl_marca_bibCommonDao extends Tb_marcaCommonDao{



    protected boolean kycleslike = false;

	public Vl_marca_bibCommonDao() {
        super();
	}
	...
	{
		try {
			Class cl = Vl_marca_bibCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vl_marca_bibCommonDao aut = new Vl_marca_bibCommonDao();

...
public class Vl_marca_repCommonDao extends Tb_marcaCommonDao{
	...
	{
		try {
			Class cl = Vl_marca_repCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vl_marca_repCommonDao aut = new Vl_marca_repCommonDao();

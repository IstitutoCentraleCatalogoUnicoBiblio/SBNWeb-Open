...
public class Vl_musica_autCommonDao extends Tb_titoloCommonDao {
	...
	{
		try {
			Class cl = Vl_musica_autCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vl_musica_autCommonDao aut = new Vl_musica_autCommonDao();

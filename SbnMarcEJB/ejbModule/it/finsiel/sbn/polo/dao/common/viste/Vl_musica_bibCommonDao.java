...
public class Vl_musica_bibCommonDao extends Tb_titoloCommonDao {
	...
	{
		try {
			Class cl = Vl_musica_bibCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vl_musica_bibCommonDao aut = new Vl_musica_bibCommonDao();

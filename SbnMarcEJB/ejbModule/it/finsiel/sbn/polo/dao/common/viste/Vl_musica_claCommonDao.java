...
public class Vl_musica_claCommonDao extends Tb_titoloCommonDao {
	...
	{
		try {
			Class cl = Vl_musica_claCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vl_musica_claCommonDao aut = new Vl_musica_claCommonDao();

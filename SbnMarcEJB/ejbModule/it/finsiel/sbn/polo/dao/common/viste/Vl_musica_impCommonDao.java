...
public class Vl_musica_impCommonDao extends Tb_titoloCommonDao {
	...
	{
		try {
			Class cl = Vl_musica_impCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vl_musica_impCommonDao aut = new Vl_musica_impCommonDao();

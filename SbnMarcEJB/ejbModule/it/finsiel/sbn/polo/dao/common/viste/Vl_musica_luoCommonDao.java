...
public class Vl_musica_luoCommonDao extends Tb_titoloCommonDao {
	...
	{
		try {
			Class cl = Vl_musica_luoCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vl_musica_luoCommonDao aut = new Vl_musica_luoCommonDao();

...
public class Vl_musica_marCommonDao extends Tb_titoloCommonDao {
	...
	{
		try {
			Class cl = Vl_musica_marCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vl_musica_marCommonDao aut = new Vl_musica_marCommonDao();

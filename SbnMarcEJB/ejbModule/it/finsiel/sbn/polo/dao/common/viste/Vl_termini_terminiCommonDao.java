...
public class Vl_termini_terminiCommonDao extends Tb_termine_thesauroCommonDao{



    protected boolean kycleslike = false;

	public Vl_termini_terminiCommonDao() {
        super();
	}
	...
	{
		try {
			Class cl = Vl_termini_terminiCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vl_termini_terminiCommonDao aut = new Vl_termini_terminiCommonDao();

...
public class Vl_the_tit_bibCommonDao extends Tb_termine_thesauroCommonDao{


    protected boolean kycleslike = false;

	public Vl_the_tit_bibCommonDao() {
        super();
	}
	...
	{
		try {
			Class cl = Vl_the_tit_bibCommonDao.class;//this.getClass();

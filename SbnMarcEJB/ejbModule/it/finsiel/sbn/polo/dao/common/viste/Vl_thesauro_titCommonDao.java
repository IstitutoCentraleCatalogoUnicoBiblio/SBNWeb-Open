...
public class Vl_thesauro_titCommonDao extends Tb_termine_thesauroCommonDao{


    protected boolean kycleslike = false;

	public Vl_thesauro_titCommonDao() {
        super();
	}
	...
	{
		try {
			Class cl = Vl_thesauro_titCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vl_thesauro_titCommonDao aut = new Vl_thesauro_titCommonDao();

...
public class Vl_titolo_autCommonDao extends Tb_titoloCommonDao {
	...
	{
		try {
			Class cl = Vl_titolo_autCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vl_titolo_autCommonDao aut = new Vl_titolo_autCommonDao();

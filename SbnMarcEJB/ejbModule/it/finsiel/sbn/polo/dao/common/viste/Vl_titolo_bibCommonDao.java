...
public class Vl_titolo_bibCommonDao extends Tb_titoloCommonDao {
	...
	{
		try {
			Class cl = Vl_titolo_bibCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vl_titolo_bibCommonDao aut = new Vl_titolo_bibCommonDao();

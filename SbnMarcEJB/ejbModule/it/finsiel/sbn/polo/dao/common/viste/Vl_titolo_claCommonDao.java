...
public class Vl_titolo_claCommonDao extends Tb_titoloCommonDao {
	...
	{
		try {
			Class cl = Vl_titolo_claCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vl_titolo_claCommonDao aut = new Vl_titolo_claCommonDao();

...
public class Vl_titolo_luoCommonDao extends Tb_titoloCommonDao {
	...
	{
		try {
			Class cl = Vl_titolo_luoCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vl_titolo_luoCommonDao aut = new Vl_titolo_luoCommonDao();

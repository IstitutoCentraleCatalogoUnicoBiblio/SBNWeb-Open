...
public class Vl_titolo_num_stdCommonDao extends Tb_titoloCommonDao {
	...
	public Vl_titolo_num_stdCommonDao() {
        super();
	}
	...
	{
		try {
			Class cl = Vl_titolo_num_stdCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vl_titolo_num_stdCommonDao aut = new Vl_titolo_num_stdCommonDao();

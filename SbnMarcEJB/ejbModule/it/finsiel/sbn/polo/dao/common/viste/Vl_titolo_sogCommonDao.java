...
public class Vl_titolo_sogCommonDao extends Tb_titoloCommonDao {
	...
	{
		try {
			Class cl = Vl_titolo_sogCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vl_titolo_sogCommonDao aut = new Vl_titolo_sogCommonDao();

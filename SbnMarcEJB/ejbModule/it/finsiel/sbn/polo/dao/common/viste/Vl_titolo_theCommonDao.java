...
public class Vl_titolo_theCommonDao extends Tb_titoloCommonDao {
	...
	{
		try {
			Class cl = Vl_titolo_theCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vl_titolo_theCommonDao aut = new Vl_titolo_theCommonDao();

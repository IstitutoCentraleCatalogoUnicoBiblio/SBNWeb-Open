...
public class Vl_titolo_tit_cCommonDao extends Tb_titoloCommonDao {
	...
	public Vl_titolo_tit_cCommonDao() {
        super();
	}
	...
	{
		try {
			Class cl = Vl_titolo_tit_cCommonDao.class;//this.getClass();
	...
	public static void main(String[] args) throws Exception{
		Vl_titolo_tit_cCommonDao aut = new Vl_titolo_tit_cCommonDao();

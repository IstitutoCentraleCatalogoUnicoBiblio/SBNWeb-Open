...
import it.finsiel.sbn.polo.dao.common.viste.V_composizioneCommonDao;
...
public class V_composizioneResult extends V_composizioneCommonDao {

    public V_composizioneResult(V_composizione v_composizione) throws InfrastructureException {
        super();
        this.valorizzaParametro(v_composizione.leggiAllParametro());
    }
	 ...
	 */
	public List<V_composizione> selectPerNomeLike(HashMap opzioni)
			throws InfrastructureException {
		try {
			...
			session.enableFilter("V_COMPOSIZIONE_selectPerNomeLike");
			...
			List<V_composizione> result = this.basicCriteria
					.list();
	...
	<statement nome="countPerNomeLike" tipo="count" id="04_taymer">
			<fisso>
				SELECT COUNT (distinct (bid) ) FROM v_composizione
				WHERE
				fl_canc !='S' AND
				(
					( ky_cles1_t  LIKE XXXstringaLike1||'%'
	...
	public Integer countPerNomeLike(HashMap opzioni)
		...
		try {
			...
			this.basicCriteria = session.createCriteria(getTarget());
			this.kycleslike=false;
			session.enableFilter("V_COMPOSIZIONE_countPerNomeLike");
	 ...
	 * @throws InfrastructureException
	 */
	public List<V_composizione> selectPerNomeEsatto(HashMap opzioni)
			throws InfrastructureException {
		try {
			HashMap myOpzioni = (HashMap) opzioni.clone();
			Session session = this.getSession();
			...
			this.basicCriteria = session.createCriteria(getTarget());
			this.kycleslike=false;
			session.enableFilter("V_COMPOSIZIONE_selectPerNomeEsatto");
	...
	public Integer countPerNomeEsatto(HashMap opzioni)
		...
		try {
			...
			this.basicCriteria = session.createCriteria(getTarget());
			this.kycleslike=false;
			session.enableFilter("V_COMPOSIZIONE_countPerNomeEsatto");
	 ...
	 * @throws InfrastructureException
	 */
	public List<V_composizione> selectPerClet(HashMap opzioni)
			throws InfrastructureException {
		try {
			HashMap myOpzioni = (HashMap) opzioni.clone();
			Session session = this.getSession();
			...
			this.basicCriteria = session.createCriteria(getTarget());
			this.kycleslike=false;
			Filter filter = session.enableFilter("V_COMPOSIZIONE_selectPerClet");
			filter.setParameter(it.finsiel.sbn.polo.dao.common.viste.V_composizioneCommonDao.XXXstringaClet, opzioni
					.get(it.finsiel.sbn.polo.dao.common.viste.V_composizioneCommonDao.XXXstringaClet));
			myOpzioni.remove(it.finsiel.sbn.polo.dao.common.viste.V_composizioneCommonDao.XXXstringaClet);
            this.basicCriteria = Parameter.setOrdinamento(myOpzioni,
                    "V_composizione",
                    this.basicCriteria, session);
	...
	public Integer countPerClet(HashMap opzioni)
		...
		try {
			...
			this.basicCriteria = session.createCriteria(getTarget());
			this.kycleslike=false;
			Filter filter = session.enableFilter("V_COMPOSIZIONE_countPerClet");
			filter.setParameter(it.finsiel.sbn.polo.dao.common.viste.V_composizioneCommonDao.XXXstringaClet, opzioni
					.get(it.finsiel.sbn.polo.dao.common.viste.V_composizioneCommonDao.XXXstringaClet));
			myOpzioni.remove(it.finsiel.sbn.polo.dao.common.viste.V_composizioneCommonDao.XXXstringaClet);
	 ...
	 * @throws InfrastructureException
	 */
	public List<V_composizione> selectPerComposizione(HashMap opzioni)
			throws InfrastructureException {
		try {
			HashMap myOpzioni = (HashMap) opzioni.clone();
			Session session = this.getSession();
			...
			this.basicCriteria = session.createCriteria(getTarget());
			this.kycleslike=false;
			session.enableFilter("V_COMPOSIZIONE_selectPerComposizione");
	...
	public Integer countPerComposizione(HashMap opzioni)
		...
		try {
			...
			this.basicCriteria = session.createCriteria(getTarget());
			this.kycleslike=false;
			session.enableFilter("V_COMPOSIZIONE_countPerComposizione");
	...
	<statement nome="selectPerBid" tipo="select" id="12_william">
			<fisso>
     		...
     		<opzionale dipende="XXXdata_composizione">
				AND  aa_comp_1 &gt;= UPPER(XXXdata_composizione)
				AND  aa_comp_2 &lt; UPPER(XXXdata_composizione)
			</opzionale>
	 ...
	 * @throws InfrastructureException
	 */
	public List<V_composizione> selectPerBid(HashMap opzioni)
			throws InfrastructureException {
		try {
			HashMap myOpzioni = (HashMap) opzioni.clone();
			Session session = this.getSession();
			...
			Filter filter = session.enableFilter("V_COMPOSIZIONE_selectPerBid");
			filter.setParameter(it.finsiel.sbn.polo.dao.common.viste.V_composizioneCommonDao.XXXbid, opzioni
					.get(it.finsiel.sbn.polo.dao.common.viste.V_composizioneCommonDao.XXXbid));
			myOpzioni.remove(it.finsiel.sbn.polo.dao.common.viste.V_composizioneCommonDao.XXXbid);

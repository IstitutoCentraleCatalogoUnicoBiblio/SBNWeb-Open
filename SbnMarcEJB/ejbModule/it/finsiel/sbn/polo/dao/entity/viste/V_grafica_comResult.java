...
public class V_grafica_comResult extends it.finsiel.sbn.polo.dao.common.viste.V_graficaCommonDao {

    public V_grafica_comResult(V_grafica_com v_grafica_com) throws InfrastructureException {
        super();
        this.valorizzaParametro(v_grafica_com.leggiAllParametro());
    }
	/**

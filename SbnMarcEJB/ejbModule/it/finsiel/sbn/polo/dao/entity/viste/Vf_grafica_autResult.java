...
public class Vf_grafica_autResult extends it.finsiel.sbn.polo.dao.common.viste.Vf_grafica_autCommonDao{

    public Vf_grafica_autResult(Vf_grafica_aut vf_grafica_aut) throws InfrastructureException {
        super();
        this.valorizzaParametro(vf_grafica_aut.leggiAllParametro());
    }
	/**
	 ...
	 */
	public List<Vf_grafica_aut> selectPerNomeEsatto(HashMap opzioni)
			throws InfrastructureException {
		try {
			...
			session.enableFilter("VF_GRAFICA_AUT_selectPerNomeEsatto");
			...
			List<Vf_grafica_aut> result = this.basicCriteria
					.list();
	 ...
	 * @throws InfrastructureException
	 */
	public List<Vf_grafica_aut> selectPerNomeLike(HashMap opzioni)
			throws InfrastructureException {
		try {
			HashMap myOpzioni = (HashMap) opzioni.clone();
			Session session = this.getSession();
			...
			this.basicCriteria = session.createCriteria(getTarget());
			this.kycleslike=false;
			session.enableFilter("VF_GRAFICA_AUT_selectPerNomeLike");
	 ...
	 * @throws InfrastructureException
	 */
	public List<Vf_grafica_aut> selectPerClet(HashMap opzioni)
			throws InfrastructureException {
		try {
			HashMap myOpzioni = (HashMap) opzioni.clone();
			Session session = this.getSession();
			...
			this.basicCriteria = session.createCriteria(getTarget());
			this.kycleslike=false;
			Filter filter = session.enableFilter("VF_GRAFICA_AUT_selectPerClet");
			filter.setParameter(it.finsiel.sbn.polo.dao.common.viste.Vf_grafica_autCommonDao.XXXstringaClet, opzioni
					.get(it.finsiel.sbn.polo.dao.common.viste.Vf_grafica_autCommonDao.XXXstringaClet));
			myOpzioni.remove(it.finsiel.sbn.polo.dao.common.viste.Vf_grafica_autCommonDao.XXXstringaClet);
	...
	<statement nome="countPerNomeEsatto" tipo="count" id="05_taymer">
			<fisso>
				SELECT COUNT (distinct (bid) ) FROM vf_grafica_aut
				WHERE
				fl_canc !='S' AND
				(
					( ky_cles1_t = XXXstringaEsatta1
	...
	public Integer countPerNomeEsatto(HashMap opzioni)
		...
		try {
			...
			this.basicCriteria = session.createCriteria(getTarget());
			this.kycleslike=false;
			session.enableFilter("VF_GRAFICA_AUT_countPerNomeEsatto");
	...
	public Integer countPerNomeLike(HashMap opzioni)
		...
		try {
			...
			this.basicCriteria = session.createCriteria(getTarget());
			this.kycleslike=false;
			session.enableFilter("VF_GRAFICA_AUT_countPerNomeLike");
	...
	public Integer countPerClet(HashMap opzioni)
		...
		try {
			...
			this.basicCriteria = session.createCriteria(getTarget());
			this.kycleslike=false;
			Filter filter = session.enableFilter("VF_GRAFICA_AUT_countPerClet");
			filter.setParameter(it.finsiel.sbn.polo.dao.common.viste.Vf_grafica_autCommonDao.XXXstringaClet, opzioni
					.get(it.finsiel.sbn.polo.dao.common.viste.Vf_grafica_autCommonDao.XXXstringaClet));
			myOpzioni.remove(it.finsiel.sbn.polo.dao.common.viste.Vf_grafica_autCommonDao.XXXstringaClet);

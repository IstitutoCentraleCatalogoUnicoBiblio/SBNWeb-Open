...
public class Vf_grafica_luoResult extends it.finsiel.sbn.polo.dao.common.viste.Vf_cartografia_luoCommonDao {

    public Vf_grafica_luoResult(Vf_grafica_luo vf_grafica_luo) throws InfrastructureException {
        super();
        this.valorizzaParametro(vf_grafica_luo.leggiAllParametro());
    }
	 ...
	 */
	public List<Vf_grafica_luo> selectPerNomeLike(HashMap opzioni)
			throws InfrastructureException {
		try {
			...
			session.enableFilter("VF_GRAFICA_LUO_selectPerNomeLike");
			...
			List<Vf_grafica_luo> result = this.basicCriteria
					.list();
	...
	<statement nome="countPerNomeLike" tipo="count" id="04">
			<fisso>
				SELECT COUNT (distinct (bid) ) FROM Vf_grafica_luoCommonDao
				WHERE
				fl_canc !='S' AND
				(
					( ky_cles1_t  LIKE XXXstringaLike1||'%'
	...
	public Integer countPerNomeLike(HashMap opzioni)
		...
		try {
			...
			this.basicCriteria = session.createCriteria(getTarget());
			this.kycleslike=false;
			session.enableFilter("VF_GRAFICA_LUO_countPerNomeLike");
	 ...
	 * @throws InfrastructureException
	 */
	public List<Vf_grafica_luo> selectPerNomeEsatto(HashMap opzioni)
			throws InfrastructureException {
		try {
			HashMap myOpzioni = (HashMap) opzioni.clone();
			Session session = this.getSession();
			...
			this.basicCriteria = session.createCriteria(getTarget());
			this.kycleslike=false;
			session.enableFilter("VF_GRAFICA_LUO_selectPerNomeEsatto");
	...
	public Integer countPerNomeEsatto(HashMap opzioni)
		...
		try {
			...
			this.basicCriteria = session.createCriteria(getTarget());
			this.kycleslike=false;
			session.enableFilter("VF_GRAFICA_LUO_countPerNomeEsatto");
	 ...
	 * @throws InfrastructureException
	 */
	public List<Vf_grafica_luo> selectPerClet(HashMap opzioni)
			throws InfrastructureException {
		try {
			HashMap myOpzioni = (HashMap) opzioni.clone();
			Session session = this.getSession();
			...
			this.basicCriteria = session.createCriteria(getTarget());
			this.kycleslike=false;
			Filter filter = session.enableFilter("VF_GRAFICA_LUO_selectPerClet");
			filter.setParameter(it.finsiel.sbn.polo.dao.common.viste.Vf_grafica_luoCommonDao.XXXstringaClet, opzioni
					.get(it.finsiel.sbn.polo.dao.common.viste.Vf_grafica_luoCommonDao.XXXstringaClet));
			myOpzioni.remove(it.finsiel.sbn.polo.dao.common.viste.Vf_grafica_luoCommonDao.XXXstringaClet);
	...
	public Integer countPerClet(HashMap opzioni)
		...
		try {
			...
			this.basicCriteria = session.createCriteria(getTarget());
			this.kycleslike=false;
			Filter filter = session.enableFilter("VF_GRAFICA_LUO_countPerClet");
			filter.setParameter(it.finsiel.sbn.polo.dao.common.viste.Vf_grafica_luoCommonDao.XXXstringaClet, opzioni
					.get(it.finsiel.sbn.polo.dao.common.viste.Vf_grafica_luoCommonDao.XXXstringaClet));
			myOpzioni.remove(it.finsiel.sbn.polo.dao.common.viste.Vf_grafica_luoCommonDao.XXXstringaClet);

...
public class Vf_musica_autResult extends
		it.finsiel.sbn.polo.dao.common.viste.Vf_musica_autCommonDao {

    public Vf_musica_autResult(Vf_musica_aut vf_musica_aut) throws InfrastructureException {
        super();
        this.valorizzaParametro(vf_musica_aut.leggiAllParametro());
    }
	 ...
	 */
	public List<Vf_musica_aut> selectPerNomeLike(HashMap opzioni)
			throws InfrastructureException {
		try {
			...
			session.enableFilter("VF_MUSICA_AUT_selectPerNomeLike");
			...
			List<Vf_musica_aut> result = this.basicCriteria
					.list();
	...
	<statement nome="countPerNomeLike" tipo="count" id="04_taymer">
			<fisso>
				SELECT COUNT (distinct (bid) ) FROM vf_musica_aut
				WHERE
				fl_canc !='S' AND
				(
					( ky_cles1_t  LIKE XXXstringaLike1||'%'
	...
	public Integer countPerNomeLike(HashMap opzioni)
		...
		try {
			...
			this.basicCriteria = session.createCriteria(getTarget());
			this.kycleslike=false;
			session.enableFilter("VF_MUSICA_AUT_countPerNomeLike");
	 ...
	 * @throws InfrastructureException
	 */
	public List<Vf_musica_aut> selectPerNomeEsatto(HashMap opzioni)
			throws InfrastructureException {
		try {
			HashMap myOpzioni = (HashMap) opzioni.clone();
			Session session = this.getSession();
			...
			this.basicCriteria = session.createCriteria(getTarget());
			this.kycleslike=false;
			session.enableFilter("VF_MUSICA_AUT_selectPerNomeEsatto");
	...
	public Integer countPerNomeEsatto(HashMap opzioni)
		...
		try {
			...
			this.basicCriteria = session.createCriteria(getTarget());
			this.kycleslike=false;
			session.enableFilter("VF_MUSICA_AUT_countPerNomeEsatto");
	 ...
	 * @throws InfrastructureException
	 */
	public List<Vf_musica_aut> selectPerClet(HashMap opzioni)
			throws InfrastructureException {
		try {
			HashMap myOpzioni = (HashMap) opzioni.clone();
			Session session = this.getSession();
			...
			this.basicCriteria = session.createCriteria(getTarget());
			this.kycleslike=false;
			Filter filter = session.enableFilter("VF_MUSICA_AUT_selectPerClet");
			filter.setParameter(it.finsiel.sbn.polo.dao.common.viste.Vf_musica_autCommonDao.XXXstringaClet, opzioni
					.get(it.finsiel.sbn.polo.dao.common.viste.Vf_musica_autCommonDao.XXXstringaClet));
			myOpzioni.remove(it.finsiel.sbn.polo.dao.common.viste.Vf_musica_autCommonDao.XXXstringaClet);
	...
	public Integer countPerClet(HashMap opzioni)
		...
		try {
			...
			this.basicCriteria = session.createCriteria(getTarget());
			this.kycleslike=false;
			Filter filter = session.enableFilter("VF_MUSICA_AUT_countPerClet");
			filter.setParameter(it.finsiel.sbn.polo.dao.common.viste.Vf_musica_autCommonDao.XXXstringaClet, opzioni
					.get(it.finsiel.sbn.polo.dao.common.viste.Vf_musica_autCommonDao.XXXstringaClet));
			myOpzioni.remove(it.finsiel.sbn.polo.dao.common.viste.Vf_musica_autCommonDao.XXXstringaClet);

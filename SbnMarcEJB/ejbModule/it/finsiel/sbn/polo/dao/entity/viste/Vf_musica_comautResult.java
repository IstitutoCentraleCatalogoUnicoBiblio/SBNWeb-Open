...
import it.finsiel.sbn.polo.dao.common.viste.Vf_musica_comautCommonDao;
...
public class Vf_musica_comautResult extends Vf_musica_comautCommonDao {

    public Vf_musica_comautResult(Vf_musica_comaut vf_musica_comaut) throws InfrastructureException {
        super();
        this.valorizzaParametro(vf_musica_comaut.leggiAllParametro());
    }
	/**
	 ...
	 */
	public List<Vf_musica_comaut> selectPerNomeLike(HashMap opzioni)
			throws InfrastructureException {
		try {
			...
			session.enableFilter("VF_MUSICA_COMAUT_selectPerNomeLike");
			...
			List<Vf_musica_comaut> result = this.basicCriteria
					.list();
	...
	<statement nome="countPerNomeLike" tipo="count" id="04_taymer">
			<fisso>
				SELECT COUNT (distinct (bid) ) FROM vf_musica_comaut
				WHERE
				fl_canc !='S' AND
				(
					( ky_cles1_t  LIKE XXXstringaLike1||'%'
	...
	public Integer countPerNomeLike(HashMap opzioni)
		...
		try {
			...
			this.basicCriteria = session.createCriteria(getTarget());
			this.kycleslike=false;
			session.enableFilter("VF_MUSICA_COMAUT_countPerNomeLike");
	 ...
	 * @throws InfrastructureException
	 */
	public List<Vf_musica_comaut> selectPerNomeEsatto(HashMap opzioni)
			throws InfrastructureException {
		try {
			HashMap myOpzioni = (HashMap) opzioni.clone();
			Session session = this.getSession();
			...
			this.basicCriteria = session.createCriteria(getTarget());
			this.kycleslike=false;
			session.enableFilter("VF_MUSICA_COMAUT_selectPerNomeEsatto");
	...
	public Integer countPerNomeEsatto(HashMap opzioni)
		...
		try {
			...
			this.basicCriteria = session.createCriteria(getTarget());
			this.kycleslike=false;
			session.enableFilter("VF_MUSICA_COMAUT_countPerNomeEsatto");
	 ...
	 * @throws InfrastructureException
	 */
	public List<Vf_musica_comaut> selectPerClet(HashMap opzioni)
			throws InfrastructureException {
		try {
			HashMap myOpzioni = (HashMap) opzioni.clone();
			Session session = this.getSession();
			...
			this.basicCriteria = session.createCriteria(getTarget());
			this.kycleslike=false;
			Filter filter = session.enableFilter("VF_MUSICA_COMAUT_selectPerClet");
			filter.setParameter(it.finsiel.sbn.polo.dao.common.viste.Vf_musica_comautCommonDao.XXXstringaClet, opzioni
					.get(it.finsiel.sbn.polo.dao.common.viste.Vf_musica_comautCommonDao.XXXstringaClet));
			myOpzioni.remove(it.finsiel.sbn.polo.dao.common.viste.Vf_musica_comautCommonDao.XXXstringaClet);
	...
	public Integer countPerClet(HashMap opzioni)
		...
		try {
			...
			this.basicCriteria = session.createCriteria(getTarget());
			this.kycleslike=false;
			Filter filter = session.enableFilter("VF_MUSICA_COMAUT_countPerClet");
			filter.setParameter(it.finsiel.sbn.polo.dao.common.viste.Vf_musica_comautCommonDao.XXXstringaClet, opzioni
					.get(it.finsiel.sbn.polo.dao.common.viste.Vf_musica_comautCommonDao.XXXstringaClet));
			myOpzioni.remove(it.finsiel.sbn.polo.dao.common.viste.Vf_musica_comautCommonDao.XXXstringaClet);
	 ...
	 * @throws InfrastructureException
	 */
	public List<Vf_musica_comaut> selectPerComposizione(HashMap opzioni)
			throws InfrastructureException {
		try {
			HashMap myOpzioni = (HashMap) opzioni.clone();
			Session session = this.getSession();
			...
			this.basicCriteria = session.createCriteria(getTarget());
			this.kycleslike=false;
			session.enableFilter("VF_MUSICA_COMAUT_selectPerComposizione");
	...
	public Integer countPerComposizione(HashMap opzioni)
		...
		try {
			...
			this.basicCriteria = session.createCriteria(getTarget());
			this.kycleslike=false;
			session.enableFilter("VF_MUSICA_COMAUT_countPerComposizione");

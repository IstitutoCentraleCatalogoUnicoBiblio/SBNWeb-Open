...
import it.finsiel.sbn.polo.orm.viste.Vf_musica_luo;
...
public class Vf_musica_luoResult extends
		it.finsiel.sbn.polo.dao.common.viste.Vf_musica_luoCommonDao {

    public Vf_musica_luoResult(Vf_musica_luo vf_musica_luo) throws InfrastructureException {
        super();
        this.valorizzaParametro(vf_musica_luo.leggiAllParametro());
    }
	 ...
	 */
	public List<Vf_musica_luo> selectPerNomeLike(HashMap opzioni)
			throws InfrastructureException {
		try {
			...
			session.enableFilter("VF_MUSICA_LUO_selectPerNomeLike");
			...
			List<Vf_musica_luo> result = this.basicCriteria
					.list();
	...
	<statement nome="countPerNomeLike" tipo="count" id="04_taymer">
			<fisso>
				SELECT COUNT (distinct (bid) ) FROM vf_musica_luo
				WHERE
				fl_canc !='S' AND
				(
					( ky_cles1_t  LIKE XXXstringaLike1||'%'
	...
	public Integer countPerNomeLike(HashMap opzioni)
		...
		try {
			...
			this.basicCriteria = session.createCriteria(getTarget());
			this.kycleslike=false;
			session.enableFilter("VF_MUSICA_LUO_countPerNomeLike");
	 ...
	 * @throws InfrastructureException
	 */
	public List<Vf_musica_luo> selectPerNomeEsatto(HashMap opzioni)
			throws InfrastructureException {
		try {
			HashMap myOpzioni = (HashMap) opzioni.clone();
			Session session = this.getSession();
			...
			this.basicCriteria = session.createCriteria(getTarget());
			this.kycleslike=false;
			session.enableFilter("VF_MUSICA_LUO_selectPerNomeEsatto");
	...
	public Integer countPerNomeEsatto(HashMap opzioni)
		...
		try {
			...
			this.basicCriteria = session.createCriteria(getTarget());
			this.kycleslike=false;
			session.enableFilter("VF_MUSICA_LUO_countPerNomeEsatto");
	 ...
	 * @throws InfrastructureException
	 */
	public List<Vf_musica_luo> selectPerClet(HashMap opzioni)
			throws InfrastructureException {
		try {
			HashMap myOpzioni = (HashMap) opzioni.clone();
			Session session = this.getSession();
			...
			this.basicCriteria = session.createCriteria(getTarget());
			this.kycleslike=false;
			Filter filter = session.enableFilter("VF_MUSICA_LUO_selectPerClet");
			filter.setParameter(it.finsiel.sbn.polo.dao.common.viste.Vf_musica_luoCommonDao.XXXstringaClet, opzioni
					.get(it.finsiel.sbn.polo.dao.common.viste.Vf_musica_luoCommonDao.XXXstringaClet));
			myOpzioni.remove(it.finsiel.sbn.polo.dao.common.viste.Vf_musica_luoCommonDao.XXXstringaClet);
	...
	public Integer countPerClet(HashMap opzioni)
		...
		try {
			...
			this.basicCriteria = session.createCriteria(getTarget());
			this.kycleslike=false;
			Filter filter = session.enableFilter("VF_MUSICA_LUO_countPerClet");
			filter.setParameter(it.finsiel.sbn.polo.dao.common.viste.Vf_musica_luoCommonDao.XXXstringaClet, opzioni
					.get(it.finsiel.sbn.polo.dao.common.viste.Vf_musica_luoCommonDao.XXXstringaClet));
			myOpzioni.remove(it.finsiel.sbn.polo.dao.common.viste.Vf_musica_luoCommonDao.XXXstringaClet);

 ...
 */
public class CancellaTermineThesauro extends CancellaFactoring{
	private String 			_idCancellazione;
	private Tb_termine_thesauro		termineDaCancellare;
	private String				_codiceUtente;
	private TimestampHash		_timeHash = new TimestampHash();

	public CancellaTermineThesauro(SBNMarc input_root_object) {
    ...
    private void executeCancella() throws IllegalArgumentException, InvocationTargetException, Exception {
		...
		termineDaCancellare = termineValida.validaPerCancella(user,_idCancellazione);
        if (termineDaCancellare == null) {
        ...
        termineThesauro.cancellaTermine_thesauro(termineDaCancellare,_codiceUtente);

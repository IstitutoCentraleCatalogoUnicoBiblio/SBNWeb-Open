...
/**
 * Classe FondeTitoloUniforme
 *
 * Gestisce la fusione o lo spostamento legame tra due titoli uniformi
 *
 * Riceve in input la richiesta di fusione
 *
 * Valida la richiesta:
 * . i due titoli idPartenza e idArrivo devono esistere in tb_titolo,  devono
 * avere natura A e tipo materiale a spazio, altrimenti si segnala diagnostico ' i
 * bid indicati non si riferiescono a titoli uniformi'.
 *
 ...
 */
public class FondeTitoloUniforme extends FondeElementoAutFoctoring {
    public FondeTitoloUniforme(SBNMarc input_root_object) {
    ...
    public String getIdAttivitaSt(){
        return CodiciAttivita.getIstance().FONDE_TITOLO_UNIFORME_1268;
    }

 ...
 * @version 30-mag-03
 */
public class ElencoForme implements Elenco {
    ...
    */
    ...
    private static final ElencoForme instance = new ElencoForme();
    static Category log = Category.getInstance("iccu.box.ElencoForme");
    ...
    */
    public void init() throws Exception {
    	...
    	try {
			log.debug("Initializing ElencoForme");
			StopList stoplist = new StopList();
			elenco = new TreeSet<String>();
			List<Ts_stop_list> v = stoplist.leggiParoleF();
			Ts_stop_list sl;
	...
	public static ElencoForme getInstance() {
		return instance;
	}

...
import it.finsiel.sbn.polo.dao.entity.viste.Ve_cartografia_aut_autResult;
...
import it.finsiel.sbn.polo.dao.entity.viste.Vl_cartografia_autResult;
 ...
 * @version 22-mag-03
 */
public class CartografiaAutCerca extends TitoloCartografia {
    /**
	 * 
	 */
	private static final long serialVersionUID = 6893846342749086846L;
	private static Category log = Category.getInstance("it.finsiel.sbn.polo.oggetti.cercatitolo.CartografiaAutCerca");
    private String ord;
    ...
    protected TableDao cercaTitoloPerAutore() throws IllegalArgumentException, InvocationTargetException, Exception {
        if (cercaTitolo.getCercaDatiTit() == null
            ...
            Vl_cartografia_aut tit = new Vl_cartografia_aut();
            Vl_cartografia_autResult tavola = new Vl_cartografia_autResult(tit);
            ...
            Ve_cartografia_aut_aut tit = new Ve_cartografia_aut_aut();
            Ve_cartografia_aut_autResult tavola = new Ve_cartografia_aut_autResult(tit);
            tit.setVID(cercaTitolo.getArrivoLegame().getLegameElementoAut().getIdArrivo());
            valorizzaFiltri(tit, cercaTitolo.getCercaDatiTit());

...
import it.finsiel.sbn.polo.dao.entity.viste.Ve_cartografia_aut_luoResult;
import it.finsiel.sbn.polo.dao.entity.viste.Ve_cartografia_cla_luoResult;
import it.finsiel.sbn.polo.dao.entity.viste.Ve_cartografia_mar_luoResult;
import it.finsiel.sbn.polo.dao.entity.viste.Ve_cartografia_sog_autResult;
import it.finsiel.sbn.polo.dao.entity.viste.Ve_cartografia_the_autResult;
import it.finsiel.sbn.polo.dao.entity.viste.Ve_cartografia_tit_c_luoResult;
import it.finsiel.sbn.polo.dao.entity.viste.Vf_cartografia_luoResult;
import it.finsiel.sbn.polo.dao.entity.viste.Vl_cartografia_luoResult;
import it.finsiel.sbn.polo.exception.EccezioneSbnDiagnostico;
import it.finsiel.sbn.polo.factoring.transactionmaker.CercaTitolo;
import it.finsiel.sbn.polo.orm.Tb_titolo;
import it.finsiel.sbn.polo.orm.viste.Ve_cartografia_aut_luo;
import it.finsiel.sbn.polo.orm.viste.Ve_cartografia_cla_luo;
import it.finsiel.sbn.polo.orm.viste.Ve_cartografia_mar_luo;
import it.finsiel.sbn.polo.orm.viste.Ve_cartografia_sog_aut;
import it.finsiel.sbn.polo.orm.viste.Ve_cartografia_the_aut;
import it.finsiel.sbn.polo.orm.viste.Ve_cartografia_tit_c_luo;
import it.finsiel.sbn.polo.orm.viste.Vf_cartografia_luo;
import it.finsiel.sbn.polo.orm.viste.Vl_cartografia_luo;
 ...
 * @version 16-apr-03
 */
public class CartografiaLuoCerca extends TitoloCartografia {
    /**
	 * 
	 */
	private static final long serialVersionUID = -9125959908702896184L;
	private static Category log = Category.getInstance("it.finsiel.sbn.polo.oggetti.cercatitolo.CartografiaLuoCerca");
    private String ord;
    ...
    public CartografiaLuoCerca(CercaTitolo factoring, CercaTitoloType cercaTitolo, String ord) {
        super();
        this.ord = ord;
    ...
    protected TableDao cercaTitoloPerLuogo() throws IllegalArgumentException, InvocationTargetException, Exception {
            Vl_cartografia_luo tit = new Vl_cartografia_luo();
            Vl_cartografia_luoResult tavola = new Vl_cartografia_luoResult(tit);
    ...
    protected TableDao cercaTitoloPerThesauro() throws IllegalArgumentException, InvocationTargetException, Exception {
        Ve_cartografia_the_aut tit = new Ve_cartografia_the_aut();
        Ve_cartografia_the_autResult tavola = new Ve_cartografia_the_autResult(tit);
        valorizzaFiltri(tit, cercaTitolo.getCercaDatiTit());
    ...
    protected TableDao cercaTitoloPerClet(String clet) throws IllegalArgumentException, InvocationTargetException, Exception {
        Vf_cartografia_luo tit = new Vf_cartografia_luo();
        Vf_cartografia_luoResult tavola = new Vf_cartografia_luoResult(tit);
    ...
    /** Esegue la conta dei record che vengono trovati: ritorna una tavola
     * contenente un elenco di oggetti vista vl_cartografia_luo
     * @throws Exception
     * @throws InvocationTargetException
     * @throws IllegalArgumentException */
    protected TableDao cercaTitoloPerAutore() throws IllegalArgumentException, InvocationTargetException, Exception {
        Ve_cartografia_aut_luo tit = new Ve_cartografia_aut_luo();
        Ve_cartografia_aut_luoResult tavola = new Ve_cartografia_aut_luoResult(tit);
    ...
    protected TableDao cercaTitoloPerLegameTitolo(String bid) throws IllegalArgumentException, InvocationTargetException, Exception {
        Ve_cartografia_tit_c_luo tit = new Ve_cartografia_tit_c_luo();
        Ve_cartografia_tit_c_luoResult tavola = new Ve_cartografia_tit_c_luoResult(tit);
    ...
    protected TableDao cercaTitoloPerClasse() throws IllegalArgumentException, InvocationTargetException, Exception {
        Ve_cartografia_cla_luo tit = new Ve_cartografia_cla_luo();
        Ve_cartografia_cla_luoResult tavola = new Ve_cartografia_cla_luoResult(tit);
        valorizzaFiltri(tit, cercaTitolo.getCercaDatiTit());
    ...
    protected TableDao cercaTitoloPerMarca() throws IllegalArgumentException, InvocationTargetException, Exception {
        Ve_cartografia_mar_luo tit = new Ve_cartografia_mar_luo();
        Ve_cartografia_mar_luoResult tavola = new Ve_cartografia_mar_luoResult(tit);
        valorizzaFiltri(tit, cercaTitolo.getCercaDatiTit());

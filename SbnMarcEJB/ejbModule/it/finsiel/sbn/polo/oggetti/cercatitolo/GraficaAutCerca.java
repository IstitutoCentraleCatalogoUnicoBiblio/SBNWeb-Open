...
import it.finsiel.sbn.polo.dao.entity.viste.Ve_grafica_aut_autResult;
import it.finsiel.sbn.polo.dao.entity.viste.Ve_grafica_cla_autResult;
import it.finsiel.sbn.polo.dao.entity.viste.Ve_grafica_luo_autResult;
import it.finsiel.sbn.polo.dao.entity.viste.Ve_grafica_mar_autResult;
...
import it.finsiel.sbn.polo.dao.entity.viste.Ve_grafica_tit_c_autResult;
import it.finsiel.sbn.polo.dao.entity.viste.Vf_grafica_autResult;
import it.finsiel.sbn.polo.dao.entity.viste.Vl_grafica_autResult;
...
import it.finsiel.sbn.polo.orm.viste.Ve_grafica_aut_aut;
import it.finsiel.sbn.polo.orm.viste.Ve_grafica_cla_aut;
import it.finsiel.sbn.polo.orm.viste.Ve_grafica_luo_aut;
import it.finsiel.sbn.polo.orm.viste.Ve_grafica_mar_aut;
import it.finsiel.sbn.polo.orm.viste.Ve_grafica_sog_aut;
import it.finsiel.sbn.polo.orm.viste.Ve_grafica_the_aut;
import it.finsiel.sbn.polo.orm.viste.Ve_grafica_tit_c_aut;
import it.finsiel.sbn.polo.orm.viste.Vf_grafica_aut;
...
/**
 * Classe graficaAutCerca
 * <p>
 * Esegue quelle ricerche di titoli che valorizzano i filtri relativi ad un autore
 * Utilizza le viste di tipo VE , VL e VF.
 * Estende la classe TitoloGrafica, dalla quale eredita diversi metodi di utilità e la possibilità
 * di valorizzare i filtri sul titolo grafico cercato.
 * </p>
 * @author
 * @author
 *
 * @version 11-mag-03
 */
public class GraficaAutCerca extends TitoloGrafica {
    /**
	 * 
	 */
	private static final long serialVersionUID = 6229401755205686566L;
    ...
    public GraficaAutCerca(CercaTitolo factoring, CercaTitoloType cercaTitolo, String ord) {
        super();
        this.ord = ord;
    ...
    protected TableDao cercaTitoloPerAutore() throws IllegalArgumentException, InvocationTargetException, Exception {
        if (cercaTitolo.getCercaDatiTit() == null
            ...
            Vl_grafica_aut tit = new Vl_grafica_aut();
            Vl_grafica_autResult tavola = new Vl_grafica_autResult(tit);
            ...
            Ve_grafica_aut_aut tit = new Ve_grafica_aut_aut();
            Ve_grafica_aut_autResult tavola = new Ve_grafica_aut_autResult(tit);
            tit.setVID(cercaTitolo.getArrivoLegame().getLegameElementoAut().getIdArrivo());
            valorizzaFiltri(tit, cercaTitolo.getCercaDatiTit());
    ...
    protected TableDao cercaTitoloPerClet(String clet) throws IllegalArgumentException, InvocationTargetException, Exception {
        Vf_grafica_aut tit = new Vf_grafica_aut();
        Vf_grafica_autResult tavola = new Vf_grafica_autResult(tit);
    ...
    protected TableDao cercaTitoloPerLuogo() throws IllegalArgumentException, InvocationTargetException, Exception {
        Ve_grafica_luo_aut tit = new Ve_grafica_luo_aut();
        Ve_grafica_luo_autResult tavola = new Ve_grafica_luo_autResult(tit);
    ...
    protected TableDao cercaTitoloPerLegameTitolo(String bid) throws IllegalArgumentException, InvocationTargetException, Exception {
        Ve_grafica_tit_c_aut tit = new Ve_grafica_tit_c_aut();
        Ve_grafica_tit_c_autResult tavola = new Ve_grafica_tit_c_autResult(tit);
    ...
    protected TableDao cercaTitoloPerClasse() throws IllegalArgumentException, InvocationTargetException, Exception {
        Ve_grafica_cla_aut tit = new Ve_grafica_cla_aut();
        Ve_grafica_cla_autResult tavola = new Ve_grafica_cla_autResult(tit);
        valorizzaFiltri(tit, cercaTitolo.getCercaDatiTit());
    ...
    protected TableDao cercaTitoloPerMarca() throws IllegalArgumentException, InvocationTargetException, Exception {
        Ve_grafica_mar_aut tit = new Ve_grafica_mar_aut();
        Ve_grafica_mar_autResult tavola = new Ve_grafica_mar_autResult(tit);
        valorizzaFiltri(tit, cercaTitolo.getCercaDatiTit());
    ...
    protected void valorizzaFiltri(Vf_grafica_aut autore, CercaDatiTitType cerca)
    ...
    protected void valorizzaFiltri(Ve_grafica_aut_aut autore, CercaDatiTitType cerca)
        throws EccezioneSbnDiagnostico {
        super.valorizzaFiltri(autore, cerca);
        ElementoAutLegatoType elAut = cerca.getElementoAutLegato();
        if (elAut != null) {
    ...
    protected void valorizzaFiltri(Ve_grafica_luo_aut autore, CercaDatiTitType cerca)
        throws EccezioneSbnDiagnostico {
        super.valorizzaFiltri(autore, cerca);
        ElementoAutLegatoType elAut = cerca.getElementoAutLegato();
        if (elAut != null) {
    ...
    protected void valorizzaFiltri(Ve_grafica_mar_aut autore, CercaDatiTitType cerca)
        throws EccezioneSbnDiagnostico {
        super.valorizzaFiltri(autore, cerca);
        ElementoAutLegatoType elAut = cerca.getElementoAutLegato();
        if (elAut != null) {
    ...
    protected void valorizzaFiltri(Ve_grafica_cla_aut autore, CercaDatiTitType cerca)
        throws EccezioneSbnDiagnostico {
        super.valorizzaFiltri(autore, cerca);
        ElementoAutLegatoType elAut = cerca.getElementoAutLegato();
        if (elAut != null) {
    ...
    protected void valorizzaFiltri(Ve_grafica_tit_c_aut autore, CercaDatiTitType cerca)
        throws EccezioneSbnDiagnostico {
        super.valorizzaFiltri(autore, cerca);
        ElementoAutLegatoType elAut = cerca.getElementoAutLegato();
        if (elAut != null) {

...
import it.finsiel.sbn.polo.dao.entity.viste.Ve_musica_aut_autResult;
import it.finsiel.sbn.polo.dao.entity.viste.Ve_musica_cla_autResult;
import it.finsiel.sbn.polo.dao.entity.viste.Ve_musica_luo_autResult;
import it.finsiel.sbn.polo.dao.entity.viste.Ve_musica_mar_autResult;
import it.finsiel.sbn.polo.dao.entity.viste.Ve_musica_tit_c_autResult;
import it.finsiel.sbn.polo.dao.entity.viste.Vf_musica_autResult;
import it.finsiel.sbn.polo.dao.entity.viste.Vl_musica_autResult;
...
import it.finsiel.sbn.polo.orm.viste.Ve_musica_cla_aut;
import it.finsiel.sbn.polo.orm.viste.Ve_musica_luo_aut;
import it.finsiel.sbn.polo.orm.viste.Ve_musica_mar_aut;
import it.finsiel.sbn.polo.orm.viste.Ve_musica_tit_c_aut;
import it.finsiel.sbn.polo.orm.viste.Vf_musica_aut;
import it.finsiel.sbn.polo.orm.viste.Vl_musica_aut;
...
/**
 * Classe MusicaAutCerca
 * <p>
 * Esegue quelle ricerche di titoli che valorizzano i filtri relativi ad un autore
 * Utilizza le viste di tipo VE , VL e VF.
 * Estende la classe TitoloMusica, dalla quale eredita diversi metodi di utilità e la possibilità
 * di valorizzare i filtri sul titolo musicale cercato.
 * </p>
 * @author
 * @author
 *
 * @version 11-apr-03
 */
public class MusicaAutCerca extends TitoloMusica {
    /**
	 * 
	 */
	private static final long serialVersionUID = 3085148357682270913L;
    ...
    public MusicaAutCerca(CercaTitolo factoring,CercaTitoloType cercaTitolo, String ord) {
        super();
        this.ord = ord;
    ...
    protected TableDao cercaTitoloPerAutore() throws IllegalArgumentException, InvocationTargetException, Exception {
        if (cercaTitolo.getCercaDatiTit() == null
            ...
            Vl_musica_aut tit = new Vl_musica_aut();
            Vl_musica_autResult tavola = new Vl_musica_autResult(tit);
            ...
            Ve_musica_aut_aut tit = new Ve_musica_aut_aut();
            Ve_musica_aut_autResult tavola = new Ve_musica_aut_autResult(tit);
            tit.setVID(cercaTitolo.getArrivoLegame().getLegameElementoAut().getIdArrivo());
            valorizzaFiltri(tit, cercaTitolo.getCercaDatiTit());
    ...
    protected TableDao cercaTitoloPerClet(String clet) throws IllegalArgumentException, InvocationTargetException, Exception {
        Vf_musica_aut tit = new Vf_musica_aut();
        Vf_musica_autResult tavola = new Vf_musica_autResult(tit);
    ...
    protected TableDao cercaTitoloPerLuogo() throws IllegalArgumentException, InvocationTargetException, Exception {
        Ve_musica_luo_aut tit = new Ve_musica_luo_aut();
        Ve_musica_luo_autResult tavola = new Ve_musica_luo_autResult(tit);
    ...
    protected TableDao cercaTitoloPerLegameTitolo(String bid) throws IllegalArgumentException, InvocationTargetException, Exception {
        Ve_musica_tit_c_aut tit = new Ve_musica_tit_c_aut();
        Ve_musica_tit_c_autResult tavola = new Ve_musica_tit_c_autResult(tit);
    ...
    protected TableDao cercaTitoloPerClasse() throws IllegalArgumentException, InvocationTargetException, Exception {
        Ve_musica_cla_aut tit = new Ve_musica_cla_aut();
        Ve_musica_cla_autResult tavola = new Ve_musica_cla_autResult(tit);
        valorizzaFiltri(tit, cercaTitolo.getCercaDatiTit());
    ...
    protected TableDao cercaTitoloPerMarca() throws IllegalArgumentException, InvocationTargetException, Exception {
        Ve_musica_mar_aut tit = new Ve_musica_mar_aut();
        Ve_musica_mar_autResult tavola = new Ve_musica_mar_autResult(tit);
        valorizzaFiltri(tit, cercaTitolo.getCercaDatiTit());
    ...
    protected void valorizzaFiltri(Vf_musica_aut autore, CercaDatiTitType cerca)
        throws EccezioneSbnDiagnostico {
    ...
    protected void valorizzaFiltri(Ve_musica_aut_aut autore, CercaDatiTitType cerca)
        throws EccezioneSbnDiagnostico {
        super.valorizzaFiltri(autore, cerca);
        ElementoAutLegatoType elAut = cerca.getElementoAutLegato();
        if (elAut != null) {
    ...
    protected void valorizzaFiltri(Ve_musica_luo_aut autore, CercaDatiTitType cerca)
        throws EccezioneSbnDiagnostico {
        super.valorizzaFiltri(autore, cerca);
        ElementoAutLegatoType elAut = cerca.getElementoAutLegato();
        if (elAut != null) {
    ...
    protected void valorizzaFiltri(Ve_musica_mar_aut autore, CercaDatiTitType cerca)
        throws EccezioneSbnDiagnostico {
        super.valorizzaFiltri(autore, cerca);
        ElementoAutLegatoType elAut = cerca.getElementoAutLegato();
        if (elAut != null) {
    ...
    protected void valorizzaFiltri(Ve_musica_cla_aut autore, CercaDatiTitType cerca)
        throws EccezioneSbnDiagnostico {
        super.valorizzaFiltri(autore, cerca);
        ElementoAutLegatoType elAut = cerca.getElementoAutLegato();
        if (elAut != null) {
    ...
    protected void valorizzaFiltri(Ve_musica_tit_c_aut autore, CercaDatiTitType cerca)
        throws EccezioneSbnDiagnostico {
        super.valorizzaFiltri(autore, cerca);
        ElementoAutLegatoType elAut = cerca.getElementoAutLegato();
        if (elAut != null) {

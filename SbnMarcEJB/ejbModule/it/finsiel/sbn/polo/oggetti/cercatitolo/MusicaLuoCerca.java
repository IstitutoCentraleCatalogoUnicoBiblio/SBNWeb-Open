...
import it.finsiel.sbn.polo.dao.entity.viste.Ve_musica_aut_luoResult;
import it.finsiel.sbn.polo.dao.entity.viste.Ve_musica_cla_luoResult;
import it.finsiel.sbn.polo.dao.entity.viste.Ve_musica_mar_luoResult;
import it.finsiel.sbn.polo.dao.entity.viste.Ve_musica_tit_c_luoResult;
 ...
 * @version 16-apr-03
 */
public class MusicaLuoCerca extends TitoloMusica {

	private static final long serialVersionUID = 4986038340244969412L;
	...
	public MusicaLuoCerca(CercaTitolo factoring, CercaTitoloType cercaTitolo, String ord) {
		super();
		this.ord = ord;
	...
	protected TableDao cercaTitoloPerAutore() throws IllegalArgumentException, InvocationTargetException, Exception {
		Ve_musica_aut_luo tit = new Ve_musica_aut_luo();
		Ve_musica_aut_luoResult tavola = new Ve_musica_aut_luoResult(tit);
	...
	protected TableDao cercaTitoloPerLegameTitolo(String bid) throws IllegalArgumentException, InvocationTargetException, Exception {
		Ve_musica_tit_c_luo tit = new Ve_musica_tit_c_luo();
		Ve_musica_tit_c_luoResult tavola = new Ve_musica_tit_c_luoResult(tit);
	...
	protected TableDao cercaTitoloPerClasse() throws IllegalArgumentException, InvocationTargetException, Exception {
		Ve_musica_cla_luo tit = new Ve_musica_cla_luo();
		Ve_musica_cla_luoResult tavola = new Ve_musica_cla_luoResult(tit);
		valorizzaFiltri(tit, cercaTitolo.getCercaDatiTit());
	...
	protected TableDao cercaTitoloPerMarca() throws IllegalArgumentException, InvocationTargetException, Exception {
		Ve_musica_mar_luo tit = new Ve_musica_mar_luo();
		Ve_musica_mar_luoResult tavola = new Ve_musica_mar_luoResult(tit);
		valorizzaFiltri(tit, cercaTitolo.getCercaDatiTit());

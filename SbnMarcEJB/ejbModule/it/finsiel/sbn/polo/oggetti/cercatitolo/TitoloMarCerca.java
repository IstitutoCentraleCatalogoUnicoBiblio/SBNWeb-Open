...
import it.finsiel.sbn.polo.dao.entity.viste.Ve_titolo_aut_marResult;
import it.finsiel.sbn.polo.dao.entity.viste.Ve_titolo_cla_marResult;
import it.finsiel.sbn.polo.dao.entity.viste.Ve_titolo_luo_marResult;
import it.finsiel.sbn.polo.dao.entity.viste.Ve_titolo_sog_marResult;
import it.finsiel.sbn.polo.dao.entity.viste.Ve_titolo_the_marResult;
import it.finsiel.sbn.polo.dao.entity.viste.Ve_titolo_tit_c_marResult;
import it.finsiel.sbn.polo.dao.entity.viste.Vf_titolo_marResult;
...
import it.finsiel.sbn.polo.orm.viste.Ve_titolo_aut_mar;
import it.finsiel.sbn.polo.orm.viste.Ve_titolo_cla_mar;
import it.finsiel.sbn.polo.orm.viste.Ve_titolo_luo_mar;
import it.finsiel.sbn.polo.orm.viste.Ve_titolo_sog_mar;
import it.finsiel.sbn.polo.orm.viste.Ve_titolo_the_mar;
 ...
 * @version 16-apr-03
 */
public class TitoloMarCerca extends Titolo {

	private static final long serialVersionUID = -1627125927282720815L;
	...
	public TitoloMarCerca(CercaTitolo factoring, CercaTitoloType cercaTitolo, String ord) {
		super();
		this.ord = ord;
	...
	public TableDao cercaTitolo() throws IllegalArgumentException, InvocationTargetException, Exception {
		if (cercaTitolo.getArrivoLegame() != null) {
			...
			return cercaTitoloConFiltriMarca();
		}
		return null;
	}
	...
	protected TableDao cercaTitoloPerMarca() throws IllegalArgumentException, InvocationTargetException, Exception {
			Vl_titolo_mar tit = new Vl_titolo_mar();

			Vl_titolo_marResult tavola = new Vl_titolo_marResult(tit);
	 ...
	 * @throws IllegalArgumentException
	 * */
	protected TableDao cercaTitoloConFiltriMarca() throws IllegalArgumentException, InvocationTargetException, Exception {
	...
	protected TableDao cercaTitoloPerClet(String clet) throws IllegalArgumentException, InvocationTargetException, Exception {
		Vf_titolo_mar tit = new Vf_titolo_mar();
		Vf_titolo_marResult tavola = new Vf_titolo_marResult(tit);
	...
	protected TableDao cercaTitoloPerAutore() throws IllegalArgumentException, InvocationTargetException, Exception {
		Ve_titolo_aut_mar tit = new Ve_titolo_aut_mar();
		Ve_titolo_aut_marResult tavola = new Ve_titolo_aut_marResult(tit);
	...
	protected TableDao cercaTitoloPerLegameTitolo() throws IllegalArgumentException, InvocationTargetException, Exception {
		Ve_titolo_tit_c_mar tit = new Ve_titolo_tit_c_mar();
		Ve_titolo_tit_c_marResult tavola = new Ve_titolo_tit_c_marResult(tit);
	...
	/** Esegue la conta dei record che vengono trovati: ritorna una tavola
	 * contenente un elenco di oggetti vista vl_titolo_mar
	 * @throws Exception
	 * @throws InvocationTargetException
	 * @throws IllegalArgumentException */
	protected TableDao cercaTitoloPerClasse() throws IllegalArgumentException, InvocationTargetException, Exception {
		Ve_titolo_cla_mar tit = new Ve_titolo_cla_mar();
		Ve_titolo_cla_marResult tavola = new Ve_titolo_cla_marResult(tit);
		valorizzaFiltri(tit, cercaTitolo.getCercaDatiTit());
	...
	protected TableDao cercaTitoloPerSoggetto() throws IllegalArgumentException, InvocationTargetException, Exception {
		Ve_titolo_sog_mar tit = new Ve_titolo_sog_mar();
		Ve_titolo_sog_marResult tavola = new Ve_titolo_sog_marResult(tit);
		valorizzaFiltri(tit, cercaTitolo.getCercaDatiTit());
	...
	protected TableDao cercaTitoloPerThesauro() throws IllegalArgumentException, InvocationTargetException, Exception {
		Ve_titolo_the_mar tit = new Ve_titolo_the_mar();
		Ve_titolo_the_marResult tavola = new Ve_titolo_the_marResult(tit);
		valorizzaFiltri(tit, cercaTitolo.getCercaDatiTit());
	...
	protected TableDao cercaTitoloPerLuogo() throws IllegalArgumentException, InvocationTargetException, Exception {
		Ve_titolo_luo_mar tit = new Ve_titolo_luo_mar();
		Ve_titolo_luo_marResult tavola = new Ve_titolo_luo_marResult(tit);
		valorizzaFiltri(tit, cercaTitolo.getCercaDatiTit());
		tit.setMID(cercaTitolo.getArrivoLegame().getLegameElementoAut().getIdArrivo());
    ...
    protected void estraeParoleDaStringa(OggettoServerSbnMarc tavola, String stringa) {
        ...
        while (st.hasMoreTokens() && n<5) {
            ...
            if (!ElencoParole.getInstance().contiene(parola)) {
                n++;
                tavola.settaParametro("XXXparola"+n,parola);
            }

        }
    }

	protected void valorizzaFiltri(Vf_titolo_mar marca, CercaDatiTitType cerca)
		throws EccezioneSbnDiagnostico {
		super.valorizzaFiltri(marca, cerca);
		...
		if (elAut != null) {
			...
			if (canali != null) {
				...
				if (stringaCerca != null) {
					if (stringaCerca.getStringaCercaTypeChoice().getStringaEsatta() != null)
						marca.settaParametro(TableDao.XXXStringaEsattaMarca, stringaCerca.getStringaCercaTypeChoice().getStringaEsatta());
					if (stringaCerca.getStringaCercaTypeChoice().getStringaLike() != null) {
						estraeParoleDaStringa(marca, stringaCerca.getStringaCercaTypeChoice().getStringaLike());
                    }
				}
			}
		}
	...
	protected void valorizzaFiltri(Ve_titolo_aut_mar marca, CercaDatiTitType cerca)
		throws EccezioneSbnDiagnostico {
		super.valorizzaFiltri(marca, cerca);
		ElementoAutLegatoType elAut = cerca.getElementoAutLegato();
		if (elAut != null) {
	...
	protected void valorizzaFiltri(Ve_titolo_luo_mar marca, CercaDatiTitType cerca)
		throws EccezioneSbnDiagnostico {
		super.valorizzaFiltri(marca, cerca);
		ElementoAutLegatoType elAut = cerca.getElementoAutLegato();
		if (elAut != null) {
	...
	protected void valorizzaFiltri(Ve_titolo_sog_mar marca, CercaDatiTitType cerca)
		throws EccezioneSbnDiagnostico {
		super.valorizzaFiltri(marca, cerca);
		ElementoAutLegatoType elAut = cerca.getElementoAutLegato();
		if (elAut != null) {

 ...
 */
public class Ts_legami_001 extends OggettoServerSbnMarc implements Serializable {

	private static final long serialVersionUID = -6474097477620877194L;

	public boolean equals(Object aObj) {
		if (aObj == null)
			return false;
		if (!(aObj instanceof Ts_legami_001))
			return false;
		Ts_legami_001 ts_legami_001 = (Ts_legami_001)aObj;
		if (getID_TAG_MARC() != ts_legami_001.getID_TAG_MARC())
			return false;
		if (getBID_LEG_MARC() != null && !getBID_LEG_MARC().equals(ts_legami_001.getBID_LEG_MARC()))
			return false;
		if (getID_TITOLO_MARC() != ts_legami_001.getID_TITOLO_MARC())
			return false;
		return true;
	}
	...
	public int hashCode() {
		...
		hashcode = hashcode + getBID_LEG_MARC().hashCode();
 ...
 public String getBID_LEG_MARC() {
	...
	public String toString() {
		return String.valueOf(getID_TAG_MARC() + " " + getBID_LEG_MARC() + " " + getID_TITOLO_MARC());
	}

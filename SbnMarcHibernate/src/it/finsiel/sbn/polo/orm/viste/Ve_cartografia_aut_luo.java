 ...
 */
public class Ve_cartografia_aut_luo extends V_cartografia {

	private static final long serialVersionUID = 8382856549225321922L;

	public boolean equals(Object aObj) {
		if (aObj == null)
			return false;
		if (!(aObj instanceof Ve_cartografia_aut_luo))
			return false;
		Ve_cartografia_aut_luo ve_cartografia_aut_luo = (Ve_cartografia_aut_luo)aObj;
		if (getVID() != null && !getVID().equals(ve_cartografia_aut_luo.getVID()))
			return false;
		if (getTP_RESPONSABILITA() != ve_cartografia_aut_luo.getTP_RESPONSABILITA())
			return false;
		if (getCD_RELAZIONE() != null && !getCD_RELAZIONE().equals(ve_cartografia_aut_luo.getCD_RELAZIONE()))
			return false;
		if (getBID() != null && !getBID().equals(ve_cartografia_aut_luo.getBID()))
			return false;
		if (getLID() != null && !getLID().equals(ve_cartografia_aut_luo.getLID()))
			return false;
		return true;
	}

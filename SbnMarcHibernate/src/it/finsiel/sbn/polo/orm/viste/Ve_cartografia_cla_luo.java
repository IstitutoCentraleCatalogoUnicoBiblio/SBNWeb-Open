 ...
 */
public class Ve_cartografia_cla_luo extends V_cartografia {

	private static final long serialVersionUID = -6288620927701086024L;

	public boolean equals(Object aObj) {
		if (aObj == null)
			return false;
		if (!(aObj instanceof Ve_cartografia_cla_luo))
			return false;
		Ve_cartografia_cla_luo ve_cartografia_cla_luo = (Ve_cartografia_cla_luo)aObj;
		if (getCD_SISTEMA() != ve_cartografia_cla_luo.getCD_SISTEMA())
			return false;
		if (getCD_EDIZIONE() != ve_cartografia_cla_luo.getCD_EDIZIONE())
			return false;
		if (getCLASSE() != null && !getCLASSE().equals(ve_cartografia_cla_luo.getCLASSE()))
			return false;
		if (getBID() != null && !getBID().equals(ve_cartografia_cla_luo.getBID()))
			return false;
		if (getLID() != null && !getLID().equals(ve_cartografia_cla_luo.getLID()))
			return false;
		return true;
	}

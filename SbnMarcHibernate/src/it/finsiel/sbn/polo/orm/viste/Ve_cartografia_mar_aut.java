 ...
 */
public class Ve_cartografia_mar_aut  extends V_cartografia {

	private static final long serialVersionUID = 1295167872411700870L;

	public boolean equals(Object aObj) {
		if (aObj == null)
			return false;
		if (!(aObj instanceof Ve_cartografia_mar_aut))
			return false;
		Ve_cartografia_mar_aut ve_cartografia_mar_aut = (Ve_cartografia_mar_aut)aObj;
		if (getMID() != null && !getMID().equals(ve_cartografia_mar_aut.getMID()))
			return false;
		if (getBID() != null && !getBID().equals(ve_cartografia_mar_aut.getBID()))
			return false;
		if (getTP_RESPONSABILITA() != ve_cartografia_mar_aut.getTP_RESPONSABILITA())
			return false;
		if (getCD_RELAZIONE() != null && !getCD_RELAZIONE().equals(ve_cartografia_mar_aut.getCD_RELAZIONE()))
			return false;
		if (getVID() != null && !getVID().equals(ve_cartografia_mar_aut.getVID()))
			return false;
		return true;
	}

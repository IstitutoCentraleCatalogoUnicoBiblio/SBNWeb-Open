 ...
 */
public class Ve_cartografia_mar_luo  extends V_cartografia implements Serializable {

	private static final long serialVersionUID = -1338393215433064101L;

	public boolean equals(Object aObj) {
		if (aObj == null)
			return false;
		if (!(aObj instanceof Ve_cartografia_mar_luo))
			return false;
		Ve_cartografia_mar_luo ve_cartografia_mar_luo = (Ve_cartografia_mar_luo)aObj;
		if (getMID() != null && !getMID().equals(ve_cartografia_mar_luo.getMID()))
			return false;
		if (getBID() != null && !getBID().equals(ve_cartografia_mar_luo.getBID()))
			return false;
		if (getLID() != null && !getLID().equals(ve_cartografia_mar_luo.getLID()))
			return false;
		return true;
	}

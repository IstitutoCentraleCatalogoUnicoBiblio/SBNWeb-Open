 ...
 */
public class Ve_cartografia_sog_luo extends V_cartografia {

	private static final long serialVersionUID = 3814506435163852598L;

	public boolean equals(Object aObj) {
		if (aObj == null)
			return false;
		if (!(aObj instanceof Ve_cartografia_sog_luo))
			return false;
		Ve_cartografia_sog_luo ve_cartografia_sog_luo = (Ve_cartografia_sog_luo)aObj;
		if (getCID() != null && !getCID().equals(ve_cartografia_sog_luo.getCID()))
			return false;
		if (getBID() != null && !getBID().equals(ve_cartografia_sog_luo.getBID()))
			return false;
		if (getLID() != null && !getLID().equals(ve_cartografia_sog_luo.getLID()))
			return false;
		return true;
	}

 ...
 */
public class Ve_cartografia_the_luo extends V_cartografia {

	private static final long serialVersionUID = -8970253796173899717L;

	public boolean equals(Object aObj) {
		if (aObj == null)
			return false;
		if (!(aObj instanceof Ve_cartografia_the_luo))
			return false;
		Ve_cartografia_the_luo ve_cartografia_the_luo = (Ve_cartografia_the_luo)aObj;
		if (getDID() != null && !getDID().equals(ve_cartografia_the_luo.getDID()))
			return false;
		if (getBID() != null && !getBID().equals(ve_cartografia_the_luo.getBID()))
			return false;
		if (getLID() != null && !getLID().equals(ve_cartografia_the_luo.getLID()))
			return false;
		return true;
	}

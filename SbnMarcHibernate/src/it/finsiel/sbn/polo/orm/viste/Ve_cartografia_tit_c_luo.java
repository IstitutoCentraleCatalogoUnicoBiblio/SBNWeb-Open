 ...
 */
public class Ve_cartografia_tit_c_luo extends V_cartografia {

	private static final long serialVersionUID = -6126900640340556826L;

	public boolean equals(Object aObj) {
		if (aObj == null)
			return false;
		if (!(aObj instanceof Ve_cartografia_tit_c_luo))
			return false;
		Ve_cartografia_tit_c_luo ve_cartografia_tit_c_luo = (Ve_cartografia_tit_c_luo)aObj;
		if (getBID_COLL() != null && !getBID_COLL().equals(ve_cartografia_tit_c_luo.getBID_COLL()))
			return false;
		if (getTP_LEGAME() != null && !getTP_LEGAME().equals(ve_cartografia_tit_c_luo.getTP_LEGAME()))
			return false;
		if (getBID() != null && !getBID().equals(ve_cartografia_tit_c_luo.getBID()))
			return false;
		if (getLID() != null && !getLID().equals(ve_cartografia_tit_c_luo.getLID()))
			return false;
		return true;
	}

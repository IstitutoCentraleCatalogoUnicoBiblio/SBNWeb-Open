 ...
 */
public class Ve_grafica_sog_luo extends Tb_titolo implements Serializable {

	private static final long serialVersionUID = 1554197476049628734L;

	public boolean equals(Object aObj) {
		if (aObj == null)
			return false;
		if (!(aObj instanceof Ve_grafica_sog_luo))
			return false;
		Ve_grafica_sog_luo ve_grafica_sog_luo = (Ve_grafica_sog_luo)aObj;
		if (getCID() != null && !getCID().equals(ve_grafica_sog_luo.getCID()))
			return false;
		if (getBID() != null && !getBID().equals(ve_grafica_sog_luo.getBID()))
			return false;
		if (getLID() != null && !getLID().equals(ve_grafica_sog_luo.getLID()))
			return false;
		return true;
	}

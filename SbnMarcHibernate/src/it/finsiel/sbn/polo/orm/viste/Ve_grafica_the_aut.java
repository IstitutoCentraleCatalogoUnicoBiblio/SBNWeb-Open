 ...
 */
public class Ve_grafica_the_aut extends Tb_titolo implements Serializable {

	private static final long serialVersionUID = -3269562542372442477L;

	public boolean equals(Object aObj) {
		if (aObj == null)
			return false;
		if (!(aObj instanceof Ve_grafica_the_aut))
			return false;
		Ve_grafica_the_aut ve_grafica_the_aut = (Ve_grafica_the_aut)aObj;
		if (getDID() != null && !getDID().equals(ve_grafica_the_aut.getDID()))
			return false;
		if (getBID() != null && !getBID().equals(ve_grafica_the_aut.getBID()))
			return false;
		if (getTP_RESPONSABILITA() != ve_grafica_the_aut.getTP_RESPONSABILITA())
			return false;
		if (getCD_RELAZIONE() != null && !getCD_RELAZIONE().equals(ve_grafica_the_aut.getCD_RELAZIONE()))
			return false;
		if (getVID() != null && !getVID().equals(ve_grafica_the_aut.getVID()))
			return false;
		return true;
	}

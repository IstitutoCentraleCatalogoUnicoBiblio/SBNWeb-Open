 ...
 */
public class Ve_grafica_the_luo extends Tb_titolo implements Serializable {

	private static final long serialVersionUID = 3210782120346044861L;

	public boolean equals(Object aObj) {
		if (aObj == null)
			return false;
		if (!(aObj instanceof Ve_grafica_the_luo))
			return false;
		Ve_grafica_the_luo ve_grafica_the_luo = (Ve_grafica_the_luo)aObj;
		if (getDID() != null && !getDID().equals(ve_grafica_the_luo.getDID()))
			return false;
		if (getBID() != null && !getBID().equals(ve_grafica_the_luo.getBID()))
			return false;
		if (getLID() != null && !getLID().equals(ve_grafica_the_luo.getLID()))
			return false;
		return true;
	}

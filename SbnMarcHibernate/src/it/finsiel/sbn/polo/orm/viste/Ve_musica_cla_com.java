 ...
 */
public class Ve_musica_cla_com extends Tb_titolo implements Serializable {

	private static final long serialVersionUID = 8163480448971432443L;

	public boolean equals(Object aObj) {
		if (aObj == null)
			return false;
		if (!(aObj instanceof Ve_musica_cla_com))
			return false;
		Ve_musica_cla_com ve_musica_cla_com = (Ve_musica_cla_com)aObj;
		if (getCD_SISTEMA() != ve_musica_cla_com.getCD_SISTEMA())
			return false;
		if (getCD_EDIZIONE() != ve_musica_cla_com.getCD_EDIZIONE())
			return false;
		if (getCLASSE() != null && !getCLASSE().equals(ve_musica_cla_com.getCLASSE()))
			return false;
		if (getBID() != null && !getBID().equals(ve_musica_cla_com.getBID()))
			return false;
		if (getBID_CM() != null && !getBID_CM().equals(ve_musica_cla_com.getBID_CM()))
			return false;
		return true;
	}
 ...
 public String getKY_APP_RIC() {
	...
	public String toString() {
		return String.valueOf(getCD_SISTEMA() + " " + getCD_EDIZIONE() + " " + getCLASSE() + " " + getBID() + " " + getBID_CM());
	}

 ...
 */
public class Ve_musica_mar_luo extends Tb_titolo implements Serializable {

	private static final long serialVersionUID = -600647484264098640L;

	public boolean equals(Object aObj) {
		if (aObj == null)
			return false;
		if (!(aObj instanceof Ve_musica_mar_luo))
			return false;
		Ve_musica_mar_luo ve_musica_mar_luo = (Ve_musica_mar_luo)aObj;
		if (getMID() != null && !getMID().equals(ve_musica_mar_luo.getMID()))
			return false;
		if (getBID() != null && !getBID().equals(ve_musica_mar_luo.getBID()))
			return false;
		if (getLID() != null && !getLID().equals(ve_musica_mar_luo.getLID()))
			return false;
		return true;
	}

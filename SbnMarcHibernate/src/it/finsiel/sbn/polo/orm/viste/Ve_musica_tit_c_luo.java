 ...
 */
public class Ve_musica_tit_c_luo extends Tb_titolo implements Serializable {

	private static final long serialVersionUID = -4053162433058115925L;

	public boolean equals(Object aObj) {
		if (aObj == null)
			return false;
		if (!(aObj instanceof Ve_musica_tit_c_luo))
			return false;
		Ve_musica_tit_c_luo ve_musica_tit_c_luo = (Ve_musica_tit_c_luo)aObj;
		if (getBID_COLL() != null && !getBID_COLL().equals(ve_musica_tit_c_luo.getBID_COLL()))
			return false;
		if (getTP_LEGAME() != null && !getTP_LEGAME().equals(ve_musica_tit_c_luo.getTP_LEGAME()))
			return false;
		if (getBID() != null && !getBID().equals(ve_musica_tit_c_luo.getBID()))
			return false;
		if (getLID() != null && !getLID().equals(ve_musica_tit_c_luo.getLID()))
			return false;
		return true;
	}

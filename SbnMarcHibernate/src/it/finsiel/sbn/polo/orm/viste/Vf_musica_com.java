 ...
 */
public class Vf_musica_com extends Tb_titolo implements Serializable {

	private static final long serialVersionUID = 6967836404940364746L;

	public boolean equals(Object aObj) {
		if (aObj == null)
			return false;
		if (!(aObj instanceof Vf_musica_com))
			return false;
		Vf_musica_com vf_musica_com = (Vf_musica_com)aObj;
		if (getBID() != null && !getBID().equals(vf_musica_com.getBID()))
			return false;
		if (getBID_CM() != null && !getBID_CM().equals(vf_musica_com.getBID_CM()))
			return false;
		return true;
	}
 ...
 public String getKY_APP_NOR_PRE() {
	...
	public String toString() {
		return String.valueOf(getBID() + " " + getBID_CM());
	}

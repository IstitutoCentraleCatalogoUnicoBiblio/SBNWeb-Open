 ...
 */
public class Vf_musica_luo extends Tb_titolo implements Serializable {

	private static final long serialVersionUID = -1986190681268095965L;

	public boolean equals(Object aObj) {
		if (aObj == null)
			return false;
		if (!(aObj instanceof Vf_musica_luo))
			return false;
		Vf_musica_luo vf_musica_luo = (Vf_musica_luo)aObj;
		if (getBID() != null && !getBID().equals(vf_musica_luo.getBID()))
			return false;
		if (getLID() != null && !getLID().equals(vf_musica_luo.getLID()))
			return false;
		return true;
	}

 ...
 */
public class Vl_biblioteca_cla extends Tbf_biblioteca_in_polo implements Serializable {

	private static final long serialVersionUID = -3621321091051298409L;

	public boolean equals(Object aObj) {
		if (aObj == null)
			return false;
		if (!(aObj instanceof Vl_biblioteca_cla))
			return false;
		Vl_biblioteca_cla vl_biblioteca_cla = (Vl_biblioteca_cla)aObj;
		if (getBID() != null && !getBID().equals(vl_biblioteca_cla.getBID()))
			return false;
		if (getCD_SISTEMA() != vl_biblioteca_cla.getCD_SISTEMA())
			return false;
		if (getCD_EDIZIONE() != vl_biblioteca_cla.getCD_EDIZIONE())
			return false;
		if (getCLASSE() != null && !getCLASSE().equals(vl_biblioteca_cla.getCLASSE()))
			return false;
		if (getCod_polo() != null && !getCod_polo().equals(vl_biblioteca_cla.getCod_polo()))
			return false;
		if (getCd_biblioteca() != null && !getCd_biblioteca().equals(vl_biblioteca_cla.getCd_biblioteca()))
			return false;
		return true;
	}
	...
	public String toString() {
		return String.valueOf(getBID() + " " + getCD_SISTEMA() + " " + getCD_EDIZIONE() + " " + getCLASSE() + " " + getCod_polo() + " " + getCd_biblioteca());
	}

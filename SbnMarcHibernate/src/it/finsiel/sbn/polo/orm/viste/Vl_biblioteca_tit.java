 ...
 */
public class Vl_biblioteca_tit extends Tbf_biblioteca_in_polo implements Serializable {

	private static final long serialVersionUID = 8358100988814062235L;

	public boolean equals(Object aObj) {
		if (aObj == null)
			return false;
		if (!(aObj instanceof Vl_biblioteca_tit))
			return false;
		Vl_biblioteca_tit vl_biblioteca_tit = (Vl_biblioteca_tit)aObj;
		if (getBID() != null && !getBID().equals(vl_biblioteca_tit.getBID()))
			return false;
		if (getCod_polo() != null && !getCod_polo().equals(vl_biblioteca_tit.getCod_polo()))
			return false;
		if (getCd_biblioteca() != null && !getCd_biblioteca().equals(vl_biblioteca_tit.getCd_biblioteca()))
			return false;
		return true;
	}
	...
	public String toString() {
		return String.valueOf(getBID() + " " + getCod_polo() + " " + getCd_biblioteca());
	}

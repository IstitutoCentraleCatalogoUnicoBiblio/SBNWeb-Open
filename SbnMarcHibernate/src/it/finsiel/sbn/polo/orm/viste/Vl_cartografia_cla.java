 ...
 */
public class Vl_cartografia_cla extends V_cartografia {

	private static final long serialVersionUID = 401314181887408041L;

	public boolean equals(Object aObj) {
		if (aObj == null)
			return false;
		if (!(aObj instanceof Vl_cartografia_cla))
			return false;
		Vl_cartografia_cla vl_cartografia_cla = (Vl_cartografia_cla)aObj;
		if (getBID() != null && !getBID().equals(vl_cartografia_cla.getBID()))
			return false;
		if (getCLASSE() != null && !getCLASSE().equals(vl_cartografia_cla.getCLASSE()))
			return false;
		if (getCD_SISTEMA() != vl_cartografia_cla.getCD_SISTEMA())
			return false;
		if (getCD_EDIZIONE() != vl_cartografia_cla.getCD_EDIZIONE())
			return false;
		return true;
	}
 ...
 public String getCD_CATEG_SATELLITE() {
	...
	public String toString() {
		return String.valueOf(getBID() + " " + getCLASSE() + " " + getCD_SISTEMA() + " " + getCD_EDIZIONE());
	}

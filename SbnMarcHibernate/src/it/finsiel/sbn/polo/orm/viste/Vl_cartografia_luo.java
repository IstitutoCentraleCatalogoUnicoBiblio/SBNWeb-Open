 ...
 */
public class Vl_cartografia_luo extends V_cartografia {

	private static final long serialVersionUID = 2458853812697915913L;

	public boolean equals(Object aObj) {
		if (aObj == null)
			return false;
		if (!(aObj instanceof Vl_cartografia_luo))
			return false;
		Vl_cartografia_luo vl_cartografia_luo = (Vl_cartografia_luo)aObj;
		if (getLID() != null && !getLID().equals(vl_cartografia_luo.getLID()))
			return false;
		if (getBID() != null && !getBID().equals(vl_cartografia_luo.getBID()))
			return false;
		if (getTP_LUOGO() != vl_cartografia_luo.getTP_LUOGO())
			return false;
		return true;
	}
 ...
 public String getCD_CATEG_SATELLITE() {
	...
	public String toString() {
		return String.valueOf(getLID() + " " + getBID() + " " + getTP_LUOGO());
	}

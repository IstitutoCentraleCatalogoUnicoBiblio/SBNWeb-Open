 ...
 */
public class Vl_cartografia_sog extends V_cartografia {

	private static final long serialVersionUID = -6829370577304061691L;

	public boolean equals(Object aObj) {
		if (aObj == null)
			return false;
		if (!(aObj instanceof Vl_cartografia_sog))
			return false;
		Vl_cartografia_sog vl_cartografia_sog = (Vl_cartografia_sog)aObj;
		if (getBID() != null && !getBID().equals(vl_cartografia_sog.getBID()))
			return false;
		if (getCID() != null && !getCID().equals(vl_cartografia_sog.getCID()))
			return false;
		return true;
	}

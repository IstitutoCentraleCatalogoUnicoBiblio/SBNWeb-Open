 ...
 */
public class Vl_cartografia_the extends V_cartografia  {

	private static final long serialVersionUID = 4937193671507026342L;

	public boolean equals(Object aObj) {
		if (aObj == null)
			return false;
		if (!(aObj instanceof Vl_cartografia_the))
			return false;
		Vl_cartografia_the vl_cartografia_the = (Vl_cartografia_the)aObj;
		if (getBID() != null && !getBID().equals(vl_cartografia_the.getBID()))
			return false;
		if (getDID() != null && !getDID().equals(vl_cartografia_the.getDID()))
			return false;
		return true;
	}

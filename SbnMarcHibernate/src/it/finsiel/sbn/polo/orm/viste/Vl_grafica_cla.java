 ...
 */
public class Vl_grafica_cla extends Tb_titolo implements Serializable {

	private static final long serialVersionUID = -5797235650497801800L;


	public boolean equals(Object aObj) {
		if (aObj == null)
			return false;
		if (!(aObj instanceof Vl_grafica_cla))
			return false;
		Vl_grafica_cla vl_grafica_cla = (Vl_grafica_cla)aObj;
		if (getBID() != null && !getBID().equals(vl_grafica_cla.getBID()))
			return false;
		if (getCLASSE() != null && !getCLASSE().equals(vl_grafica_cla.getCLASSE()))
			return false;
		if (getCD_SISTEMA() != vl_grafica_cla.getCD_SISTEMA())
			return false;
		if (getCD_EDIZIONE() != vl_grafica_cla.getCD_EDIZIONE())
			return false;
		return true;
	}

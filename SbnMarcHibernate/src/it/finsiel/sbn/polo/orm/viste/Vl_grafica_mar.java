 ...
 */
public class Vl_grafica_mar extends Tb_titolo implements Serializable  {

	private static final long serialVersionUID = -8817597979768403203L;

	public boolean equals(Object aObj) {
		if (aObj == null)
			return false;
		if (!(aObj instanceof Vl_grafica_mar))
			return false;
		Vl_grafica_mar vl_grafica_mar = (Vl_grafica_mar)aObj;
		if (getBID() != null && !getBID().equals(vl_grafica_mar.getBID()))
			return false;
		if (getMID() != null && !getMID().equals(vl_grafica_mar.getMID()))
			return false;
		return true;
	}

 ...
 */
public class Vl_grafica_sog extends Tb_titolo implements Serializable  {

	private static final long serialVersionUID = 4992055814167161301L;

	public boolean equals(Object aObj) {
		if (aObj == null)
			return false;
		if (!(aObj instanceof Vl_grafica_sog))
			return false;
		Vl_grafica_sog vl_grafica_sog = (Vl_grafica_sog)aObj;
		if (getBID() != null && !getBID().equals(vl_grafica_sog.getBID()))
			return false;
		if (getCID() != null && !getCID().equals(vl_grafica_sog.getCID()))
			return false;
		return true;
	}

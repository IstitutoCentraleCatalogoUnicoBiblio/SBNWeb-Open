 ...
 */
public class Vl_grafica_tit_c extends Tb_titolo implements Serializable  {

	private static final long serialVersionUID = -2752936074498950086L;

	public boolean equals(Object aObj) {
		if (aObj == null)
			return false;
		if (!(aObj instanceof Vl_grafica_tit_c))
			return false;
		Vl_grafica_tit_c vl_grafica_tit_c = (Vl_grafica_tit_c)aObj;
		if (getBID() != null && !getBID().equals(vl_grafica_tit_c.getBID()))
			return false;
		if (getBID_COLL() != null && !getBID_COLL().equals(vl_grafica_tit_c.getBID_COLL()))
			return false;
		if (getTP_LEGAME() != null && !getTP_LEGAME().equals(vl_grafica_tit_c.getTP_LEGAME()))
			return false;
		return true;
	}
 ...
 public String getCD_DESIGN_FUNZ() {
	...
	public String toString() {
		return String.valueOf(getBID() + " " + getBID_COLL() + " " + getTP_LEGAME());
	}
}

 ...
 */
public class Vl_musica_luo extends Tb_titolo implements Serializable  {

	private static final long serialVersionUID = -1225744003840253652L;

	public boolean equals(Object aObj) {
		if (aObj == null)
			return false;
		if (!(aObj instanceof Vl_musica_luo))
			return false;
		Vl_musica_luo vl_musica_luo = (Vl_musica_luo)aObj;
		if (getBID() != null && !getBID().equals(vl_musica_luo.getBID()))
			return false;
		if (getLID() != null && !getLID().equals(vl_musica_luo.getLID()))
			return false;
		if (getTP_LUOGO() != vl_musica_luo.getTP_LUOGO())
			return false;
		return true;
	}

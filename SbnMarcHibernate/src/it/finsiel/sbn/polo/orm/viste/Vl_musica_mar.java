 ...
 */
public class Vl_musica_mar extends Tb_titolo implements Serializable  {

	private static final long serialVersionUID = 5198279264004353070L;

	public boolean equals(Object aObj) {
		if (aObj == null)
			return false;
		if (!(aObj instanceof Vl_musica_mar))
			return false;
		Vl_musica_mar vl_musica_mar = (Vl_musica_mar)aObj;
		if (getMID() != null && !getMID().equals(vl_musica_mar.getMID()))
			return false;
		if (getBID() != null && !getBID().equals(vl_musica_mar.getBID()))
			return false;
		return true;
	}

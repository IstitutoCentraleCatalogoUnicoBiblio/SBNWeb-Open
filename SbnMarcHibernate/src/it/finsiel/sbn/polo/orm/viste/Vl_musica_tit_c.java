 ...
 */
public class Vl_musica_tit_c extends Tb_titolo implements Serializable  {

	private static final long serialVersionUID = -7643968645875233134L;

	public boolean equals(Object aObj) {
		if (aObj == null)
			return false;
		if (!(aObj instanceof Vl_musica_tit_c))
			return false;
		Vl_musica_tit_c vl_musica_tit_c = (Vl_musica_tit_c)aObj;
		if (getBID() != null && !getBID().equals(vl_musica_tit_c.getBID()))
			return false;
		if (getBID_COLL() != null && !getBID_COLL().equals(vl_musica_tit_c.getBID_COLL()))
			return false;
		if (getTP_LEGAME() != null && !getTP_LEGAME().equals(vl_musica_tit_c.getTP_LEGAME()))
			return false;
		return true;
	}

 ...
 */
public class Vl_titolo_tit_c extends Tb_titolo  implements Serializable {

	private static final long serialVersionUID = -2285783377152149067L;

	public boolean equals(Object aObj) {
		if (aObj == null)
			return false;
		if (!(aObj instanceof Vl_titolo_tit_c))
			return false;
		Vl_titolo_tit_c vl_titolo_tit_c = (Vl_titolo_tit_c)aObj;
		if (getBID_COLL() != null && !getBID_COLL().equals(vl_titolo_tit_c.getBID_COLL()))
			return false;
		if (getTP_LEGAME() != null && !getTP_LEGAME().equals(vl_titolo_tit_c.getTP_LEGAME()))
			return false;
		if (getBID() != null && !getBID().equals(vl_titolo_tit_c.getBID()))
			return false;
		return true;
	}

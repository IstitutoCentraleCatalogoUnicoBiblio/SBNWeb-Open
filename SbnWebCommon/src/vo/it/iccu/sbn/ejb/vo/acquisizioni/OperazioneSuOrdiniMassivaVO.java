...
public class OperazioneSuOrdiniMassivaVO extends ParametriRichiestaElaborazioneDifferitaVO {

	private static final long serialVersionUID = 3895128231974488457L;
	...
	private int annoBil = 0; // anno su cui imputare il bilancio per i rinnovi PICOS

	private int capitoloBil = 0; // anno su cui imputare il capitolo per i rinnovi PICOS
	...
	private SchedaInventarioInputVO passaggioDati;

	private SchedaInventarioAcqVO scheda;

	public OperazioneSuOrdiniMassivaVO() {
	}
	...
	public SchedaInventarioInputVO getPassaggioDati() {
		return passaggioDati;
	}

	public void setPassaggioDati(SchedaInventarioInputVO passaggioDati) {
		this.passaggioDati = passaggioDati;
	}

	public SchedaInventarioAcqVO getScheda() {
		return scheda;
	}

	public void setScheda(SchedaInventarioAcqVO scheda) {
		this.scheda = scheda;
	}

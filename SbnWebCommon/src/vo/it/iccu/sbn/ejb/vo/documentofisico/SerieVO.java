...
public class SerieVO extends SerializableVO implements Comparable<SerieVO> {
	...
	public int hashCode() {
		...
		result = prime * result + ((codSerie == null) ? 0 : codSerie.hashCode());
		result = prime * result + ((pregrAssInv == null) ? 0 : pregrAssInv.hashCode());
		result = prime * result + ((progAssInv == null) ? 0 : progAssInv.hashCode());
		return result;
	}

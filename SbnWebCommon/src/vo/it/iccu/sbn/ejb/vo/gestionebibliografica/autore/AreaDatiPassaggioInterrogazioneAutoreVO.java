...
public class AreaDatiPassaggioInterrogazioneAutoreVO extends SerializableVO {

	// = AreaDatiPassaggioInterrogazioneAutoreVO.class.hashCode();

	/**
	 *
	 */
	private static final long serialVersionUID = -5219470622018609112L;
	...
	InterrogazioneAutoreGeneraleVO interrGener = new InterrogazioneAutoreGeneraleVO();

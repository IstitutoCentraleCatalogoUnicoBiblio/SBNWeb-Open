...
public class AreaDatiPassaggioInterrogazioneMarcaVO  extends SerializableVO {

	// = AreaDatiPassaggioInterrogazioneMarcaVO.class.hashCode();

	/**
	 *
	 */
	private static final long serialVersionUID = 1388572906928210204L;
	...
	InterrogazioneMarcaGeneraleVO interrGener = new InterrogazioneMarcaGeneraleVO();

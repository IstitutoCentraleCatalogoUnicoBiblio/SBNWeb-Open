...
public class InterrogazioneTitoloMusicaVO   extends SerializableVO {

	// = InterrogazioneTitoloMusicaVO.class.hashCode();

	/**
	 *
	 */
	private static final long serialVersionUID = -6483684973207637765L;
	private List listaTipoTestoLetterario;
	private String tipoTestoLetterarioSelez;
	...
	public String getTipoTestoLetterarioSelez() {
		return tipoTestoLetterarioSelez;
	}
	public void setTipoTestoLetterarioSelez(String tipoTestoLetterarioSelez) {
		this.tipoTestoLetterarioSelez = tipoTestoLetterarioSelez;
	}

...
public class TabellaNumSTDImpronteAggiornataVO extends SerializableVO {

	// = TabellaNumSTDImpronteAggiornataVO.class.hashCode();

	/**
	 *
	 */
	private static final long serialVersionUID = -8364712670498354742L;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		final TabellaNumSTDImpronteAggiornataVO other = (TabellaNumSTDImpronteAggiornataVO) obj;
		if (campoDue == null) {
	...
	public TabellaNumSTDImpronteAggiornataVO() {
		super();
		this.campoUno = "";
		this.campoDue = "";
		this.descCampoDue = "";
	...
	public TabellaNumSTDImpronteAggiornataVO(String campoUno, String campoDue, String  descCampoDue, String nota) {
		super();

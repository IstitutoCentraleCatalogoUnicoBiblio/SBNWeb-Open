...
public class TabellaNumSTDImpronteOriginarioVO extends SerializableVO {

	// = TabellaNumSTDImpronteOriginarioVO.class.hashCode();

	/**
	 *
	 */
	private static final long serialVersionUID = -8639762380998622050L;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		final TabellaNumSTDImpronteOriginarioVO other = (TabellaNumSTDImpronteOriginarioVO) obj;
		if (campoDue == null) {
	...
	public TabellaNumSTDImpronteOriginarioVO() {
		super();
		this.campoUno = "";
		this.campoDue = "";
		this.descCampoDue = "";
	...
	public TabellaNumSTDImpronteOriginarioVO(String campoUno, String campoDue, String  descCampoDue, String nota) {
		super();

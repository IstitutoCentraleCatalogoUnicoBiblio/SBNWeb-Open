...
public enum TipoOrdinamento {
	...
	PER_TESTO		("2", "Testo"),
	PER_DATA		("3", "Data var./ins. + Testo");

	public static final TipoOrdinamento fromSbnMarcValue(String value) {
	...
	private TipoOrdinamento(String sbnMarcValue, String descrizione) {

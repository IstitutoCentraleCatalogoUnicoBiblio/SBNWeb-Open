...
public abstract class DettaglioSogDesBaseVO extends DettaglioOggettoSemanticaVO {

	private static final long serialVersionUID = -3960664483173084753L;

	protected String campoSoggettario;
	protected String edizioneSoggettario;

	public DettaglioSogDesBaseVO() {
		super();
	}

...
public class DefaultVO extends BaseVO {
	...
	private String tipo; // Tipo di oggetto da visualizzare nella JSP (Es.:
							// Opzioni, multiOpzioni...)
	private String tipoDB; // Tipo di oggetto sul database (Es. Radio, String,
							// Check...)

...
import it.iccu.sbn.ejb.domain.elaborazioniDifferite.acquisizioni.AccettaSuggerimenti;
...
public class AccettaSuggerimentiBatch implements BatchExecutor {
	...
	public ElaborazioniDifferiteOutputVo execute(String prefissoOutput,
		...
		log.logWriteLine("Sto eseguendo ACCETTA/RIFIUTA SUGGERIMENTI");

		//OperazioneSuOrdini operazioneSuOrdini =new  OperazioneSuOrdini();
		//OperazioneSuOrdiniMassivaVO operazioneSuOrdiniVO
		OperazioneSuOrdiniMassivaVO operazioneSuOrdiniVO = ((AccettaSuggerimentiDiffVO) params).getOperazioneSuOrdini();

		//ElaborazioniDifferiteOutputVo elaborazioniDifferiteOutputVo = new ElaborazioniDifferiteOutputVo(operazioneSuOrdiniVO);
		AccettaSuggerimenti accettaSuggerimenti = new AccettaSuggerimenti(operazioneSuOrdiniVO);

		ElaborazioniDifferiteOutputVo outputRifiuto = accettaSuggerimenti.accettaSuggerimenti(log);

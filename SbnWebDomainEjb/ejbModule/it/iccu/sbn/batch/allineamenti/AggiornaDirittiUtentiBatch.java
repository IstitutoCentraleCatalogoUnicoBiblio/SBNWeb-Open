...
import it.iccu.sbn.ejb.domain.elaborazioniDifferite.servizi.AggiornaDirittiUtenti;
...
public class AggiornaDirittiUtentiBatch implements BatchExecutor {
	...
	public ElaborazioniDifferiteOutputVo execute(String prefissoOutput,
		...
		log.logWriteLine("Sto eseguendo AGGIORNAMENTO DIRITTI UTENTI");

		AggiornaDirittiUtenteVO operazioneVO = ((AggiornaDirittiUtenteVO) params);

		//ElaborazioniDifferiteOutputVo elaborazioniDifferiteOutputVo = new ElaborazioniDifferiteOutputVo(operazioneSuOrdiniVO);
		AggiornaDirittiUtenti aggiornaDiritti = new AggiornaDirittiUtenti(operazioneVO);

		ElaborazioniDifferiteOutputVo outputRinnovo = aggiornaDiritti.aggiornaDirittiUtenti(log);

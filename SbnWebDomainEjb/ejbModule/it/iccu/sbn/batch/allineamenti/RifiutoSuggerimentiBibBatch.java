...
import it.iccu.sbn.ejb.domain.elaborazioniDifferite.acquisizioni.RifiutoSuggerimentiBib;
import it.iccu.sbn.ejb.vo.acquisizioni.OperazioneSuOrdiniMassivaVO;
import it.iccu.sbn.ejb.vo.elaborazioniDifferite.ElaborazioniDifferiteOutputVo;
import it.iccu.sbn.ejb.vo.elaborazioniDifferite.ParametriRichiestaElaborazioneDifferitaVO;
import it.iccu.sbn.ejb.vo.elaborazioniDifferite.RifiutoSuggerimentiBibDiffVO;
import it.iccu.sbn.servizi.batch.BatchExecutor;
import it.iccu.sbn.servizi.batch.BatchLogWriter;

import javax.transaction.UserTransaction;

public class RifiutoSuggerimentiBibBatch implements BatchExecutor {
	...
	public ElaborazioniDifferiteOutputVo execute(String prefissoOutput,
		...
		OperazioneSuOrdiniMassivaVO operazioneSuOrdiniVO = ((RifiutoSuggerimentiBibDiffVO) params).getOperazioneSuOrdini();

		//ElaborazioniDifferiteOutputVo elaborazioniDifferiteOutputVo = new ElaborazioniDifferiteOutputVo(operazioneSuOrdiniVO);
		RifiutoSuggerimentiBib rifiutoSuggerimentiBib = new RifiutoSuggerimentiBib(operazioneSuOrdiniVO);

		ElaborazioniDifferiteOutputVo outputRifiuto = rifiutoSuggerimentiBib.rifiutoSuggerimentiBib(log);

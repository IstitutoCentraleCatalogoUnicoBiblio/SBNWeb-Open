...
import it.iccu.sbn.ejb.domain.elaborazioniDifferite.servizi.RinnovoDiritti;
...
public class RinnovoDirittiBatch implements BatchExecutor {
	...
	public ElaborazioniDifferiteOutputVo execute(String prefissoOutput,
		...
		log.logWriteLine("Sto eseguendo RINNOVO DIRITTI");

		RinnovoDirittiDiffVO operazioneVO = ((RinnovoDirittiDiffVO) params);

		//ElaborazioniDifferiteOutputVo elaborazioniDifferiteOutputVo = new ElaborazioniDifferiteOutputVo(operazioneSuOrdiniVO);
		RinnovoDiritti rinnovoDiritti = new RinnovoDiritti(operazioneVO);

		ElaborazioniDifferiteOutputVo outputRinnovo = rinnovoDiritti.rinnovoDiritti(log);

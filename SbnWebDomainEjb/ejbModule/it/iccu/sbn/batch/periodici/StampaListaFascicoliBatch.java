 ...
 ******************************************************************************/
package it.iccu.sbn.batch.periodici;
...
public class StampaListaFascicoliBatch implements BatchExecutor {

	SBNStampeListaFascicoli getEjb() throws Exception {
		return DomainEJBStampeFactory.getInstance().getSBNStampeListaFascicoli();
	}
	...
	public ElaborazioniDifferiteOutputVo execute(String prefissoOutput,
		...
		log.logWriteLine("Sto eseguendo la stampa Lista Fascicoli");

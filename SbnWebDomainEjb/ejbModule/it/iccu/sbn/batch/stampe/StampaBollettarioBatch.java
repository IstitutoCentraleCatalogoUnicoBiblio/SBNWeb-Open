...
public class StampaBollettarioBatch implements BatchExecutor {

	SBNStampeBollettario getEjb() throws Exception {
		return DomainEJBStampeFactory.getInstance().getSBNStampeBollettario();
	}
	...
	public ElaborazioniDifferiteOutputVo execute(String prefissoOutput,
		...
		log.logWriteLine("Sto eseguendo la stampa del bollettario");
		output = (ElaborazioniDifferiteOutputVo) getEjb().elabora((StampaBollettarioDiffVO) params, log);
		return output;
	}

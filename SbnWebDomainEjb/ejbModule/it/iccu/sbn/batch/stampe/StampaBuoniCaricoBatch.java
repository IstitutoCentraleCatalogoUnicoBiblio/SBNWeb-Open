...
public class StampaBuoniCaricoBatch implements BatchExecutor {

	SBNStampeBuoniCarico getEjb() throws Exception {
		return DomainEJBStampeFactory.getInstance().getSBNStampeBuoniCarico();
	}
	...
	public ElaborazioniDifferiteOutputVo execute(String prefissoOutput,
		...
		log.logWriteLine("Sto eseguendo la stampa buono di carico");

...
public class StampaFornitoriBatch implements BatchExecutor {

	SBNStampeFornitori getEjb() throws Exception {
		return DomainEJBStampeFactory.getInstance().getSBNStampeFornitori();
	}
	...
	public ElaborazioniDifferiteOutputVo execute(String prefissoOutput,
		...
		log.logWriteLine("Sto eseguendo la stampa dei fornitori");
		output = (ElaborazioniDifferiteOutputVo) getEjb().elabora((StampaFornitoriDiffVO) params, log);
		return output;
	}

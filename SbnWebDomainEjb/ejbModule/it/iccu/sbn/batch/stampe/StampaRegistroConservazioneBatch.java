...
public class StampaRegistroConservazioneBatch implements BatchExecutor {

	SBNStampeRegistroConservazione getEjb() throws Exception {
		return DomainEJBStampeFactory.getInstance().getSBNStampeRegistroConservazione();
	}
	...
	public ElaborazioniDifferiteOutputVo execute(String prefissoOutput,
		...
		log.logWriteLine("Sto eseguendo la stampa del registro di conservazione");

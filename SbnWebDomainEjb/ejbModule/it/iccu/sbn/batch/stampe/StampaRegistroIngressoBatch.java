...
public class StampaRegistroIngressoBatch implements BatchExecutor {

	SBNStampeRegistriIngresso getEjb() throws Exception {
		return DomainEJBStampeFactory.getInstance().getSBNStampeRegistriIngresso();
	}
	...
	public ElaborazioniDifferiteOutputVo execute(String prefissoOutput,
		...
		log.logWriteLine("Sto eseguendo la stampa registro d'ingresso");

...
public class StampaRegistroTopograficoBatch implements BatchExecutor {

	SBNStampeRegistroTopografico getEjb() throws Exception {
		return DomainEJBStampeFactory.getInstance().getSBNStampeRegistroTopografico();
	}
	...
	public ElaborazioniDifferiteOutputVo execute(String prefissoOutput,
		...
		log.logWriteLine("Sto eseguendo la stampa registro topografico");

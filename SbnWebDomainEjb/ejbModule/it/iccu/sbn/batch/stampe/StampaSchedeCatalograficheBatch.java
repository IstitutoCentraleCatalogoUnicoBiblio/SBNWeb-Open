...
public class StampaSchedeCatalograficheBatch implements BatchExecutor {

	SBNStampeSchede getEjb() throws Exception {
		return DomainEJBStampeFactory.getInstance().getSBNStampeSchede();
	}
	...
	public ElaborazioniDifferiteOutputVo execute(String prefissoOutput,
		...
		log.logWriteLine("Sto eseguendo la stampa schede catalografiche");

...
public class StampaServiziCorrentiBatch implements BatchExecutor {

	SBNStampeServiziCorrenti getEjb() throws Exception {
		return DomainEJBStampeFactory.getInstance().getSBNStampeServiziCorrenti();
	}
	...
	public ElaborazioniDifferiteOutputVo execute(String prefissoOutput,
		...
		log.logWriteLine("Sto eseguendo la stampa servizi correnti");

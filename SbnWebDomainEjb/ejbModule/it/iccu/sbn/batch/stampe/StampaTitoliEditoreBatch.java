...
public class StampaTitoliEditoreBatch implements BatchExecutor {

	SBNStampeTitoliEditore getEjb() throws Exception {
		return DomainEJBStampeFactory.getInstance().getSBNStampeTitoliEditore();
	}
	...
	public ElaborazioniDifferiteOutputVo execute(String prefissoOutput,
		...
		log.logWriteLine("Sto eseguendo la stampa titoli per editore");

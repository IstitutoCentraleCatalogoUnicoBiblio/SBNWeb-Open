...
public class AccettaSuggerimenti {
	...
	public AccettaSuggerimenti() {
		this.ejbCreate();
	}

	private OperazioneSuOrdiniMassivaVO operazioneSuOrdiniVO;

	public AccettaSuggerimenti(OperazioneSuOrdiniMassivaVO operazioneSuOrdiniVO){
		this.operazioneSuOrdiniVO = operazioneSuOrdiniVO;
		this.ejbCreate();
	}

	public ElaborazioniDifferiteOutputVo accettaSuggerimenti(BatchLogWriter log)	{
		System.out.println("++============================================================================++");
		System.out.println("AccettaSuggerimenti Elaborazioni differite - Inizio di AccettaSuggerimenti.java metodo accettaSuggerimenti");
		...
		String suffisso="accettaSuggerimenti_";
    	...
    	try {
			...
			if (outputAllineamentoVO != null){
			 ...
			 streamOut.write("FINE Accetta Suggerimenti".getBytes());
			streamOut.close();
		...
		System.out.println("++============================================================================++");
		System.out.println("AccettaSuggerimenti Elaborazioni differite - Fine di AccettaSuggerimenti.java metodo accettaSuggerimenti");
		System.out.println("Sone le " + DateUtil.getDate()+DateUtil.getTime());
		System.out.println("++============================================================================++");

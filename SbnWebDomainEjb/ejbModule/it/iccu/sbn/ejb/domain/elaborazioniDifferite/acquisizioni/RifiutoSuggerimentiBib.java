...
public class RifiutoSuggerimentiBib {
	...
	public RifiutoSuggerimentiBib() {
		this.ejbCreate();
	}

	private OperazioneSuOrdiniMassivaVO operazioneSuOrdiniVO;

	public RifiutoSuggerimentiBib(OperazioneSuOrdiniMassivaVO operazioneSuOrdiniVO){
		this.operazioneSuOrdiniVO = operazioneSuOrdiniVO;
		this.ejbCreate();
	}

	public ElaborazioniDifferiteOutputVo rifiutoSuggerimentiBib(BatchLogWriter log)	{
		System.out.println("++============================================================================++");
		System.out.println("RifiutoSuggerimentiBib Elaborazioni differite - Inizio di RifiutoSuggerimentiBib.java metodo rifiutoSuggerimentiBib");
		...
		String suffisso="rifiutoSuggerimentiBib_";
    	...
    	try {
			...
			if (outputAllineamentoVO != null){
			 ...
			 streamOut.write("FINE Rifiuto Suggerimenti del Bibliotecario".getBytes());
			streamOut.close();
		...
		System.out.println("++============================================================================++");
		System.out.println("RifiutoSuggerimentiBib Elaborazioni differite - Fine di RifiutoSuggerimentiBib.java metodo rifiutoSuggerimentiBib");
		System.out.println("Sone le " + DateUtil.getDate()+DateUtil.getTime());
		System.out.println("++============================================================================++");

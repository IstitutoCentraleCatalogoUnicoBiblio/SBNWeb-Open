 ...
 *
 * @ejb.bean name="SBNComunicazione"
 * 			 acknowledge-mode="Auto-acknowledge"
 *           destination-type="javax.jms.Queue"
 *           transaction-type="Container"
 *           destination-jndi-name="SBNComunicazione"
 ...
 *
 */
public class SBNStampeComunicazioneBean extends SBNStampeBase implements MessageDrivenBean, MessageListener {
	/**
	 *
	 */
	...
	private static Logger log = Logger.getLogger(SBNStampeComunicazioneBean.class.getName());
			...
			if (stampaVO instanceof StampaOnLineVO) {
				...
				try {
					...
					if(datiDaStampare.size()>0){
						...
						if(streamRichiestaStampa !=null){
							try {
								//nameFile = utente +"_comunicazione_"+idMess+ "." + stampaVO.getTipoStampa().toLowerCase();
					...
					if(!listaEsistente){
						...
						elaborazioniDifferiteOutputVo.setStato(ConstantsJMS.STATO_OK);
						nameFile = utente +"_log_comunicazione_"+idMess+ "." + "txt";
...
//					log.info("Terminata l'elaborazione del messaggio in SBNStampeComunicazioneBean");

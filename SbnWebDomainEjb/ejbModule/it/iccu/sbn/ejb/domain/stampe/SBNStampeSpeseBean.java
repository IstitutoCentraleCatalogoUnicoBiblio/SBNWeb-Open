 ...
 *
 */
public class SBNStampeSpeseBean extends SBNStampeBase implements MessageDrivenBean, MessageListener {
	/**
	 *
	 */
	...
	private static Logger log = Logger.getLogger(SBNStampeSpeseBean.class);
...
*/
	...
	throws ResourceNotFoundException, ApplicationException, ValidationException, DataException	{
		RipartizioneSpeseDiffVO stampaVO = (RipartizioneSpeseDiffVO) input;
		...
		try {
			...
			if (stampavo instanceof StampaOnLineVO) {
				...
				try{
					...
					//{
						listaOutput = getEjbAcq().ripartoSpese(lpVO);
					//}
					//else
					//{
					//	listaOutput = (List<StatisticheVO>) getEjbAcq().statisticheTempi(lpVO);
					//}

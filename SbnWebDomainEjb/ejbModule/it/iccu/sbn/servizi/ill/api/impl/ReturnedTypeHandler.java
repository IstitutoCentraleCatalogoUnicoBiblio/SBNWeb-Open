...
public class ReturnedTypeHandler extends AvanzamentoRichiestaILLBaseHandler {

	private static final long serialVersionUID = -4710715407101077450L;

	private ReturnedType returned;

	public ReturnedTypeHandler(String ticket, ILLAPDU input) {
		super(ticket, input);
	...
	public String getXMLName() {
		return formattaNomeXML(returned.getTransactionId(), StatoIterRichiesta.F116_RESTITUZIONE_MATERIALE,
				returned.getResponderId());
	}

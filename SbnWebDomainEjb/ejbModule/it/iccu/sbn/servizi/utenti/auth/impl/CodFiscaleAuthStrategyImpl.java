...
public class CodFiscaleAuthStrategyImpl extends SbnWebUtenteLettoreLoginBaseImpl {
	...
	protected Tbl_utenti getUtente(String userId, String password, boolean checkPassword) throws Exception {
		...
		Tbl_utenti utente = dao.selectByCodFiscale(userId, password, checkPassword);

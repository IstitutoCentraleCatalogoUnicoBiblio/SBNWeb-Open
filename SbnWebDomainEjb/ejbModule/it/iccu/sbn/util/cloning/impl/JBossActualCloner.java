...
public class JBossActualCloner extends UniqueIdentifiableVO implements ActualCloner {
	...
	public <T> T deepCopy(T src) throws Exception {
		...
		ObjectInputStream ois = new JBossObjectInputStream(bais);//, src.getClass().getClassLoader());

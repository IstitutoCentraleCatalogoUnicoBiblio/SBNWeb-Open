...
/**
 * This message will be sent when a patron has completed all of their transactions.
 * The ACS may, upon receipt of this command, close any open files or deallocate data
 * structures pertaining to that patron. The ACS should respond with an End Session
 * Response message.
 *
 * @author almaviva7
 */
public class MessaggioSip2EndPatronSessionRequest  extends MessaggioSip2 //extends DesignModel.BusinessObjects.LBO_BusinessObject.BusinessObject
    {
	/**
	 *
	 */
	private static final long serialVersionUID = 8171606105545713225L;
     ...
     */
    public MessaggioSip2EndPatronSessionRequest(java.lang.String stringa) throws Exception {
     ...
     * Costruttore
     */
    public MessaggioSip2EndPatronSessionRequest() {
    }

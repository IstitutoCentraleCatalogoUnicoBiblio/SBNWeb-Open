...
public class A02_ScaricoDaMagazzino extends AbstractAttivitaCheckerBase {

	public A02_ScaricoDaMagazzino() throws RemoteException, NamingException,
			CreateException {
		super();
	}
	...
	public ControlloAttivitaServizioResult check(DatiControlloVO dati) throws Exception {
		dati.setControlloEseguito(StatoIterRichiesta.SCARICO_DA_MAGAZZINO);

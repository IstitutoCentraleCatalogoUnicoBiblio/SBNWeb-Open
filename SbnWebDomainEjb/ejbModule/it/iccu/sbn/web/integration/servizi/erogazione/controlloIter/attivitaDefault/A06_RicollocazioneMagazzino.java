...
public class A06_RicollocazioneMagazzino extends AbstractAttivitaCheckerBase {

	public A06_RicollocazioneMagazzino() throws RemoteException, NamingException, CreateException {
		super();
	}

	@Override
	public ControlloAttivitaServizioResult check(DatiControlloVO dati) throws Exception {
		dati.setControlloEseguito(StatoIterRichiesta.RICOLLOCAZIONE_A_MAGAZZINO);
		MovimentoVO mov = dati.getMovimento();
		if (mov.getDataFineEff() == null)
			mov.setDataFineEff(DaoManager.now());

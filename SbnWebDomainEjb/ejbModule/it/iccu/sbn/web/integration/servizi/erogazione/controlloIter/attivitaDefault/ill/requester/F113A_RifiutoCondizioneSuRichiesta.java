...
public class F113A_RifiutoCondizioneSuRichiesta extends AbstractAttivitaCheckerILL {

	public F113A_RifiutoCondizioneSuRichiesta() throws RemoteException, NamingException, CreateException {
		super();
	}

	@Override
	public ControlloAttivitaServizioResult check(DatiControlloVO dati) throws Exception {
		dati.setControlloEseguito(StatoIterRichiesta.F113A_RIFIUTO_CONDIZIONE_SU_RICHIESTA);
		...
		msg.setStato(StatoIterRichiesta.F113A_RIFIUTO_CONDIZIONE_SU_RICHIESTA.getISOCode());
	...
	public ControlloAttivitaServizioResult post(DatiControlloVO dati) throws Exception {
		...
		try {
			ILLAPDU response = ILLRequestBuilder.rispostaCondizioneRichiesta(datiILL, msg, false);
			return checkResponse(response, dati.setControlloEseguito(StatoIterRichiesta.F113A_RIFIUTO_CONDIZIONE_SU_RICHIESTA));

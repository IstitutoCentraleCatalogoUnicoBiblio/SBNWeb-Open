...
public class F113B_AccettazioneCondizioneSuRichiesta extends AbstractAttivitaCheckerILL {

	public F113B_AccettazioneCondizioneSuRichiesta() throws RemoteException, NamingException, CreateException {
		super();
	}

	@Override
	public ControlloAttivitaServizioResult check(DatiControlloVO dati) throws Exception {
		dati.setControlloEseguito(StatoIterRichiesta.F113B_ACCETTAZIONE_CONDIZIONE_SU_RICHIESTA);
		...
		msg.setStato(StatoIterRichiesta.F113B_ACCETTAZIONE_CONDIZIONE_SU_RICHIESTA.getISOCode());
	...
	public ControlloAttivitaServizioResult post(DatiControlloVO dati) throws Exception {
		...
		try {
			ILLAPDU response = ILLRequestBuilder.rispostaCondizioneRichiesta(datiILL, msg, true);
			return checkResponse(response, dati.setControlloEseguito(StatoIterRichiesta.F113B_ACCETTAZIONE_CONDIZIONE_SU_RICHIESTA));

...
public class F1212_RifiutaRichiesta extends AbstractAttivitaCheckerILL {

	public F1212_RifiutaRichiesta() throws RemoteException, NamingException, CreateException {
		super();
	}

	@Override
	public ControlloAttivitaServizioResult check(DatiControlloVO dati) throws Exception {
		dati.setControlloEseguito(StatoIterRichiesta.F1212_RICHIESTA_NON_SODDISFACIBILE);
		...
		datiILL.setCurrentState(StatoIterRichiesta.F1212_RICHIESTA_NON_SODDISFACIBILE.getISOCode());
	...
	public ControlloAttivitaServizioResult post(DatiControlloVO dati) throws Exception {
		...
		try {
			ILLAPDU response = ILLRequestBuilder.rifiutaRichiesta(datiILL, msg);
			return checkResponse(response, dati.setControlloEseguito(StatoIterRichiesta.F1212_RICHIESTA_NON_SODDISFACIBILE));

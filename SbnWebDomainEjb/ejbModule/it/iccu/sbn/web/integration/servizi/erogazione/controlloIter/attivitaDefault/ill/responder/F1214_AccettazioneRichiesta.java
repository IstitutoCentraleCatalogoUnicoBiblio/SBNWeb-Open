...
public class F1214_AccettazioneRichiesta extends AbstractAttivitaCheckerILL {

	public F1214_AccettazioneRichiesta() throws RemoteException, NamingException, CreateException {
		super();
	}

	@Override
	public ControlloAttivitaServizioResult check(DatiControlloVO dati) throws Exception {
		dati.setControlloEseguito(StatoIterRichiesta.F1214_ACCETTAZIONE_RICHIESTA);
		...
		msg.setStato(StatoIterRichiesta.F1214_ACCETTAZIONE_RICHIESTA.getISOCode());
	...
	public ControlloAttivitaServizioResult post(DatiControlloVO dati) throws Exception {
		...
		try {
			ILLAPDU response = ILLRequestBuilder.accettaRichiesta(datiILL, msg);
			return checkResponse(response, dati.setControlloEseguito(StatoIterRichiesta.F1214_ACCETTAZIONE_RICHIESTA));

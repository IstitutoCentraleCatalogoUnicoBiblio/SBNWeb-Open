...
public class F1220_RifiutoAnnullamentoRichiesta extends AbstractAttivitaCheckerILL {

	public F1220_RifiutoAnnullamentoRichiesta() throws RemoteException,
	...
	public ControlloAttivitaServizioResult check(DatiControlloVO dati)
			throws Exception {
		dati.setControlloEseguito(StatoIterRichiesta.F1220_RIFIUTO_ANNULLAMENTO);
		...
		msg.setStato(StatoIterRichiesta.F1220_RIFIUTO_ANNULLAMENTO.getISOCode());
	...
	public ControlloAttivitaServizioResult post(DatiControlloVO dati) throws Exception {
		...
		try {
			...
			ILLAPDU response = ILLRequestBuilder.rispostaRichiestaDiAnnullamento(datiILL, msg, false);
			return checkResponse(response, dati.setControlloEseguito(StatoIterRichiesta.F1220_RIFIUTO_ANNULLAMENTO));

...
public class F1221_AccettaAnnullamentoRichiesta extends AbstractAttivitaCheckerILL {

	public F1221_AccettaAnnullamentoRichiesta() throws RemoteException,
	...
	public ControlloAttivitaServizioResult check(DatiControlloVO dati)
			throws Exception {
		dati.setControlloEseguito(StatoIterRichiesta.F1221_CONFERMA_ANNULLAMENTO);
	...
	public ControlloAttivitaServizioResult post(DatiControlloVO dati) throws Exception {
		...
		try {
			...
			ILLAPDU response = ILLRequestBuilder.rispostaRichiestaDiAnnullamento(datiILL, msg, true);
			return checkResponse(response, dati.setControlloEseguito(StatoIterRichiesta.F1221_CONFERMA_ANNULLAMENTO));

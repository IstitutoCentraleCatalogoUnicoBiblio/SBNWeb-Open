...
public class F12E_SollecitoRestituzione extends AbstractAttivitaCheckerILL {

	public F12E_SollecitoRestituzione() throws RemoteException, NamingException, CreateException {
		super();
	}

	@Override
	public ControlloAttivitaServizioResult check(DatiControlloVO dati) throws Exception {
		dati.setControlloEseguito(StatoIterRichiesta.F12E_RICHIESTA_RESTITUZIONE_URGENTE);
		...
		msg.setStato(StatoIterRichiesta.F12E_RICHIESTA_RESTITUZIONE_URGENTE.getISOCode());
	...
	public ControlloAttivitaServizioResult post(DatiControlloVO dati) throws Exception {
		...
		try {
			ILLAPDU response = ILLRequestBuilder.sollecitoRestituzioneUrgente(datiILL, msg);
			return checkResponse(response, dati.setControlloEseguito(StatoIterRichiesta.F12E_RICHIESTA_RESTITUZIONE_URGENTE));

...
public class Tbf_anagrafe_utenti_professionali implements Serializable {
	...
	private static final long serialVersionUID = 866760930238469749L;
	...
	private it.iccu.sbn.polo.orm.amministrazione.Tbf_bibliotecario Tbf_bibliotecario;

	private it.iccu.sbn.polo.orm.amministrazione.Tbf_utenti_professionali_web Tbf_utenti_professionali_web;
	...
	public void setTbf_bibliotecario(it.iccu.sbn.polo.orm.amministrazione.Tbf_bibliotecario value) {
		this.Tbf_bibliotecario = value;
	}

	public it.iccu.sbn.polo.orm.amministrazione.Tbf_bibliotecario getTbf_bibliotecario() {
		return Tbf_bibliotecario;
	}

	public void setTbf_utenti_professionali_web(it.iccu.sbn.polo.orm.amministrazione.Tbf_utenti_professionali_web value) {
		this.Tbf_utenti_professionali_web = value;
	}

	public it.iccu.sbn.polo.orm.amministrazione.Tbf_utenti_professionali_web getTbf_utenti_professionali_web() {

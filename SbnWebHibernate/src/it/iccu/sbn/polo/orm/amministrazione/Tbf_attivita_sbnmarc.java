...
public class Tbf_attivita_sbnmarc implements Serializable {
	...
	private static final long serialVersionUID = -1725032494062070182L;
	...
	private it.iccu.sbn.polo.orm.amministrazione.Tbf_moduli_funzionali id_modulo;

	private it.iccu.sbn.polo.orm.amministrazione.Tbf_attivita Tbf_attivita;
	...
	public void setId_modulo(it.iccu.sbn.polo.orm.amministrazione.Tbf_moduli_funzionali value) {
		this.id_modulo = value;
	}

	public it.iccu.sbn.polo.orm.amministrazione.Tbf_moduli_funzionali getId_modulo() {
		return id_modulo;
	}

	public void setTbf_attivita(it.iccu.sbn.polo.orm.amministrazione.Tbf_attivita value) {
		this.Tbf_attivita = value;
	}

	public it.iccu.sbn.polo.orm.amministrazione.Tbf_attivita getTbf_attivita() {
		return Tbf_attivita;
	}

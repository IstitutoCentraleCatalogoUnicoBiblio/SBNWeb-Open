...
public class Trf_funzioni_denominazioni implements Serializable {
	...
	private static final long serialVersionUID = 8426855105506845634L;
	...
	private it.iccu.sbn.polo.orm.amministrazione.Tbf_attivita cd_funzione;

	private it.iccu.sbn.polo.orm.amministrazione.Tbf_lingua_supportata cd_lingua;
	...
	public void setCd_lingua(it.iccu.sbn.polo.orm.amministrazione.Tbf_lingua_supportata value) {
		this.cd_lingua = value;
	}

	public it.iccu.sbn.polo.orm.amministrazione.Tbf_lingua_supportata getCd_lingua() {
		return cd_lingua;
	}

	public void setCd_funzione(it.iccu.sbn.polo.orm.amministrazione.Tbf_attivita value) {
		this.cd_funzione = value;
	}

	public it.iccu.sbn.polo.orm.amministrazione.Tbf_attivita getCd_funzione() {
		return cd_funzione;
	}

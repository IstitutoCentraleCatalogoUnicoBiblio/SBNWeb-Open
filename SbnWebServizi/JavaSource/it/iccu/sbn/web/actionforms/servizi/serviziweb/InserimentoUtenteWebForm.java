...
public class InserimentoUtenteWebForm extends AbstractBibliotecaForm {

	private static final long serialVersionUID = -2422510926234553933L;
	...
	// indica se i dati di domicilio saranno impostati uguali a quelli di
	// residenza
	...
	public void reset(ActionMapping mapping, HttpServletRequest request) {
		...
		List<ServizioVO> servizi = this.getUteAna().getAutorizzazioni()
				.getListaServizi();
		if (servizi != null) {
	...
	public void setLock(UtenteWebLock lock) {
		this.lock = lock;
	}

	public UtenteWebLock getLock() {
		return lock;
	}

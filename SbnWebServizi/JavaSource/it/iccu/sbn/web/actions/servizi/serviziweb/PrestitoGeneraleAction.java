...
import it.iccu.sbn.web.actionforms.servizi.serviziweb.PrestitoGeneraleForm;
...
public class PrestitoGeneraleAction extends LookupDispatchAction {
	...
	protected ActionForward unspecified(ActionMapping mapping, ActionForm form,
			...
			throws Exception {
		PrestitoGeneraleForm currentForm = (PrestitoGeneraleForm)form;
	...
	public ActionForward ok(ActionMapping mapping, ActionForm form,
		...
		/*HttpSession session = request.getSession();
		session.setAttribute("FORM_PRESTITO_GEN",form);*/
		return mapping.findForward("prestitoGeneraleTariffa");
	}

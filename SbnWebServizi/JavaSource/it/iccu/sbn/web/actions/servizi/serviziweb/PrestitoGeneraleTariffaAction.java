...
import it.iccu.sbn.web.actionforms.servizi.serviziweb.PrestitoGeneraleTariffaForm;
...
public class PrestitoGeneraleTariffaAction extends LookupDispatchAction {
	...
	protected ActionForward unspecified(ActionMapping mapping, ActionForm form,
			...
			throws Exception {
		PrestitoGeneraleTariffaForm currentForm = (PrestitoGeneraleTariffaForm)form;
		...
		String tariffa = "\u20AC 1.00 + 0.00 = 1.00";
		currentForm.setTariffa(tariffa);

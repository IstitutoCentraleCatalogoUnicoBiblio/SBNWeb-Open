...
import it.iccu.sbn.web.actionforms.servizi.serviziweb.SceltaServiziILLForm;
...
public class SceltaServiziILLAction extends LookupDispatchAction {
	...
	protected ActionForward unspecified(ActionMapping mapping, ActionForm form,
		...
		SceltaServiziILLForm currentForm = (SceltaServiziILLForm)form;
		...
		utenteEjb = factory.getGestioneServiziWeb().listaServILL();
		currentForm.setListaServILL(utenteEjb.getListaServILL());
	...
	public ActionForward indietro(ActionMapping mapping, ActionForm form,
		...
		SceltaServiziILLForm currentForm = (SceltaServiziILLForm)form;
		request.setAttribute("segnatura",currentForm.getSegnatura());
		return (mapping.findForward("serviziILL"));
	}

...
<div id="header"></div>
<div id="data">
	<sbn:navform action="/serviziweb/consultazioneGenerale.do" >
	<table cellspacing="0" width="100%" border="0">
			...
			<tr>
				...
				<bean:message key="servizi.documento.richServLocalePerVolume"
					...
					- <b><c:out value="${consultazioneGeneraleForm.titolo}"> </c:out></b>
				</td>
			</tr>
			<tr>
				<td colspan="4" align="center">
			...
			<tr>
				<!-- disp -->
				<td  class="etichetta" align="right" >
					<bean:message key="servizi.documento.disp"
					bundle="serviziWebLabels" />
				</td>
				<td>
					<html:text property="disp"
							styleId="testoNormale" size="10" maxlength="10" readonly="true"></html:text>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td align="center" colspan="2">
					...
					<html:submit styleClass="submit" property="paramConsultazioneGenerale">

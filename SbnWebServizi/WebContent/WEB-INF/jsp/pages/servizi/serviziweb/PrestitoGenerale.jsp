...
<div id="header"></div>
<div id="data">
	<sbn:navform action="/serviziweb/prestitoGenerale.do" >
	<table cellspacing="0" width="100%" border="0">
			...
			<tr>
				<td colspan="4" align="center">
					Richiesta Servizi <b>locali</b> per il seguente volume <br>
					- <b><c:out value="${prestitoGeneraleForm.titolo}"> </c:out></b>
				</td>
			</tr>
			<tr>
				<td colspan="4" align="center">
			...
			<tr>
				<!-- data limite interesse -->
				<td  class="etichetta" align="right">
					<bean:message key="servizi.documento.dataLim"
					bundle="serviziWebLabels" />
				</td>
				<td>
					<html:text property="ggDataLimite"
							styleId="testoNormale" size="2" maxlength="2"></html:text><b>/</b>
					<html:text property="mmDataLimite"
							styleId="testoNormale" size="2" maxlength="2"></html:text><b>/</b>
					<html:text property="aaDataLimite"
			...
			<tr>
				<td  class="etichetta" align="right">
					<bean:message key="servizi.documento.noteUte" bundle="serviziWebLabels" />
				</td>
			...
			<tr>
				<td align="center" colspan="2">
					...
					<html:submit styleClass="submit" property="paramPrestitoGenerale">

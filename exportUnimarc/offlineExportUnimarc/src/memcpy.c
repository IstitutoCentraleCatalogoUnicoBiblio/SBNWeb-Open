 ...
 ** DEFINED at compiler level 24/10/2012
 *******************************************************************/



//#define MEMCPY_64BIT		// For 64 bit architectures
//#define LITTLE_ENDIAN		// For intel architectures
...
#define SHIFT_RIGHT_DIVIDE  3
#else
typedef UInt32              UIntN;
#define TYPE_WIDTH          4L
#define SHIFT_RIGHT_DIVIDE  2
#endif
...
#define COPY_NO_SHIFT() {                                           \
    ...
    size_t length = count >> SHIFT_RIGHT_DIVIDE;					\
	\
    while (length & 7) {                                            \
        CP_INCR();                                                  \
        length--;                                                   \
